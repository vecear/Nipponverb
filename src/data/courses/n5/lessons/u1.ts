...
const l1Quiz: UnifiedQuestion[] = [
  ...
  },
  {
    ...
    level: 'N5',
    tags: ['meaning'],
    stem: '「お母{かあ}さん」は英語{えいご}で何{なん}ですか。',
    stemZh: '「お母さん」的英文是什麼？',
    options: [
      { text: 'mother', reason: '正確。お母さん意為母親。' },
      { text: 'father', reason: '錯誤。father 是お父さん{おとうさん}。' },
      { text: 'older sister', reason: '錯誤。older sister 是姉{あね}。' },
      { text: 'younger sister', reason: '錯誤。younger sister 是妹{いもうと}。' },
    ],
    correctIndex: 0,
    explanation: {
      keyPoint: '家族稱呼',
      analysis: 'お母{かあ}さん是對母親的尊稱。注意「お」是敬語前綴。',
      comparisons: ['お父さん＝father', 'お母さん＝mother', '兄{あに}＝older brother', '姉{あね}＝older sister'],
    },
  },
  {
    id: 'cq_n5_u1_l1_006',
...
const l2Quiz: UnifiedQuestion[] = [
  ...
  },
  {
    ...
    level: 'N5',
    tags: ['reading'],
    stem: '「鉛筆{えんぴつ}」は英語{えいご}で何{なん}ですか。',
    stemZh: '「鉛筆」的英文是什麼？',
    options: [
      { text: 'pencil', reason: '正確。鉛筆{えんぴつ}意為pencil。' },
      { text: 'pen', reason: '錯誤。pen是ペン。' },
      { text: 'paper', reason: '錯誤。paper是紙{かみ}。' },
      { text: 'notebook', reason: '錯誤。notebook是ノート。' },
    ],
    correctIndex: 0,
    explanation: {
      keyPoint: '鉛筆的詞義',
      analysis: '鉛筆{えんぴつ}意為鉛筆（pencil）。注意讀音是「えんぴつ」而非「えんひつ」（連濁現象）。',
    },
  },
]
...
const l4Quiz: UnifiedQuestion[] = [
  ...
  },
  {
    ...
    level: 'N5',
    tags: ['reading'],
    stem: '「花{はな}」は英語{えいご}で何{なん}ですか。',
    stemZh: '「花」的英文是什麼？',
    options: [
      { text: 'flower', reason: '正確。花{はな}意為flower。' },
      { text: 'dog', reason: '錯誤。dog是犬{いぬ}。' },
      { text: 'cat', reason: '錯誤。cat是猫{ねこ}。' },
      { text: 'song', reason: '錯誤。song是歌{うた}。' },
    ],
    correctIndex: 0,
    explanation: {
      keyPoint: '花的詞義',
      analysis: '花{はな}意為花（flower）。注意「鼻{はな}」（鼻子）讀音相同但漢字不同。',
    },
  },
]
