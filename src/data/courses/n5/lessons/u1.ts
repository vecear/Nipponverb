...
const l1Quiz: UnifiedQuestion[] = [
  ...
  },
  {
    ...
    stemZh: '田中先生是老師。',
    options: [
      { text: 'です', reason: '正確。「です」是敬體斷定助動詞，用於禮貌場合。' },
      { text: 'だ', reason: '錯誤。「だ」是常體，在自我介紹等正式場合不適用。' },
    ...
    explanation: {
      keyPoint: '斷定助動詞「です」',
      analysis: '「です」放在名詞或形容動詞後面，表示「是〜」。敬體場合用「です」，常體用「だ」。',
    },
  },
  {
    id: 'cq_n5_u1_l1_007',
...
const l2Quiz: UnifiedQuestion[] = [
  ...
  },
  {
    ...
    explanation: {
      keyPoint: '家族的詞義',
      analysis: '家族{かぞく}意為家人、家族。是描述家庭成員時常用的總稱。',
    },
  },
  {
    id: 'cq_n5_u1_l2_006',
    ...
    options: [
      { text: 'も', reason: '正確。「も」表示「也」，替代「は」使用。' },
    ...
    explanation: {
      ...
      commonMistakes: ['○ 私も学生です / × 私は学生もです → も替代は，不是放在名詞後'],
    },
  },
  {
    id: 'cq_n5_u1_l2_007',
    ...
    level: 'N5',
    tags: ['reading'],
    stem: '「元気{げんき}」の意味{いみ}はどれですか。',
    stemZh: '「元気」的意思是哪個？',
    options: [
      { text: '元氣、精神好', reason: '正確。元気{げんき}意為元氣、精神好。' },
      { text: '名字', reason: '錯誤。名字是名前{なまえ}。' },
      { text: '一起', reason: '錯誤。一起是一緒{いっしょ}。' },
      { text: '國家', reason: '錯誤。國家是国{くに}。' },
    ],
    ...
    explanation: {
      keyPoint: '元気的詞義',
      analysis: '元気{げんき}是形容動詞，意為精神好、健康。常用問候語：「お元気ですか」（你好嗎）。',
    },
  },
]
...
const l4Quiz: UnifiedQuestion[] = [
  ...
  },
  {
    ...
    explanation: {
      keyPoint: '傘的詞義',
      analysis: '傘{かさ}意為傘。這是日常生活中很常用的物品詞彙。',
    },
  },
  {
    id: 'cq_n5_u1_l4_005',
    ...
    level: 'N5',
    tags: ['janai'],
    stem: 'これは私{わたし}のかばん＿＿。田中{たなか}さんのです。',
    stemZh: '這不是我的包包。是田中先生的。',
    options: [
      { text: 'じゃないです', reason: '正確。「じゃないです」否定前面的名詞句。' },
      { text: 'です', reason: '錯誤。語境表示否定，不能用肯定形。' },
      { text: 'ですか', reason: '錯誤。這不是疑問句。' },
      { text: 'でした', reason: '錯誤。「でした」是過去肯定，不是否定。' },
    ],
    correctIndex: 0,
    explanation: {
      keyPoint: '名詞句的否定',
      analysis: '「〜じゃないです」否定名詞句。「私のかばんじゃないです」＝「不是我的包包」。',
    },
  },
  {
    id: 'cq_n5_u1_l4_006',
