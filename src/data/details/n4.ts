...
export const n4Details: Record<string, GrammarPoint> = {
    ...
    'n4_ba': {
        ...
        quiz: [
            ...
            // 第 6 題：陷阱題 - 正確答案是「たら」不是「ば」
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「降ったら」正確！後句是意志表現（邀請），所以不能用「ば」形。「たら」可以接意志表現。這是陷阱題！',
                    wrong: [
        ...
        quiz: [
            ...
            // 第 6 題：陷阱題 - 正確答案是「と」不是「なら」
            {
                ...
                explanation: {
                    ...
                    wrong: [
                        '「たら」錯誤：「たら」強調時{じ}間{かん}順序，這裡是說明因果關係。',
                        '「ば」錯誤：「ば」可以用，但描述機器操作這種必然規律時{じ}「と」更自然。',
    ...
    'n4_saseru': {
        ...
        quiz: [
            ...
            // 第 6 題：陷阱題 - 正確答案是被動形「読まれている」不是使役形「読ませる」
            {
                id: 'n4_saseru_6',
                ...
                explanation: {
                    ...
                    wrong: [
                        '「読ませている」錯誤：「させる」是使役「讓...做」。小說不能「讓人讀」，是「被讀」。',
                        '「読んでいる」錯誤：「読んでいる」是「正在讀」，主語是讀者。這裡主語是小說。',
                        '「読ませられている」錯誤：這是使役被動，意思是「被迫讓人讀」，語意不通。'
                    ]
                }
            }
        ]
            ...
            // 第 6 題：陷阱題 - 正確答案是「くれた」不是「あげた」
            {
                ...
                explanation: {
                    ...
                    wrong: [
                        ...
                        '「あげた」錯誤：「あげる」是「我為他人」做。這裡是「媽媽為我」，方向相反！',
                        '「やった」錯誤：「やる」是對下位者（如動物）使用。'
                    ]
                }
            }
        ]
        ...
        quiz: [
            ...
            // 第 6 題：陷阱題 - 正確答案是「もらった」不是「くれた」
            {
                ...
                explanation: {
                    ...
                    wrong: [
                        '「くれた」錯誤：「くれる」主語是「為我做的人」。這裡主語是「私」，不能用「くれた」！',
                        '「あげた」錯誤：「あげる」是「我為他人做」，但這裡是朋友教我，方向相反。',
                        '「やった」錯誤：「やる」是對下位者使用，對朋友不適合。'
                    ]
                }
            }
        ]
        ...
        quiz: [
            ...
            // 第 6 題：陷阱題 - 正確答案是「くれた」不是「もらった」
            {
                ...
                explanation: {
                    ...
                    wrong: [
                        '「あげた」錯誤：「あげる」是「為他人做」，但他是為我拿，方向相反。',
                        '「やった」錯誤：「やる」是對下位者使用。',
                        '「もらった」錯誤：「もらう」的主語必須是「我」。這裡主語是「彼」，不能用「もらった」！如果要用「もらう」要改成「私は彼に持ってもらった」。'
                    ]
                }
            }
        ]
