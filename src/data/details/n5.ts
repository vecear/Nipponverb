...
Object.assign(n5Details, {
    ...
    n5_cha_ikenai: {
        id: 'n5_cha_ikenai',
        pattern: '～ちゃいけない / ～じゃいけない',
        connection: '動詞て形「て→ちゃ」「で→じゃ」+ いけない',
        translation: '不可以～（口語）',
        level: 'N5',
        explanation: [
            {
                usageId: 1,
                title: '口語禁止表現',
                description: '「～てはいけない」的口語縮約形。表示禁止某個行為。',
                examples: [
                    { japanese: 'ここで走{はし}っちゃいけないよ。', chinese: '不可以在這裡跑步喔。' },
                    { japanese: '嘘{うそ}ついちゃいけない。', chinese: '不可以說謊。' },
                    { japanese: '遊{あそ}んじゃいけない。', chinese: '不可以玩。' }
                ]
            }
        ],
        analysis: {
            title: '縮約規則',
            points: [
                { rule: '「ては」→「ちゃ」', examples: [{ japanese: '食{た}べてはいけない → 食{た}べちゃいけない', chinese: '不可以吃' }] },
                { rule: '「では」→「じゃ」', examples: [{ japanese: '読{よ}んではいけない → 読{よ}んじゃいけない', chinese: '不可以讀' }] }
            ]
        },
        quiz: [
            {
                id: 'n5_q_chaikenai_1',
                sentence: 'ここで写真{しゃしん}を撮{と}っ（　）いけない。',
                options: ['ちゃ', 'じゃ', 'ては', 'なくては'],
                correctIndex: 0,
                explanation: {
                    correct: '「ちゃ」正確！「撮って」的「て」縮約成「ちゃ」。',
                    wrong: [
                        '「じゃ」錯誤：「じゃ」是「で」的縮約形。',
                        '「ては」不太適合：雖然正確但不是口語縮約形。',
                        '「なくては」錯誤：這是「必須」的意思。'
                    ]
                }
            }
        ...
        explanation: [
            {
                usageId: 1,
                title: '斷定助動詞',
                description: '「だ」是普通體，「です」是丁寧體。用於斷定名詞或な形容詞。',
                examples: [
                    { japanese: '私{わたし}は学生{がくせい}だ。', chinese: '我是學生。（普通體）' },
                    { japanese: '私{わたし}は学生{がくせい}です。', chinese: '我是學生。（丁寧體）' },
                    { japanese: 'これは本{ほん}です。', chinese: '這是書。' }
                ]
            }
        ],
        analysis: {
            title: '普通體與丁寧體的使用場合',
            points: [
                { rule: '「だ」用於朋友、家人之間的日常對話', examples: [{ japanese: '今日{きょう}は暇{ひま}だ。', chinese: '今天很閒。' }] },
                { rule: '「です」用於正式場合、對長輩或陌生人', examples: [{ japanese: '今日{きょう}は暇{ひま}です。', chinese: '今天很閒。' }] }
            ]
        },
        quiz: [
            {
                id: 'n5_q_dadesu_1',
                sentence: '先生{せんせい}に話{はな}すとき：「私{わたし}は田中{たなか}（　）。」',
                options: ['です', 'だ', 'である', 'の'],
                correctIndex: 0,
                explanation: {
                    correct: '「です」正確！對老師說話時用丁寧體。',
                    wrong: [
                        '「だ」錯誤：對老師用普通體不禮貌。',
                        '「である」錯誤：書面語，口語不常用。',
                        '「の」錯誤：這裡不適合用「の」。'
        ...
        explanation: [
            {
                usageId: 1,
                title: '限定表現',
                description: '表示限定於某個範圍，強調「只有這個」。',
                examples: [
                    { japanese: 'コーヒーだけ飲{の}みます。', chinese: '只喝咖啡。' },
                    { japanese: '一人{ひとり}だけ来{き}ました。', chinese: '只來了一個人。' },
                    { japanese: '見{み}るだけです。', chinese: '只是看看。' }
                ]
            }
        ],
        analysis: {
            title: '「だけ」與「しか」的差異',
            points: [
                { rule: '「だけ」單純表示限定，語氣中性', examples: [{ japanese: '水{みず}だけ飲{の}む。', chinese: '只喝水。' }] },
                { rule: '「しか～ない」帶有「不足、遺憾」的語氣', examples: [{ japanese: '水{みず}しか飲{の}まない。', chinese: '只喝水（暗示選擇少）。' }] }
            ]
        },
        quiz: [
            {
                id: 'n5_q_dake_1',
                sentence: '今日{きょう}は野菜{やさい}（　）食{た}べます。',
                options: ['だけ', 'しか', 'ばかり', 'まで'],
                correctIndex: 0,
                explanation: {
                    correct: '「だけ」正確！表示「只吃蔬菜」。',
                    wrong: [
                        '「しか」錯誤：「しか」後面需接否定形。',
                        '「ばかり」錯誤：「ばかり」表示「淨是、盡是」。',
                        '「まで」錯誤：「まで」表示「到～為止」。'
    ...
    n5_darou: {
        id: 'n5_darou',
        pattern: '～だろう',
        connection: '動詞/形容詞普通形 + だろう、名詞/な形容詞 + だろう',
        translation: '大概～吧、應該是～',
        level: 'N5',
        explanation: [
            {
                usageId: 1,
                title: '推測表現',
                description: '表示說話者的推測或猜測。「でしょう」是丁寧體。',
                examples: [
                    { japanese: '明日{あした}は雨{あめ}だろう。', chinese: '明天大概會下雨吧。' },
                    { japanese: '彼{かれ}は来{く}るだろう。', chinese: '他應該會來吧。' },
                    { japanese: '美味{おい}しいだろう。', chinese: '應該很好吃吧。' }
                ]
            }
        ],
        analysis: {
            title: '「だろう」的語調變化',
            points: [
                { rule: '下降語調：表示推測', examples: [{ japanese: '雨{あめ}だろう↓', chinese: '大概會下雨吧。' }] },
                { rule: '上升語調：尋求同意', examples: [{ japanese: '美味{おい}しいだろう↑？', chinese: '很好吃吧？（對吧？）' }] }
            ]
        },
        quiz: [
            {
                ...
                options: ['だろう', 'です', 'ます', 'でした'],
                correctIndex: 0,
                explanation: {
                    correct: '「だろう」正確！表示對天氣的推測。',
                    wrong: [
                        '「です」錯誤：「です」是斷定，不是推測。',
                        '「ます」錯誤：「晴れるます」文法錯誤。',
                        '「でした」錯誤：「でした」是過去式。'
    ...
    n5_de: {
        ...
        explanation: [
            {
                ...
                examples: [
                    { japanese: '図書館{としょかん}で勉強{べんきょう}します。', chinese: '在圖書館讀書。' },
                    { japanese: '公園{こうえん}で遊{あそ}びます。', chinese: '在公園玩。' }
                ]
            },
            {
                usageId: 2,
                title: '手段・方法',
                description: '表示使用的工具或方法。',
                examples: [
                    { japanese: '箸{はし}で食{た}べます。', chinese: '用筷子吃。' },
                    { japanese: '日本語{にほんご}で話{はな}します。', chinese: '用日語說話。' }
                ]
            },
            {
                usageId: 3,
                ...
                description: '表示原因或理由。',
                examples: [
                    { japanese: '病気{びょうき}で休{やす}みました。', chinese: '因為生病而休息了。' },
        ...
        analysis: {
            title: '「で」與「に」的區別',
            points: [
                { rule: '「で」：動作進行的場所', examples: [{ japanese: '図書館{としょかん}で本{ほん}を読{よ}む。', chinese: '在圖書館看書（動作）。' }] },
                { rule: '「に」：存在的場所', examples: [{ japanese: '図書館{としょかん}に本{ほん}がある。', chinese: '圖書館裡有書（存在）。' }] }
            ]
        },
        quiz: [
            {
                id: 'n5_q_de_1',
                sentence: 'レストラン（　）食{た}べます。',
                options: ['で', 'に', 'を', 'が'],
                correctIndex: 0,
                explanation: {
                    correct: '「で」正確！表示「吃」這個動作進行的場所。',
                    wrong: [
                        '「に」錯誤：「に」用於存在的場所或目的地。',
                        '「を」錯誤：「を」是受詞助詞。',
                        '「が」錯誤：「が」是主語助詞。'
        ...
        explanation: [
            {
                usageId: 1,
                title: '舉例（隨意舉一個例子）',
                description: '表示隨意舉出一個例子，暗示還有其他選擇。',
                examples: [
                    { japanese: 'コーヒーでも飲{の}みませんか。', chinese: '喝杯咖啡之類的如何？' },
                    { japanese: '映画{えいが}でも見{み}ましょう。', chinese: '看個電影之類的吧。' }
                ]
            },
            {
                usageId: 2,
                title: '讓步（即使～也）',
                description: '表示即使在某種情況下也不變。',
                examples: [
                    { japanese: '雨{あめ}でも行{い}きます。', chinese: '即使下雨也去。' },
                    { japanese: '誰{だれ}でもできる。', chinese: '誰都可以做。' }
                ]
            }
        ],
        quiz: [
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「でも」正確！表示「喝茶之類的」建議。',
                    wrong: [
                        '「を」不太適合：「を」太直接，沒有「之類的」的隨意感。',
                        '「が」錯誤：「が」是主語助詞。',
                        '「は」不太適合：「は」是主題助詞。'
                    ]
                }
    ...
    n5_deshou: {
        id: 'n5_deshou',
        pattern: '～でしょう',
        connection: '動詞/形容詞普通形 + でしょう、名詞/な形容詞 + でしょう',
        translation: '大概～吧（丁寧體）',
        level: 'N5',
        explanation: [
            {
                usageId: 1,
                title: '推測（丁寧體）',
                description: '「だろう」的丁寧體，表示推測或猜測。',
                examples: [
                    { japanese: '明日{あした}は晴{は}れるでしょう。', chinese: '明天應該會放晴吧。' },
                    { japanese: '彼女{かのじょ}は来{く}るでしょう。', chinese: '她應該會來吧。' },
                    { japanese: 'これは高{たか}いでしょう。', chinese: '這個應該很貴吧。' }
                ]
            }
        ],
        analysis: {
            title: '「でしょう」的用法',
            points: [
                { rule: '天氣預報常用「でしょう」表示預測', examples: [{ japanese: '午後{ごご}から雨{あめ}が降{ふ}るでしょう。', chinese: '下午應該會下雨。' }] },
                { rule: '上升語調時表示確認', examples: [{ japanese: 'おいしいでしょう？', chinese: '很好吃吧？（對吧？）' }] }
            ]
        },
        quiz: [
            {
                id: 'n5_q_deshou_1',
                sentence: '明日{あした}の天気{てんき}は良{よ}い（　）。',
                options: ['でしょう', 'です', 'でした', 'ですか'],
                correctIndex: 0,
                explanation: {
                    correct: '「でしょう」正確！表示對天氣的推測。',
                    wrong: [
                        '「です」錯誤：「です」是斷定，不是推測。',
                        '「でした」錯誤：這是過去式。',
                        '「ですか」錯誤：這是疑問形式。'
        ...
        explanation: [
            {
                usageId: 1,
                title: '詢問性質或種類',
                description: '用來詢問事物的性質、特徵或種類。',
                examples: [
                    { japanese: 'どんな音楽{おんがく}が好{す}きですか。', chinese: '你喜歡什麼樣的音樂？' },
                    { japanese: 'どんな人{ひと}ですか。', chinese: '是什麼樣的人？' },
                    { japanese: 'どんな味{あじ}ですか。', chinese: '是什麼味道？' }
                ]
            }
        ],
        analysis: {
            title: '「どんな」「何の」「どの」的區別',
            points: [
                { rule: '「どんな」：詢問性質、特徵', examples: [{ japanese: 'どんな映画{えいが}？', chinese: '什麼樣的電影？（恐怖？喜劇？）' }] },
                { rule: '「何の」：詢問具體內容', examples: [{ japanese: '何{なん}の映画{えいが}？', chinese: '什麼電影？（片名）' }] },
                { rule: '「どの」：從特定範圍中選擇', examples: [{ japanese: 'どの映画{えいが}？', chinese: '哪部電影？（從這些中選）' }] }
            ]
        },
        quiz: [
            {
                id: 'n5_q_donna_1',
                sentence: '（　）料理{りょうり}が好{す}きですか。',
                options: ['どんな', 'どの', '何の', 'どこの'],
                correctIndex: 0,
                explanation: {
                    correct: '「どんな」正確！詢問喜歡什麼類型的料理。',
                    wrong: [
                        '「どの」錯誤：「どの」用於從特定選項中選擇。',
                        '「何の」不太適合：「何の料理」較少使用。',
                        '「どこの」錯誤：「どこの」問的是哪裡的。'
        ...
        explanation: [
            {
                usageId: 1,
                title: '詢問理由',
                description: '用來詢問原因或理由，語氣比「なぜ」柔和。',
                examples: [
                    { japanese: 'どうして遅{おく}れたの？', chinese: '為什麼遲到了？' },
                    { japanese: 'どうして日本語{にほんご}を勉強{べんきょう}していますか。', chinese: '為什麼在學日語？' },
                    { japanese: 'どうしてここにいるの？', chinese: '為什麼在這裡？' }
                ]
            }
        ],
        analysis: {
            title: '「どうして」「なぜ」「なんで」的區別',
            points: [
                { rule: '「どうして」：一般口語，語氣柔和', examples: [{ japanese: 'どうして泣{な}いているの？', chinese: '為什麼在哭？（關心）' }] },
                { rule: '「なぜ」：較正式，有時帶追問語氣', examples: [{ japanese: 'なぜ遅{おく}れた？', chinese: '為何遲到？（較嚴肅）' }] },
                { rule: '「なんで」：口語，較隨意', examples: [{ japanese: 'なんで？', chinese: '為啥？' }] }
            ]
        },
        quiz: [
            {
                id: 'n5_q_doushite_1',
                sentence: '（　）学校{がっこう}を休{やす}んだの？',
                options: ['どうして', 'どこで', 'いつ', 'だれが'],
                correctIndex: 0,
                explanation: {
                    correct: '「どうして」正確！詢問缺課的原因。',
                    wrong: [
                        '「どこで」錯誤：「どこで」問的是地點。',
                        '「いつ」錯誤：「いつ」問的是時間。',
                        '「だれが」錯誤：「だれが」問的是誰。'
        ...
        explanation: [
            {
                usageId: 1,
                title: '詢問方法',
                description: '用來詢問做某事的方法或手段。',
                examples: [
                    { japanese: 'どうやって作{つく}りますか。', chinese: '怎麼做？' },
                    { japanese: '駅{えき}へはどうやって行{い}きますか。', chinese: '車站怎麼去？' },
                    { japanese: 'どうやって使{つか}いますか。', chinese: '怎麼使用？' }
                ]
            }
        ],
        analysis: {
            title: '「どうやって」與「どう」的區別',
            points: [
                { rule: '「どうやって」：具體詢問方法、步驟', examples: [{ japanese: 'どうやって開{あ}けますか。', chinese: '怎麼打開？（具體操作）' }] },
                { rule: '「どう」：詢問狀態或感想', examples: [{ japanese: 'どうですか。', chinese: '怎麼樣？（感想）' }] }
            ]
        },
        quiz: [
            {
                id: 'n5_q_douyatte_1',
                sentence: 'この漢字{かんじ}は（　）読{よ}みますか。',
                options: ['どうやって', 'どうして', 'どこで', 'いつ'],
                correctIndex: 0,
                explanation: {
                    correct: '「どうやって」正確！詢問漢字的讀法。',
                    wrong: [
                        '「どうして」錯誤：「どうして」問的是原因。',
                        '「どこで」錯誤：「どこで」問的是地點。',
                        '「いつ」錯誤：「いつ」問的是時間。'
        ...
        explanation: [
            {
                usageId: 1,
                title: '標示主語',
                description: '「が」標示句子的主語，強調「是這個」而不是別的。',
                examples: [
                    { japanese: '誰{だれ}が来{き}ましたか。', chinese: '誰來了？' },
                    { japanese: '私{わたし}が行{い}きます。', chinese: '我去。（強調是我）' },
                    { japanese: '雨{あめ}が降{ふ}っています。', chinese: '正在下雨。' }
                ]
            },
            {
                usageId: 2,
                title: '能力・好惡・希望的對象',
                description: '「わかる」「できる」「好き」「欲しい」等詞前面用「が」。',
                examples: [
                    { japanese: '日本語{にほんご}がわかります。', chinese: '懂日語。' },
                    { japanese: '寿司{すし}が好{す}きです。', chinese: '喜歡壽司。' },
                    { japanese: '水{みず}が欲{ほ}しい。', chinese: '想要水。' }
                ]
            }
        ],
        analysis: {
            title: '「が」與「は」的區別',
            points: [
                { rule: '「が」強調主語本身（新資訊、對比）', examples: [{ japanese: '誰{だれ}が食{た}べた？→私{わたし}が食{た}べた。', chinese: '誰吃的？→我吃的。' }] },
                { rule: '「は」標示話題（已知資訊）', examples: [{ japanese: '私{わたし}は学生{がくせい}です。', chinese: '我是學生。' }] }
            ]
        },
        quiz: [
            {
                id: 'n5_q_ga_1',
                sentence: '日本語{にほんご}（　）わかりますか。',
                options: ['が', 'は', 'を', 'で'],
                correctIndex: 0,
                explanation: {
                    correct: '「が」正確！「わかる」前面用「が」。',
                    wrong: [
                        '「は」不太適合：「わかる」的對象用「が」較自然。',
                        '「を」錯誤：「わかる」不是他動詞，不用「を」。',
                        '「で」錯誤：「で」表示場所或手段。'
                    ]
                }
        ...
        explanation: [
            {
                usageId: 1,
                title: '表示非生物的存在',
                description: '表示物品、場所、抽象事物等非生物的存在。',
                examples: [
                    { japanese: '机{つくえ}の上{うえ}に本{ほん}があります。', chinese: '桌上有書。' },
                    { japanese: '質問{しつもん}がありますか。', chinese: '有問題嗎？' },
                    { japanese: '時間{じかん}がありません。', chinese: '沒有時間。' }
                ]
            }
        ],
        analysis: {
            title: '「あります」與「います」的區別',
            points: [
                { rule: '「あります」：物品、植物、抽象事物', examples: [{ japanese: '花{はな}があります。', chinese: '有花。' }] },
                { rule: '「います」：人、動物等有生命會動的', examples: [{ japanese: '猫{ねこ}がいます。', chinese: '有貓。' }] }
            ]
        },
        quiz: [
            {
                id: 'n5_q_gaarimasu_1',
                sentence: '教室{きょうしつ}に机{つくえ}が（　）。',
                options: ['あります', 'います', 'です', 'ます'],
                correctIndex: 0,
                explanation: {
                    correct: '「あります」正確！桌子是非生物，用「あります」。',
                    wrong: [
                        '「います」錯誤：「います」用於生物。',
                        '「です」錯誤：「です」是斷定，不是存在。',
                        '「ます」錯誤：「ます」不能單獨使用。'
        ...
        explanation: [
            {
                usageId: 1,
                title: '表示想要某物',
                description: '表示說話者想要得到某個東西。注意：主要用於第一人稱。',
                examples: [
                    { japanese: '新{あたら}しい車{くるま}がほしいです。', chinese: '想要新車。' },
                    { japanese: '何{なに}がほしいですか。', chinese: '想要什麼？' },
                    { japanese: '休{やす}みがほしい。', chinese: '想要休假。' }
                ]
            }
        ],
        analysis: {
            title: '「ほしい」與「たい」的區別',
            points: [
                { rule: '「ほしい」：想要「物品」', examples: [{ japanese: 'お金{かね}がほしい。', chinese: '想要錢。' }] },
                { rule: '「たい」：想要「做某事」', examples: [{ japanese: 'お金{かね}を稼{かせ}ぎたい。', chinese: '想賺錢。' }] }
            ]
        },
        quiz: [
            {
                id: 'n5_q_gahoshii_1',
                sentence: '冷{つめ}たい水{みず}（　）ほしいです。',
                options: ['が', 'を', 'は', 'に'],
                correctIndex: 0,
                explanation: {
        ...
        explanation: [
            {
                usageId: 1,
                title: '表示生物的存在',
                description: '表示人、動物等有生命會動的東西的存在。',
                examples: [
                    { japanese: '公園{こうえん}に子供{こども}がいます。', chinese: '公園裡有小孩。' },
                    { japanese: '犬{いぬ}がいますか。', chinese: '有狗嗎？' },
                    { japanese: '誰{だれ}もいません。', chinese: '沒有任何人。' }
                ]
            }
        ],
        quiz: [
            {
                id: 'n5_q_gaimasu_1',
                sentence: '庭{にわ}に猫{ねこ}が（　）。',
                options: ['います', 'あります', 'です', 'ます'],
                correctIndex: 0,
                explanation: {
                    correct: '「います」正確！貓是生物，用「います」。',
                    wrong: [
                        '「あります」錯誤：「あります」用於非生物。',
                        '「です」錯誤：「です」是斷定，不是存在。',
                        '「ます」錯誤：「ます」不能單獨使用。'
    ...
    n5_hou_ga_ii: {
        ...
        translation: '最好～、還是～比較好',
        level: 'N5',
        explanation: [
            {
                usageId: 1,
                title: '給予建議',
                description: '用來給對方建議或忠告。「た形＋ほうがいい」語氣較強烈。',
                examples: [
                    { japanese: '早{はや}く寝{ね}たほうがいいですよ。', chinese: '最好早點睡喔。' },
                    { japanese: '傘{かさ}を持{も}っていったほうがいい。', chinese: '帶傘去比較好。' },
                    { japanese: '食{た}べないほうがいい。', chinese: '最好不要吃。' }
                ]
            }
        ],
        analysis: {
            title: '肯定建議與否定建議',
            points: [
                { rule: '「た形＋ほうがいい」：建議做某事', examples: [{ japanese: '薬{くすり}を飲{の}んだほうがいい。', chinese: '最好吃藥。' }] },
                { rule: '「ない形＋ほうがいい」：建議不要做', examples: [{ japanese: '無理{むり}しないほうがいい。', chinese: '最好不要勉強。' }] }
            ]
        },
        quiz: [
            {
                id: 'n5_q_hougaii_1',
                sentence: '風邪{かぜ}のとき、休{やす}（　）ほうがいいです。',
                options: ['んだ', 'む', 'まない', 'んで'],
                correctIndex: 0,
                explanation: {
                    correct: '「んだ」正確！「休む」的た形是「休んだ」。',
                    wrong: [
                        '「む」錯誤：需要た形，不是辭書形。',
                        '「まない」錯誤：「まない」是否定形。',
                        '「んで」錯誤：「んで」是て形。'
        ...
        explanation: [
            {
                ...
                description: '表示和某人一起做某事。',
                examples: [
                    { japanese: '友達{ともだち}と一緒{いっしょ}に映画{えいが}を見{み}ました。', chinese: '和朋友一起看了電影。' },
                    { japanese: '家族{かぞく}と一緒{いっしょ}に食{た}べます。', chinese: '和家人一起吃。' },
                    { japanese: '一緒{いっしょ}に行{い}きませんか。', chinese: '要不要一起去？' }
                ]
            }
        ],
        quiz: [
            {
                id: 'n5_q_isshoni_1',
                sentence: '彼女{かのじょ}（　）一緒{いっしょ}に勉強{べんきょう}します。',
                options: ['と', 'で', 'に', 'を'],
                correctIndex: 0,
                explanation: {
                    correct: '「と」正確！「～と一緒に」表示和某人一起。',
                    wrong: [
                        '「で」錯誤：「で」表示場所或手段。',
                        '「に」錯誤：「に」表示目的地或對象。',
                        '「を」錯誤：「を」是受詞助詞。'
        ...
        explanation: [
            {
                usageId: 1,
                title: '否定表現（口語）',
                description: '「ではない」的口語縮約形。表示否定。',
                examples: [
                    { japanese: 'これは私{わたし}のじゃない。', chinese: '這不是我的。' },
                    { japanese: '彼{かれ}は学生{がくせい}じゃない。', chinese: '他不是學生。' },
                    { japanese: '静{しず}かじゃない。', chinese: '不安靜。' }
                ]
            }
        ],
        analysis: {
            title: '口語與書面語',
            points: [
                { rule: '口語：「じゃない」', examples: [{ japanese: '違{ちが}うじゃない？', chinese: '不一樣吧？' }] },
                { rule: '書面語/丁寧：「ではありません」', examples: [{ japanese: '違{ちが}うのではありません。', chinese: '並非不同。' }] }
            ]
        },
        quiz: [
            {
                id: 'n5_q_janai_1',
                sentence: 'これは私{わたし}の本{ほん}（　）。',
                options: ['じゃない', 'ではない', 'くない', 'ない'],
                correctIndex: 0,
                explanation: {
                    correct: '「じゃない」正確！名詞的否定用「じゃない」。',
                    wrong: [
                        '「ではない」也正確但較正式。',
                        '「くない」錯誤：「くない」是い形容詞的否定。',
                        '「ない」錯誤：「ない」單獨不能接名詞。'
        ...
        explanation: [
            {
                usageId: 1,
                title: '疑問句',
                description: '「か」是疑問助詞，用於句尾表示疑問。',
                examples: [
                    { japanese: 'これは何{なん}ですか。', chinese: '這是什麼？' },
                    { japanese: '日本人{にほんじん}ですか。', chinese: '是日本人嗎？' },
                    { japanese: '分{わ}かりましたか。', chinese: '懂了嗎？' }
                ]
            }
        ],
        analysis: {
            title: '疑問句的語調',
            points: [
                { rule: '丁寧體疑問句通常不需要上升語調', examples: [{ japanese: 'これは何{なん}ですか。', chinese: '這是什麼？' }] },
                { rule: '普通體省略「か」時用上升語調', examples: [{ japanese: 'これ、何{なに}？↑', chinese: '這是什麼？（口語）' }] }
            ]
        },
        quiz: [
            {
                id: 'n5_q_ka_1',
                sentence: 'あなたは学生{がくせい}です（　）。',
                options: ['か', 'よ', 'ね', 'の'],
                correctIndex: 0,
                explanation: {
                    correct: '「か」正確！疑問句用「か」。',
        ...
        explanation: [
            {
                usageId: 1,
                title: '選擇疑問',
                description: '用於詢問二選一的問題。',
                examples: [
                    { japanese: 'コーヒーか紅茶{こうちゃ}か、どちらがいいですか。', chinese: '咖啡還是紅茶，哪個好？' },
                    { japanese: '行{い}くか行{い}かないか、決{き}めてください。', chinese: '去還是不去，請決定。' },
                    { japanese: '今日{きょう}か明日{あした}か教{おし}えてください。', chinese: '請告訴我是今天還是明天。' }
                ]
            }
        ],
        quiz: [
            {
                id: 'n5_q_kaka_1',
                sentence: '肉{にく}（　）魚{さかな}（　）、どちらが好{す}きですか。',
                options: ['か、か', 'と、と', 'や、や', 'も、も'],
                correctIndex: 0,
                explanation: {
                    correct: '「か、か」正確！表示選擇疑問。',
                    wrong: [
                        '「と、と」錯誤：「と」是列舉。',
                        '「や、や」錯誤：「や」是舉例。',
                        '「も、も」錯誤：「も」表示「也」。'
        ...
        explanation: [
            {
                usageId: 1,
                title: '表示原因・理由',
                description: '用於說明原因或理由。可以接在普通形或丁寧形後面。',
                examples: [
                    { japanese: '疲{つか}れたから、休{やす}みます。', chinese: '因為累了，所以休息。' },
                    { japanese: '雨{あめ}だから、傘{かさ}を持{も}っていきます。', chinese: '因為下雨，所以帶傘。' },
                    { japanese: '美味{おい}しいですから、食{た}べてください。', chinese: '因為好吃，請吃。' }
                ]
            },
            {
                usageId: 2,
                title: '表示起點',
                description: '「から」也可表示時間或地點的起點。',
                examples: [
                    { japanese: '9時{じ}から始{はじ}まります。', chinese: '從9點開始。' },
                    { japanese: '東京{とうきょう}から来{き}ました。', chinese: '從東京來的。' }
                ]
            }
        ],
        analysis: {
            title: '「から」與「ので」的區別',
            points: [
                { rule: '「から」：主觀理由，語氣較直接', examples: [{ japanese: '眠{ねむ}いから寝{ね}る。', chinese: '因為睏所以睡覺。' }] },
                { rule: '「ので」：客觀理由，語氣較柔和', examples: [{ japanese: '眠{ねむ}いので寝{ね}ます。', chinese: '因為睏所以睡覺。（較禮貌）' }] }
            ]
        },
        quiz: [
            {
                id: 'n5_q_kara_1',
                sentence: '時間{じかん}がない（　）、急{いそ}ぎましょう。',
                options: ['から', 'ので', 'けど', 'し'],
                correctIndex: 0,
                explanation: {
                    correct: '「から」正確！表示原因。',
        ...
        explanation: [
            {
                usageId: 1,
                title: '表示方法',
                description: '接在動詞ます形後面，表示做某事的方法。',
                examples: [
                    { japanese: '使{つか}い方{かた}を教{おし}えてください。', chinese: '請教我使用方法。' },
                    { japanese: '食{た}べ方{かた}が分{わ}かりません。', chinese: '不知道怎麼吃。' },
                    { japanese: '読{よ}み方{かた}は何{なん}ですか。', chinese: '讀音是什麼？' }
                ]
            }
        ],
        quiz: [
            {
                id: 'n5_q_kata_1',
                sentence: 'この漢字{かんじ}の書{か}き（　）を教{おし}えてください。',
                options: ['方', '式', '法', '形'],
                correctIndex: 0,
                explanation: {
                    correct: '「方」正確！「書き方」表示書寫方法。',
                    wrong: [
                        '「式」錯誤：「式」不這樣用。',
                        '「法」錯誤：「法」通常用於更正式的場合。',
                        '「形」錯誤：「形」表示形狀。'
        ...
        explanation: [
            {
                usageId: 1,
                title: '逆接（轉折）',
                description: '表示前後對比或轉折關係。口語形式。',
                examples: [
                    { japanese: '高{たか}いけど、買{か}います。', chinese: '雖然貴，但是買。' },
                    { japanese: '食{た}べたいけど、時間{じかん}がない。', chinese: '雖然想吃，但沒時間。' },
                    { japanese: '行{い}きたいけど…', chinese: '雖然想去但是...（欲言又止）' }
                ]
            },
            {
                usageId: 2,
                title: '話題導入',
                description: '用於開始話題或引起注意。',
                examples: [
                    { japanese: 'すみませんけど、ちょっといいですか。', chinese: '不好意思，可以打擾一下嗎？' },
                    { japanese: '明日{あした}のことなんですけど…', chinese: '關於明天的事...' }
                ]
            }
        ],
        quiz: [
    ...
    n5_keredo_mo: {
        ...
        pattern: '～けれども',
        connection: '句子 + けれども',
        translation: '雖然～但是（較正式）',
        level: 'N5',
        explanation: [
            {
                usageId: 1,
                title: '逆接（正式）',
                description: '「けど」的正式說法。書面語或正式場合使用。',
                examples: [
                    { japanese: '努力{どりょく}したけれども、失敗{しっぱい}しました。', chinese: '雖然努力了，但是失敗了。' },
                    { japanese: '高価{こうか}ではありますけれども、品質{ひんしつ}は良{よ}いです。', chinese: '雖然昂貴，但品質很好。' }
                ]
            }
        ],
        analysis: {
            title: '禮貌程度比較',
            points: [
                { rule: '「けど」：最口語', examples: [{ japanese: '忙{いそが}しいけど、行{い}く。', chinese: '雖然忙但去。' }] },
                { rule: '「けれど」：稍正式', examples: [{ japanese: '忙{いそが}しいけれど、行{い}きます。', chinese: '雖然忙但去。' }] },
                { rule: '「けれども」：最正式', examples: [{ japanese: '忙{いそが}しいけれども、参{さん}ります。', chinese: '雖然忙但會參加。' }] }
            ]
        },
        quiz: [
            {
                id: 'n5_q_keredomo_1',
                sentence: '（正式場合）お忙{いそが}しいところ恐{おそ}れ入{い}ります（　）、少{すこ}しよろしいでしょうか。',
                options: ['けれども', 'けど', 'が', 'でも'],
                correctIndex: 0,
                explanation: {
                    correct: '「けれども」正確！正式場合用較禮貌的形式。',
                    wrong: [
                        '「けど」不太適合：太口語。',
                        '「が」也可以，但「けれども」更禮貌。',
                        '「でも」錯誤：「でも」用法不同。'
    ...
    n5_mada: {
        id: 'n5_mada',
        pattern: 'まだ',
        connection: 'まだ + 動詞て形いない / まだ + 形容詞/名詞',
        translation: '還、仍然',
        level: 'N5',
        explanation: [
            {
                usageId: 1,
                title: '表示狀態持續',
                description: '表示某狀態持續到現在。',
                examples: [
                    { japanese: 'まだ雨{あめ}が降{ふ}っています。', chinese: '還在下雨。' },
                    { japanese: 'まだ若{わか}いです。', chinese: '還年輕。' },
                    { japanese: 'まだ学生{がくせい}です。', chinese: '還是學生。' }
                ]
            },
            {
                usageId: 2,
                title: '表示未完成',
                description: '與「～ていません」搭配，表示尚未完成。',
                examples: [
                    { japanese: 'まだ食{た}べていません。', chinese: '還沒吃。' },
                    { japanese: 'まだ決{き}めていません。', chinese: '還沒決定。' }
                ]
            }
        ],
        analysis: {
            title: '「まだ」與「もう」的對比',
            points: [
                { rule: '「まだ～ていない」：還沒～', examples: [{ japanese: 'まだ起{お}きていない。', chinese: '還沒起床。' }] },
                { rule: '「もう～た」：已經～', examples: [{ japanese: 'もう起{お}きた。', chinese: '已經起床了。' }] }
            ]
        },
        quiz: [
            {
                id: 'n5_q_mada_1',
                sentence: '宿題{しゅくだい}は（　）終{お}わっていません。',
                options: ['まだ', 'もう', 'また', 'まあ'],
                correctIndex: 0,
                explanation: {
                    correct: '「まだ」正確！表示「還沒完成」。',
                    wrong: [
                        '「もう」錯誤：「もう」表示「已經」。',
                        '「また」錯誤：「また」表示「又、再」。',
                        '「まあ」錯誤：「まあ」是感嘆詞。'
        ...
        explanation: [
            {
                usageId: 1,
                title: '表示動作尚未完成',
                description: '表示某個動作到現在還沒有做。',
                examples: [
                    { japanese: 'まだ朝{あさ}ご飯{はん}を食{た}べていません。', chinese: '還沒吃早餐。' },
                    { japanese: 'まだ見{み}ていません。', chinese: '還沒看。' },
                    { japanese: 'まだ届{とど}いていません。', chinese: '還沒收到。' }
                ]
            }
        ],
        quiz: [
            {
                id: 'n5_q_madateimasen_1',
                sentence: 'レポートはまだ（　）。',
                options: ['書いていません', '書きました', '書きます', '書いた'],
                correctIndex: 0,
                explanation: {
                    correct: '「書いていません」正確！「まだ～ていません」表示還沒完成。',
                    wrong: [
                        '「書きました」錯誤：這是已完成的意思。',
                        '「書きます」錯誤：這是將來要寫。',
                        '「書いた」錯誤：這是已經寫了。'
    ...
    n5_made: {
        ...
        explanation: [
            {
                ...
                description: '表示時間的終點。',
                examples: [
                    { japanese: '5時{じ}まで働{はたら}きます。', chinese: '工作到5點。' },
                    { japanese: '来週{らいしゅう}まで待{ま}ってください。', chinese: '請等到下週。' }
                ]
            },
            {
                usageId: 2,
                ...
                description: '表示地點的終點。',
                examples: [
                    { japanese: '駅{えき}まで歩{ある}きます。', chinese: '走到車站。' },
                    { japanese: '東京{とうきょう}まで行{い}きます。', chinese: '去到東京。' }
                ]
            }
        ],
        analysis: {
            title: '「まで」與「までに」的區別',
            points: [
                { rule: '「まで」：表示動作持續的終點', examples: [{ japanese: '5時{じ}まで勉強{べんきょう}する。', chinese: '讀書讀到5點。' }] },
                { rule: '「までに」：表示期限', examples: [{ japanese: '5時{じ}までに終{お}わらせる。', chinese: '在5點前完成。' }] }
            ]
        },
        quiz: [
            {
                id: 'n5_q_made_1',
                sentence: '明日{あした}（　）にレポートを出{だ}してください。',
                options: ['まで', 'から', 'に', 'で'],
                correctIndex: 0,
                explanation: {
                    correct: '「まで」正確！「までに」表示期限。',
                    wrong: [
                        '「から」錯誤：「から」表示起點。',
                        '「に」不太適合：單獨的「に」不表示期限。',
                        '「で」錯誤：「で」表示場所或手段。'
        ...
        explanation: [
            {
                usageId: 1,
                title: '禮貌的邀請',
                description: '用否定疑問的形式來禮貌地邀請對方。',
                examples: [
                    { japanese: '一緒{いっしょ}に食{た}べませんか。', chinese: '要不要一起吃？' },
                    { japanese: '映画{えいが}を見{み}ませんか。', chinese: '要不要看電影？' },
                    { japanese: 'お茶{ちゃ}でも飲{の}みませんか。', chinese: '要不要喝杯茶之類的？' }
                ]
            }
        ],
        analysis: {
            title: '「～ませんか」與「～ましょうか」的區別',
            points: [
                { rule: '「～ませんか」：邀請對方', examples: [{ japanese: '行{い}きませんか。', chinese: '要不要去？' }] },
                { rule: '「～ましょうか」：提議幫忙', examples: [{ japanese: '持{も}ちましょうか。', chinese: '我來幫你拿好嗎？' }] }
            ]
        },
        quiz: [
            {
                id: 'n5_q_masenka_1',
                sentence: '今度{こんど}一緒{いっしょ}にカラオケに（　）。',
                options: ['行きませんか', '行きましょうか', '行きますか', '行くか'],
                correctIndex: 0,
                explanation: {
                    correct: '「行きませんか」正確！禮貌的邀請。',
                    wrong: [
                        '「行きましょうか」不太適合：這是提議幫忙時用的。',
                        '「行きますか」不太適合：這是單純詢問。',
                        '「行くか」錯誤：太隨便。'
                    ]
                }
    ...
    n5_mashouka: {
        id: 'n5_mashouka',
        pattern: '～ましょうか',
        connection: '動詞ます形（去ます）+ ましょうか',
        translation: '要不要我～？（提議幫忙）',
        level: 'N5',
        explanation: [
            {
                usageId: 1,
                title: '提議幫忙',
                description: '用於主動提出為對方做某事。',
                examples: [
                    { japanese: '荷物{にもつ}を持{も}ちましょうか。', chinese: '我幫你拿行李好嗎？' },
                    { japanese: '窓{まど}を開{あ}けましょうか。', chinese: '要不要我開窗？' },
                    { japanese: '手伝{てつだ}いましょうか。', chinese: '要不要我幫忙？' }
                ]
            }
        ],
        quiz: [
            {
                id: 'n5_q_mashouka_1',
                sentence: '重{おも}そうですね。（　）。',
                options: ['持ちましょうか', '持ちませんか', '持ちますか', '持っていますか'],
                correctIndex: 0,
                explanation: {
                    correct: '「持ちましょうか」正確！提議幫對方拿。',
                    wrong: [
                        '「持ちませんか」錯誤：這是邀請，不是提議幫忙。',
                        '「持ちますか」錯誤：這是單純詢問。',
                        '「持っていますか」錯誤：這是問「你有嗎」。'
                    ]
                }
        ...
        explanation: [
            {
                usageId: 1,
                title: '表示「也」',
                description: '表示同樣適用於另一個對象。',
                examples: [
                    { japanese: '私{わたし}も行{い}きます。', chinese: '我也去。' },
                    { japanese: 'これも美味{おい}しいです。', chinese: '這個也好吃。' },
                    { japanese: '彼{かれ}も学生{がくせい}です。', chinese: '他也是學生。' }
                ]
            },
            {
                usageId: 2,
                title: '表示強調數量',
                description: '與數量詞搭配，表示「多達」或「連...都」。',
                examples: [
                    { japanese: '3時間{じかん}も待{ま}った。', chinese: '等了足足3小時。' },
                    { japanese: '一口{ひとくち}も食{た}べなかった。', chinese: '一口都沒吃。' }
                ]
            }
        ],
        quiz: [
            {
                id: 'n5_q_mo_1',
                sentence: '田中{たなか}さんは日本人{にほんじん}です。山田{やまだ}さん（　）日本人{にほんじん}です。',
                options: ['も', 'は', 'が', 'を'],
                correctIndex: 0,
                explanation: {
                    correct: '「も」正確！表示「山田也是日本人」。',
                    wrong: [
                        '「は」不太適合：這裡要表達「也」的意思。',
                        '「が」錯誤：「が」不表示「也」。',
                        '「を」錯誤：「を」是受詞助詞。'
    ...
    n5_mou: {
        id: 'n5_mou',
        pattern: 'もう',
        connection: 'もう + 動詞た形 / もう + 數量',
        translation: '已經、再（多一個）',
        level: 'N5',
        explanation: [
            {
                usageId: 1,
                title: '表示「已經」',
                description: '與動詞た形搭配，表示動作已完成。',
                examples: [
                    { japanese: 'もう食{た}べました。', chinese: '已經吃了。' },
                    { japanese: 'もう終{お}わりましたか。', chinese: '已經結束了嗎？' },
                    { japanese: 'もう帰{かえ}った。', chinese: '已經回去了。' }
                ]
            },
            {
                usageId: 2,
                title: '表示「再、另外」',
                description: '與數量詞搭配，表示追加。',
                examples: [
                    { japanese: 'もう一度{いちど}言{い}ってください。', chinese: '請再說一次。' },
                    { japanese: 'もう一杯{いっぱい}どうですか。', chinese: '再來一杯如何？' }
                ]
            }
        ],
        analysis: {
    ...
    n5_na_adjectives: {
        ...
        pattern: 'な形容詞',
        connection: 'な形容詞 + な + 名詞',
        translation: '～的（な形容詞基礎用法）',
        level: 'N5',
        explanation: [
            {
                usageId: 1,
                title: 'な形容詞修飾名詞',
                description: 'な形容詞修飾名詞時，需要加「な」。',
                examples: [
                    { japanese: '静{しず}かな部屋{へや}', chinese: '安靜的房間' },
                    { japanese: '有名{ゆうめい}な人{ひと}', chinese: '有名的人' },
                    { japanese: '元気{げんき}な子供{こども}', chinese: '有精神的小孩' }
                ]
            },
            {
                usageId: 2,
                title: 'な形容詞作謂語',
                description: '作謂語時，加「です」（丁寧體）或「だ」（普通體）。',
                examples: [
                    { japanese: 'この町{まち}は静{しず}かです。', chinese: '這個城鎮很安靜。' },
                    { japanese: '彼{かれ}は元気{げんき}だ。', chinese: '他很有精神。' }
                ]
            }
        ],
        quiz: [
            {
                id: 'n5_q_naadj_1',
                sentence: '有名{ゆうめい}（　）レストランに行{い}きました。',
                options: ['な', 'の', 'い', 'に'],
                correctIndex: 0,
                explanation: {
                    correct: '「な」正確！な形容詞修飾名詞時加「な」。',
                    wrong: [
                        '「の」錯誤：「の」用於名詞修飾名詞。',
                        '「い」錯誤：「い」是い形容詞的詞尾。',
                        '「に」錯誤：「に」是副詞化或方向助詞。'
        ...
        explanation: [
            {
                usageId: 1,
                title: '感嘆・詠嘆',
                description: '表示感嘆、羨慕、懷念等情感。多用於自言自語。',
                examples: [
                    { japanese: 'いい天気{てんき}だなあ。', chinese: '天氣真好啊。' },
                    { japanese: '食{た}べたいなあ。', chinese: '好想吃啊。' },
                    { japanese: '懐{なつ}かしいなあ。', chinese: '好懷念啊。' }
                ]
            }
        ],
        quiz: [
    ...
    n5_naide: {
        ...
        pattern: '～ないで',
        connection: '動詞ない形 + で',
        translation: '不做～而...、沒有～就...',
        level: 'N5',
        explanation: [
            {
                usageId: 1,
                title: '附帶狀況',
                description: '表示在不做某事的狀態下做另一件事。',
                examples: [
                    { japanese: '傘{かさ}を持{も}たないで出{で}かけた。', chinese: '沒帶傘就出門了。' },
                    { japanese: '朝{あさ}ご飯{はん}を食{た}べないで学校{がっこう}に行{い}った。', chinese: '沒吃早餐就去學校了。' },
                    { japanese: '辞書{じしょ}を使{つか}わないで読{よ}んだ。', chinese: '沒用字典就讀了。' }
                ]
            }
        ],
        analysis: {
            title: '「～ないで」與「～なくて」的區別',
            points: [
                { rule: '「～ないで」：附帶狀況（沒做A就做B）', examples: [{ japanese: '見{み}ないで書{か}いた。', chinese: '沒看就寫了。' }] },
                { rule: '「～なくて」：原因（因為沒有A所以B）', examples: [{ japanese: '時間{じかん}がなくて行{い}けなかった。', chinese: '因為沒時間所以沒能去。' }] }
            ]
        },
        quiz: [
            {
                id: 'n5_q_naide_1',
                sentence: 'テレビを見{み}（　）勉強{べんきょう}してください。',
                options: ['ないで', 'なくて', 'ないに', 'なく'],
                correctIndex: 0,
                explanation: {
                    correct: '「ないで」正確！表示「不要看電視，請讀書」。',
                    wrong: [
                        '「なくて」錯誤：「なくて」表示原因。',
                        '「ないに」錯誤：這個形式不存在。',
                        '「なく」不太適合：「なく」通常後接なる或する。'
                    ]
                }
            }
        ]
        ...
        explanation: [
            {
                ...
                examples: [
                    { japanese: 'ここで写真{しゃしん}を撮{と}らないでください。', chinese: '請不要在這裡拍照。' },
                    { japanese: '心配{しんぱい}しないでください。', chinese: '請不要擔心。' },
                    { japanese: '触{さわ}らないでください。', chinese: '請不要觸摸。' }
                ]
            }
        ],
        quiz: [
            {
                id: 'n5_q_naidekudasai_1',
                sentence: '静{しず}かにしてください。話{はな}（　）。',
                options: ['さないでください', 'してください', 'しないでください', 'さないください'],
                correctIndex: 0,
                explanation: {
                    correct: '「さないでください」正確！「話す」的ない形是「話さない」。',
                    wrong: [
                        '「してください」錯誤：這是「請做」的意思。',
                        '「しないでください」錯誤：這是「する」的ない形。',
                        '「さないください」錯誤：缺少「で」。'
                    ]
                }
            }
    ...
    n5_ne: {
        ...
        pattern: '～ね',
        connection: '句子 + ね',
        translation: '～對吧、～呢（確認・同意）',
        level: 'N5',
        explanation: [
            {
                usageId: 1,
                title: '尋求同意・確認',
                description: '用於確認對方是否同意，或尋求共鳴。',
                examples: [
                    { japanese: 'いい天気{てんき}ですね。', chinese: '天氣真好呢。' },
                    { japanese: 'この料理{りょうり}は美味{おい}しいですね。', chinese: '這道菜很好吃呢。' },
                    { japanese: '明日{あした}は日曜日{にちようび}ですね。', chinese: '明天是星期天對吧。' }
                ]
            }
        ],
        analysis: {
            title: '「ね」與「よ」的區別',
            points: [
                { rule: '「ね」：尋求同意、共感', examples: [{ japanese: '暑{あつ}いですね。', chinese: '很熱呢。（你也這麼覺得吧？）' }] },
                { rule: '「よ」：告知新資訊', examples: [{ japanese: '暑{あつ}いですよ。', chinese: '很熱喔。（你可能不知道）' }] }
            ]
        },
        quiz: [
            {
                id: 'n5_q_ne_1',
                sentence: '（雙方都看到美麗的景色）きれいです（　）。',
                options: ['ね', 'よ', 'か', 'の'],
                correctIndex: 0,
                explanation: {
                    correct: '「ね」正確！雙方共同感受時用「ね」尋求共鳴。',
                    wrong: [
                        '「よ」不太適合：雙方都看到了，不需要告知。',
                        '「か」錯誤：這不是疑問句。',
                        '「の」不太適合：這裡不需要解釋。'
    ...
    n5_yo: {
        ...
        pattern: '～よ',
        connection: '句子 + よ',
        translation: '～喔、～啊（告知・強調）',
        level: 'N5',
        explanation: [
            {
                usageId: 1,
                title: '告知新資訊',
                description: '用於告訴對方不知道的事情，或強調某件事。',
                examples: [
                    { japanese: '明日{あした}は休{やす}みですよ。', chinese: '明天放假喔。' },
                    { japanese: '危{あぶ}ないですよ。', chinese: '危險喔！' },
                    { japanese: 'もう5時{じ}ですよ。', chinese: '已經5點了喔。' }
                ]
            }
        ],
        quiz: [
            {
                id: 'n5_q_yo_1',
                sentence: '（告訴不知道的人）このケーキ、美味{おい}しい（　）。',
                options: ['よ', 'ね', 'か', 'の'],
                correctIndex: 0,
                explanation: {
                    correct: '「よ」正確！告知對方新資訊時用「よ」。',
                    wrong: [
                        '「ね」不太適合：對方還沒嚐過，無法確認。',
                        '「か」錯誤：這不是疑問句。',
                        '「の」不太適合：這裡不需要解釋。'
