...
Object.assign(n5Details, {
        ...
        quiz: [
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「あと」正確！「終わったあとで」=結束之後。た形接「あとで」！',
                    wrong: [
                        '「まえ」錯誤：「まえ」表示「之前」，而且「終わった」是た形，「まえ」要接原形！',
                        '「とき」錯誤：「とき」表示「...的時候」，不是順序。',
                        '「ので」錯誤：「ので」表示原因。'
                    ]
                }
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「の」正確！名詞接「あとで」要加「の」。「昼ご飯のあとで」=午餐之後。',
                    wrong: [
            ...
            {
                id: 'n5_q_ato_de_3',
                sentence: '日本{にほん}に行{い}く（　）に、パスポートを準備{じゅんび}しました。',
                options: ['まえ', 'あと', 'とき', 'ので'],
                correctIndex: 0,
                explanation: {
                    correct: '「まえ」正確！「行くまえに」=去之前。要出發前先準備護照，所以是「之前」！',
                    wrong: [
                        '「あと」錯誤：「行くあと」不自然！「あと」要接た形（行ったあと）！而且邏輯上護照要在出發前準備！',
                        '「とき」錯誤：「とき」表示「...的時候」，這裡強調順序。',
                        '「ので」錯誤：「ので」表示原因。'
                    ]
                }
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「した」正確！「あとで」前面用動詞た形。「宿題をしたあとで」=做完功課之後。',
                    wrong: [
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '正確！「食べたあとで散歩する」（過一會散步）vs「食べてから散歩する」（吃完馬上散步）。',
                    wrong: [
                        '錯誤：兩者語感不同。「てから」強調緊密順序。',
                        '錯誤：接續不同。「あとで」接た形，「てから」接て形。',
                        '錯誤：時態跟這兩個詞無關，都可以用於各種時態。'
                    ]
                }
            }
        ]
    ...
    n5_toki: {
        ...
        quiz: [
            {
                id: 'n5_q_toki_1',
                sentence: '暇{ひま}（　）とき、音楽{おんがく}を聴{き}きます。',
                options: ['な', 'の', 'が', 'を'],
                correctIndex: 0,
                explanation: {
                    correct: '「な」正確！「暇」是な形容詞，接「とき」要加「な」。「暇なとき」=有空的時候。',
                    wrong: [
                        '「の」錯誤：「の」用於名詞！な形容詞用「な」！',
                        '「が」錯誤：「がとき」文法錯誤。',
                        '「を」錯誤：「をとき」文法錯誤。'
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「の」正確！「子供」是名詞，接「とき」要加「の」。「子供のとき」=小時候。',
                    wrong: [
                        '「な」錯誤：「な」用於な形容詞！「子供」是名詞，用「の」！',
                        '「が」錯誤：「がとき」文法錯誤。',
                        '「を」錯誤：「をとき」文法錯誤。'
                    ]
                }
            ...
            {
                id: 'n5_q_toki_3',
                sentence: '日本{にほん}に（　）とき、パスポートを持{も}っていきます。',
                options: ['行く', '行った', '行って', '行き'],
                correctIndex: 0,
                explanation: {
                    correct: '「行く」正確！還沒到日本（正要去），用原形。去日本的途中需要護照。',
                    wrong: [
                        '「行った」錯誤：「行ったとき」=到了日本之後。但護照是在到達前就需要的！這裡用原形！',
                        '「行って」錯誤：て形不直接接「とき」。',
                        '「行き」錯誤：ます形語幹不直接接「とき」。'
                    ]
                }
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「とき」正確！「悲しいとき」=傷心的時候。い形容詞直接接「とき」！',
                    wrong: [
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '正確！「行くとき」=正要去時（還沒到），「行ったとき」=去了之後（已經到了）。',
                    wrong: [
                        '錯誤：原形和た形表示的時間點不同。',
                        '錯誤：這跟過去/現在無關，是動作是否完成的問題。',
                        '錯誤：跟肯定/否定無關。'
                    ]
                }
            }
        ...
        quiz: [
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「いつも」正確！表示「總是搭電車去公司」，頻率100%。',
                    wrong: [
                        '「ときどき」錯誤：「ときどき」=有時（30-50%），不是「總是」。',
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「あまり」正確！「あまり好きではありません」=不太喜歡。「あまり」用於否定句！',
                    wrong: [
...
Object.assign(n5Details, {
        ...
        quiz: [
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「が」正確！存在句中用「が」標記存在的物品。「〜にNがある」是基本句型。',
                    wrong: [
                        '「を」錯誤：「を」是動作的受詞標記，存在句用「が」！',
                        '「に」錯誤：「に」已經標記了位置（机の上に），物品用「が」！',
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「あります」正確！植物雖然有生命，但日語中用「ある」！花、木等植物用「ある」！',
                    wrong: [
                        '「います」錯誤：「いる」用於人和動物！植物用「ある」！',
                        '「です」錯誤：「です」是判斷句，不表示存在。',
                        '「します」錯誤：「します」表示做某事。'
                    ]
                }
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「あり」正確！便利商店是物品/建築，用「ありますか」。',
                    wrong: [
                        '「い」錯誤：「いる」用於人和動物！建築物用「ある」！',
                        '「でき」錯誤：「できる」表示能夠。',
                        '「し」錯誤：「します」表示做某事。'
                    ]
                }
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '正確！「ある」=物品、植物（無生命/不動）；「いる」=人、動物（有生命/會動）。',
                    wrong: [
                        '錯誤：相反！人用「いる」，物品用「ある」。',
                        '錯誤：跟肯定/否定無關。',
                        '錯誤：不能互換！人用「ある」是錯誤的。'
    ...
    n5_e_he: {
        ...
        quiz: [
            ...
            {
                id: 'n5_q_e_he_2',
                sentence: '公園{こうえん}（　）散歩{さんぽ}しました。',
                options: ['で', 'へ', 'が', 'の'],
                correctIndex: 0,
                explanation: {
                    correct: '「で」正確！「散歩する」是動作，動作進行的場所用「で」！',
                    wrong: [
                        '「へ」錯誤：「へ」表示移動方向！「散歩する」是在公園進行的動作，用「で」！',
                        '「が」錯誤：「が」是主語標記。',
                        '「の」錯誤：「の」是所有格。'
                    ]
                }
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「へ」正確！「帰る」是移動動詞，移動的目的地用「へ」或「に」。',
                    wrong: [
                        '「で」錯誤：「で」是動作場所！「帰る」是移動動詞，用「へ」或「に」！',
                        '「が」錯誤：「が」是主語標記。',
                        '「の」錯誤：「の」是所有格。'
                    ]
                }
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「へ」正確！「行く」是移動動詞，「どこへ行く」詢問目的地方向。',
                    wrong: [
                        '「で」錯誤：「で」是動作場所！「行く」表示移動，用「へ」！',
                        '「を」錯誤：「を」是受詞標記。',
                        '「が」錯誤：「が」是主語標記。'
                    ]
                }
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '正確！「学校へ行く」（去學校）vs「学校で勉強する」（在學校讀書）。移動用「へ」，動作用「で」！',
                    wrong: [
                        '錯誤：兩者用途不同。',
                        '錯誤：跟時態無關。',
                        '錯誤：相反！「へ」用於移動，「で」用於動作。'
        ...
        quiz: [
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「で」正確！讀書是動作，動作進行的場所用「で」。',
                    wrong: [
                        '「に」錯誤：「に」用於存在場所（いる/ある）！動作場所用「で」！',
                        '「へ」錯誤：「へ」表示移動方向。',
                        '「を」錯誤：「を」是受詞標記（本を）。'
                    ]
                }
            ...
            {
                id: 'n5_q_de_place_2',
                sentence: '図書館{としょかん}（　）田中{たなか}さんがいます。',
                options: ['に', 'で', 'へ', 'を'],
                correctIndex: 0,
                explanation: {
                    correct: '「に」正確！「いる」表示存在，存在的場所用「に」！',
                    wrong: [
                        '「で」錯誤：「で」用於動作場所！「いる」是存在動詞，用「に」！',
                        '「へ」錯誤：「へ」表示移動方向。',
                        '「を」錯誤：「を」是受詞標記。'
                    ]
                }
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「で」正確！「電車で」表示交通工具/手段。「で」也表示方法！',
                    wrong: [
                        '「に」錯誤：交通工具/手段用「で」！',
                        '「へ」錯誤：「へ」表示方向（會社へ是對的）。',
                        '「を」錯誤：「を」是受詞標記。'
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「で」正確！買東西是動作，「どこで」詢問動作場所。',
                    wrong: [
                        '「に」錯誤：動作場所用「で」！「に」用於存在！',
                        '「へ」錯誤：「へ」表示移動方向。',
                        '「を」錯誤：「を」是受詞標記。'
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '正確！存在場所用「に」不是「で」！「本が机の上にある」才對！',
                    wrong: [
                        '正確用法：動作場所用「で」。',
                        '正確用法：交通工具用「で」。',
                        '正確用法：語言/方法用「で」。'
        ...
        quiz: [
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「から」正確！「九時から」表示「從九點」開始，強調起點。',
                    wrong: [
                        '「まで」錯誤：「まで」表示終點！「始まる」是開始，用起點「から」！',
                        '「に」錯誤：「に」表示時間點，但「から」更強調「從...開始」！',
                        '「で」錯誤：「で」不用於時間點。'
                    ]
                }
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「まで」正確！「五時まで」表示「到五點」為止，強調終點。',
                    wrong: [
            ...
            {
                id: 'n5_q_kara_made_3',
                sentence: '映画{えいが}は七時{しちじ}（　）終{お}わります。',
                options: ['に', 'から', 'まで', 'で'],
                correctIndex: 0,
                explanation: {
                    correct: '「に」正確！「七時に終わる」表示「在七點結束」，強調具體時間點。',
                    wrong: [
                        '「から」錯誤：「から」表示起點！「終わる」是結束，用「に」表示時間點！',
                        '「まで」錯誤：「まで」表示持續到某點。「七時まで終わる」不自然！',
                        '「で」錯誤：「で」不用於時間點。'
                    ]
                }
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「から」正確！「いつから」詢問暑假的起點。「から～まで」表示範圍！',
                    wrong: [
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '正確！「9時から」（從9點）、「5時まで」（到5點）、「3時に」（在3點）。',
                    wrong: [
                        '錯誤：三者用途不同。',
                        '錯誤：「から」是起點，「まで」是終點，相反！',
                        '錯誤：這些是時間表達，不是場所。'
    ...
    n5_naito_ikenai: {
        ...
        quiz: [
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「ないと」正確！「しないといけません」=必須運動。「する」→「しない」→「しないと」。',
                    wrong: [
                        '「なくて」錯誤：「なくて」後需要「は」！',
                        '「ないで」錯誤：「ないで」不表示義務！',
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「は」正確！「なくてはいけない」是固定形式，中間有「は」！',
                    wrong: [
                        '「が」錯誤：固定搭配是「なくては」！',
                        '「を」錯誤：不是這個助詞。',
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「ないと」正確！「終わらせないといけない」=必須完成。表示義務！',
                    wrong: [
                        '「なくて」錯誤：「なくて」後需要「は」！',
                        '「ないで」錯誤：「ないで」不表示義務。',
                        '「なくと」錯誤：沒有這種形式。'
        ...
        quiz: [
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「は」正確！「なくてはいけない」是固定形式，中間的「は」不能省略！',
                    wrong: [
            ...
            },
            {
                ...
                explanation: {
                    ...
                    wrong: [
                        '「なくても」錯誤：「なくてもいい」=不必早起，與前文「休みでも」矛盾！',
                        '「ないでは」錯誤：沒有這種接續。',
                        '「ないでも」錯誤：沒有這種接續。'
                    ]
                }
    ...
    n5_naku_temo_ii: {
        ...
        quiz: [
            ...
            },
            {
                ...
                options: ['持って行かなくて', '持って行かないと', '持って行ないで', '持って行ってない'],
                correctIndex: 0,
                explanation: {
                    correct: '「持って行かなくて」正確！=不用帶也可以。因為會變成行李負擔。',
                    wrong: [
                        '「持って行かないと」錯誤：「ないといけない」=必須帶，與情境矛盾！',
                        '「持って行ないで」錯誤：形式錯誤。',
                        '「持って行ってない」錯誤：形式錯誤。'
                    ]
                }
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '正確！「食べてもいい」=可以吃，「食べなくてはいけない」=必須吃，「食べなくてもいい」=不吃也可以。',
                    wrong: [
                        '錯誤：配對完全相反！',
                        '錯誤：三者意思不同！',
                        '錯誤：配對錯誤！'
...
Object.assign(n5Details, {
    ...
    n5_nakucha: {
        ...
        quiz: [
            ...
            {
                id: 'n5_q_nakucha_3',
                sentence: '今日{きょう}は時間{じかん}があるから、急{いそ}が（　）大丈夫{だいじょうぶ}だよ。',
                options: ['なくても', 'なくちゃ', 'ないと', 'なくては'],
                correctIndex: 0,
                explanation: {
                    correct: '「なくても」正確！「今天有時間，不趕也沒關係」。注意「なくても」表示不必做！',
                    wrong: [
                        '「なくちゃ」錯誤：這表示「必須趕」，與「有時間」矛盾。陷阱！',
    ...
    n5_nakute_wa_naranai: {
        ...
        quiz: [
            ...
            {
                id: 'n5_q_naranai_3',
                sentence: '日曜日{にちようび}は仕事{しごと}が休{やす}みだから、会社{かいしゃ}に行{い}か（　）いい。',
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「なくてはならない」正確！正式場合說「申請必須在今天內完成」。',
                    wrong: [
                        '「なくてもいい」錯誤：這表示「不申請也可以」，與截止日矛盾。',
                        '「なくちゃ」錯誤：口語說法，在正式的申請場合不太適合。',
                        '「なければいけない」也正確！意思相同，正式度稍低。'
                    ]
                }
            }
        ]
    ...
    n5_naru: {
        ...
        quiz: [
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「く」正確！い形容詞「暗い」變成「暗く」再接「なる」。這是自然變化！',
                    wrong: [
                        '「に」錯誤：「に」用於名詞和な形容詞。「暗い」是い形容詞！',
                        '「で」錯誤：不用於接「なる」。',
                        '「と」錯誤：不用於這種接續。'
                    ]
                }
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「く」正確！「暗くする」表示人為地把房間弄暗。注意「する」和「なる」的區別！',
                    wrong: [
                        '「に」錯誤：い形容詞用「く」不用「に」。而且這是人為動作用「する」！',
                        '「で」錯誤：不用於接「する」表示變化。',
                        '「と」錯誤：不用於這種接續。'
                    ]
                }
            ...
            {
                id: 'n5_q_naru_4',
                sentence: '「空{そら}が暗くなった」と「部屋{へや}を暗くした」的差別是？',
                options: [
                    '「なる」是自然變化，「する」是人為改變',
                    '「なる」是人為改變，「する」是自然變化',
                    '意思完全相同',
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「く」正確！「大きい」是い形容詞，所以用「大きくなる」。孩子長大是自然變化！',
                    wrong: [
                        '「に」錯誤：「大きい」是い形容詞，不是な形容詞。很多人會搞錯！',
                        '「で」錯誤：不用於接「なる」。',
                        '「と」錯誤：不用於這種接續。'
                    ]
                }
        ...
        quiz: [
            {
                ...
                explanation: {
                    ...
                    wrong: [
                        ...
                        '「なんです」錯誤：「悪い」是い形容詞，不需要「な」。名詞和な形容詞才需要！'
                    ]
                }
            },
            {
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「なんです」正確！「静か」是な形容詞，要加「な」再加「んです」。這是陷阱題！',
                    wrong: [
                        '「んです」錯誤：な形容詞後面需要「な」！',
                        '「です」錯誤：缺少解釋語氣，這裡是在疑惑他為何安靜。',
                        '「くんです」錯誤：「く」用於い形容詞，「静か」是な形容詞。'
                    ]
                }
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「なんです」正確！「ダイエット中」是名詞性質，所以要加「な」。用於解釋不吃的理由。',
                    wrong: [
                        '「んです」錯誤：名詞後面需要「な」。',
                        '「です」錯誤：缺少解釋的語氣。',
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '正確！名詞/な形容詞後面要加「な」：学生＋な＋んです、静か＋な＋んです。',
                    wrong: [
                        '錯誤：名詞和な形容詞後面必須加「な」！',
                        '錯誤：「だ」不能直接接「んです」。',
        ...
        quiz: [
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「に」正確！「カレーにする」表示「選擇/決定要咖哩」。點餐時的固定用法！',
                    wrong: [
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「して」正確！「小さくする」表示人為地把聲音調小。這是請求對方做的動作！',
                    wrong: [
                        '「なって」錯誤：「なる」是自然變化，這裡是請求對方做，要用「する」！',
                        '「した」錯誤：這是過去式，不能接「ください」。',
                        '「になって」錯誤：「になる」是自然變化，不是人為動作。'
                    ]
                }
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「に」正確！「春になる」表示「到了春天」。這是「なる」不是「する」！注意區分！',
                    wrong: [
                        '「を」錯誤：春天到來是自然變化，用「になる」不用「にする」。',
                        '「で」錯誤：不用於「なる」的接續。',
                        '「が」錯誤：不用於「なる」的接續。'
                    ]
                }
            ...
            {
                id: 'n5_q_nisuru_4',
                sentence: '「部屋{へや}をきれいにした」と「部屋{へや}がきれいになった」的差別是？',
                options: [
                    '「した」是人為打掃，「なった」是自然變乾淨',
                    '意思完全相同',
                    '「した」是過去式，「なった」是現在式',
                    '「した」用於自己的房間，「なった」用於別人的房間'
                ],
                correctIndex: 0,
                explanation: {
                    correct: '正確！「にする」是人為改變（我打掃了），「になる」是狀態變化（變乾淨了）。',
                    wrong: [
                        '錯誤：意思不同！動作的主體不同。',
                        '錯誤：兩者都是過去式，差別在於人為vs自然變化。',
                        '錯誤：跟誰的房間無關，是動作性質的差別。'
                    ]
                }
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「に」正確！「来週にする」表示「決定在下週」。這是主動決定，用「にする」！',
                    wrong: [
                        '「を」錯誤：「にする」固定用「に」。',
                        '「で」錯誤：不用於表示決定。',
                        '「が」錯誤：不適用於這種接續。'
        ...
        quiz: [
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「に」正確！「食べに行く」表示「去吃」的目的。動詞ます形（去ます）＋に行く！',
                    wrong: [
                        '「を」錯誤：「を」是受詞助詞，目的要用「に」表示。',
                        '「で」錯誤：「で」表示方式或場所，不表示目的。',
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「に」正確！「買い物に行く」表示去購物的目的。名詞＋に行く也可以！',
                    wrong: [
                        '「を」錯誤：「買い物をする」可以，但「買い物に行く」是固定用法。',
                        '「で」錯誤：不用於表示目的。',
                        '「へ」錯誤：「へ」表示方向，但「買い物」是目的不是方向。'
                    ]
                }
            },
            {
                id: 'n5_q_niiku_3',
                sentence: '日本{にほん}（　）勉強{べんきょう}しに来{き}ました。',
                options: ['へ', 'に', 'で', 'を'],
                correctIndex: 0,
                explanation: {
                    correct: '「へ」正確！「日本へ」表示移動方向，「勉強しに」表示目的。這裡考的是「へ」vs「に」！',
                    wrong: [
                        '「に」也可以！「日本に」表示目的地，兩者都正確。',
                        '「で」錯誤：「で」表示動作場所，但這裡是移動的方向。',
                        '「を」錯誤：不用於表示移動目的地。'
                    ]
                }
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '正確！動詞ます形（去ます）＋に行く。「食べます」→「食べ」＋「に行く」。',
                    wrong: [
                        '錯誤：不用辭書形，要用ます形去掉ます！',
                        '錯誤：不用た形。',
                        '錯誤：不用て形。'
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「へ」正確！「友達の家へ」表示移動方向，「遊びに」表示目的。',
                    wrong: [
                        '「を」錯誤：「を」不用於表示移動目的地。',
                        '「で」錯誤：「で」表示動作場所，這裡是移動方向。',
                        '「が」錯誤：「が」是主語助詞。'
                    ]
                }
            }
        ...
        quiz: [
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「のが」正確！「泳ぐのが上手」表示「擅長游泳」。「の」將動詞名詞化，「が」標示擅長的對象！',
                    wrong: [
                        '「のを」錯誤：「上手」前面用「が」不用「を」！',
                        '「ので」錯誤：這是表示原因的接續。',
                        '「のに」錯誤：這是表示對比或目的的接續。'
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「のが」正確！「弾くのが上手」表示「擅長彈鋼琴」。動詞辭書形＋のが上手！',
                    wrong: [
                        '「のを」錯誤：「上手」前面用「が」，這是常見錯誤！',
                        '「ので」錯誤：這是表示原因的接續。',
                        '「のに」錯誤：這是表示對比或目的的接續。'
                    ]
                }
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「得意」正確！說自己擅長某事時用「得意」，不用「上手」。這是陷阱題！',
                    wrong: [
                        '「上手」錯誤：「上手」用於形容他人，說自己用會不謙虛！日本文化重點！',
                        '「好き」錯誤：這是「喜歡」，不是「擅長」。',
                        '「嫌い」錯誤：這是「討厭」，意思相反。'
                    ]
                }
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「が」正確！「料理が上手」表示「擅長料理」。稱讚他人可以用「上手」！',
                    wrong: [
                        '「を」錯誤：「上手」前面用「が」不用「を」。',
                        '「に」錯誤：不用於這種接續。',
                        '「で」錯誤：不用於這種接續。'
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '正確！日語禮儀：說自己用「得意」（私は料理が得意です），說他人用「上手」（お母さんは料理が上手ですね）。',
                    wrong: [
                        '錯誤：順序相反了！',
                        '錯誤：使用場合不同，說自己「上手」會顯得不謙虛。',
                        '錯誤：跟運動或學習無關，是說自己vs說他人的差別。'
                    ]
                }
            }
        ]
        ...
        quiz: [
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「のが」正確！「歌うのが下手」表示「不擅長唱歌」。說自己可以用「下手」！',
                    wrong: [
                        '「のを」錯誤：「下手」前面用「が」不用「を」！',
                        '「ので」錯誤：這是表示原因的接續。',
                        '「のに」錯誤：這是表示對比或目的的接續。'
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「が」正確！「運転が下手」表示「不擅長開車」。名詞＋が下手！',
                    wrong: [
                        '「を」錯誤：「下手」前面用「が」。',
                        '「に」錯誤：不用於這種接續。',
                        '「で」錯誤：不用於這種接續。'
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '正確！日語禮儀：直接說他人「下手」很失禮。較委婉的說法是「あまり得意じゃないみたいですね」。',
                    wrong: [
                        '錯誤：雖然文法正確，但這樣說很失禮！',
                        '錯誤：文法正確，但使用場合不對。',
                        '錯誤：說自己「下手」是謙虛，說他人「下手」是失禮。'
                    ]
                }
            },
            {
                id: 'n5_q_heta_4',
                sentence: '私{わたし}は料理{りょうり}が（　）。',
                options: ['あまり得意じゃない', '下手です', '上手です', '好きじゃない'],
                correctIndex: 0,
                explanation: {
                    correct: '「あまり得意じゃない」正確！這是較委婉地說自己不擅長的方式。「下手」也可以但較直接。',
                    wrong: [
                        '「下手です」也可以！但較直接，「得意じゃない」更委婉。',
                        '「上手です」錯誤：說自己不謙虛，而且意思相反。',
                        '「好きじゃない」錯誤：這是「不喜歡」，不是「不擅長」。'
                    ]
                }
            },
            {
                id: 'n5_q_heta_5',
                sentence: '「上手/下手」vs「得意/苦手」的差別是？',
                options: [
                    '上手/下手客觀描述技能，得意/苦手主觀表達自信',
                    '上手/下手主觀表達，得意/苦手客觀描述',
                    '意思完全相同',
                    '上手/下手只能說他人，得意/苦手只能說自己'
                ],
                correctIndex: 0,
                explanation: {
                    correct: '正確！「上手/下手」客觀評價技能高低，「得意/苦手」主觀表達有沒有自信。說自己常用「得意/苦手」！',
                    wrong: [
                        '錯誤：順序相反了！',
                        '錯誤：意思有區別，使用場合也不同。',
                        '錯誤：不是完全限制，但說自己時用「得意/苦手」更自然。'
                    ]
                }
            }
        ]
        ...
        quiz: [
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「のが」正確！「見るのが好き」表示「喜歡看」。動詞辭書形＋のが好き！',
                    wrong: [
                        '「のを」錯誤：「好き」前面用「が」不用「を」！這是常見錯誤。',
                        '「ので」錯誤：這是表示原因的接續。',
                        '「のに」錯誤：這是表示對比或目的的接續。'
                    ]
                }
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「が」正確！「好き」前面用「が」。名詞＋が好き！',
                    wrong: [
                        '「を」錯誤：「好き」不用「を」，這是日語學習者常犯的錯誤！',
                        '「に」錯誤：不用於這種接續。',
                        '「で」錯誤：不用於這種接續。'
                    ]
                }
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「が」正確！「嫌い」也用「が」！「好き」的反義詞「嫌い」同樣用「が」。',
                    wrong: [
                        '「を」錯誤：「嫌い」和「好き」一樣用「が」。',
                        '「に」錯誤：不用於這種接續。',
                        '「で」錯誤：不用於這種接續。'
            ...
            {
                id: 'n5_q_suki_4',
                sentence: '「好き」的喜歡程度排序，從最喜歡到討厭是？',
                options: [
                    '大好き→好き→まあまあ→あまり好きじゃない→嫌い',
                    '好き→大好き→まあまあ→嫌い→あまり好きじゃない',
                    '大好き→まあまあ→好き→嫌い→あまり好きじゃない',
                    '全部程度相同'
                ],
                correctIndex: 0,
                explanation: {
                    correct: '正確！大好き（非常喜歡）→好き（喜歡）→まあまあ（還可以）→あまり好きじゃない（不太喜歡）→嫌い（討厭）',
                    wrong: [
                        '錯誤：「大好き」比「好き」程度更強！',
                        '錯誤：順序有誤，「まあまあ」是中間程度。',
                        '錯誤：程度明顯不同！'
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「が」正確！「どちらが好き」是詢問喜好的固定用法。回答用「～のほうが好き」！',
                    wrong: [
                        '「を」錯誤：「好き」固定用「が」。',
                        '「に」錯誤：不用於這種接續。',
                        '「で」錯誤：不用於這種接續。'
...
Object.assign(n5Details, {
    ...
    n5_no_naka_de_a_ga_ichiban: {
        ...
        quiz: [
            ...
            {
                id: 'n5_q_ichiban_3',
                sentence: '田中{たなか}さんは山田{やまだ}さん（　）背{せ}が高{たか}いです。',
                options: ['より', 'の中で', 'が一番', 'ほど'],
                correctIndex: 0,
                explanation: {
                    correct: '「より」正確！這是兩者比較，用「より」不用「一番」。這是陷阱題！',
                    wrong: [
                        '「の中で」錯誤：「の中で」用於三者以上比較範圍。',
                        '「が一番」錯誤：「一番」用於最高級，兩者比較不用。',
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '正確！三者以上用「の中で～が一番」，兩者比較用「AはBより～」。',
                    wrong: [
                        '錯誤：順序相反了！',
                        '錯誤：使用場合不同。',
                        '錯誤：跟人或物無關，是比較對象數量的差別。'
                    ]
                }
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「が」正確！疑問詞「何」後面用「が」。「何が一番」是最高級的固定問法！',
                    wrong: [
                        '「は」錯誤：疑問詞後面用「が」不用「は」。',
                        '「を」錯誤：不用於標示主語。',
                        '「に」錯誤：不用於這種接續。'
        ...
        quiz: [
            {
                ...
                explanation: {
                    ...
                    wrong: [
                        ...
                        '「とき」錯誤：「たとき」表示「做了...的時候」，不是經驗。'
                    ]
                }
            },
            {
                id: 'n5_q_takoto_2',
                sentence: '昨日{きのう}、日本{にほん}に行{い}（　）。',
                options: ['った', 'ったことがある', 'く', 'っている'],
                correctIndex: 0,
                explanation: {
                    correct: '「った」正確！「昨日」是具體時間，用單純過去式，不用「ことがある」！這是陷阱題！',
                    wrong: [
                        '「ったことがある」錯誤：「ことがある」表示經驗，不搭配具體時間（昨日）。',
                        '「く」錯誤：形式不對。',
                        '「っている」錯誤：這是進行或結果持續，不適合「昨日」。'
                    ]
                }
            },
            {
                id: 'n5_q_takoto_3',
                sentence: '「たことがある」和「た」的差別是？',
                options: [
                ...
                correctIndex: 0,
                explanation: {
                    correct: '正確！「日本に行ったことがある」= 有去過日本的經驗。「日本に行った」= 去了日本（單純過去事實）。',
                    wrong: [
                        '錯誤：意思不同，「ことがある」強調經驗本身。',
                        '錯誤：跟時間遠近無關，是經驗vs事實的差別。',
                        '錯誤：兩者都可以用於陳述句和疑問句。'
                    ]
                }
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「た」正確！「行ったことがある」使用動詞た形。經驗句型用た形！',
                    wrong: [
            ...
            {
                id: 'n5_q_takoto_5',
                sentence: '一度{いちど}も日本{にほん}に行{い}ったこと（　）。',
        ...
        quiz: [
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「だり」正確！「遊ぶ」的た形是「遊んだ」，所以用「遊んだり」。五段動詞要注意！',
                    wrong: [
                        '「たり」錯誤：「遊ぶ」是「ぶ」結尾，た形變濁音「遊んだ」不是「遊んた」！',
                        '「でり」錯誤：沒有這種形式。',
                        '「てり」錯誤：沒有這種形式。'
                    ]
                }
            ...
            {
                id: 'n5_q_tari_3',
                sentence: '本{ほん}を読{よ}んで、映画{えいが}を見{み}た。',
                options: [
                    '讀書，然後看電影（按順序）',
                    '讀書、看電影等（還有其他）',
                    '意思一樣',
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「たり」正確！「食べる」的た形是「食べた」，所以用「食べたり」。一段動詞直接加「たり」！',
                    wrong: [
                        '「だり」錯誤：「食べる」是一段動詞，不濁音化。',
                        '「ても」錯誤：這是「てもいい」的接續。',
                        '「て」錯誤：「て形」表示順序，不是舉例。'
                    ]
                }
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '正確！口語中常省略「する」（読んだり見たり。），但正式場合要加「する」。',
                    wrong: [
                        '錯誤：口語中經常省略。',
                        '錯誤：正式時不能省略。',
                        '錯誤：跟疑問句無關。'
    ...
    n5_temo_ii_desu: {
        ...
        quiz: [
            ...
            },
            {
                ...
                options: ['座ってはいけません', '座ってもいいですよ', '座らなくてもいいです', '座りたいです'],
                correctIndex: 0,
                explanation: {
                    ...
                    wrong: [
                        ...
                        '「座りたいです」錯誤：這是「想坐」，不是回答許可問題。'
                    ]
                }
            },
            {
                id: 'n5_q_temoii_3',
                sentence: '「てもいい」和「てもかまわない」的差別是？',
                options: [
                    '意思相同，「かまわない」更正式',
                    '意思相同，「いい」更正式',
                    '意思不同',
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「なくても」正確！「來なくてもいい」=「不來也可以」。今天會全部完成，所以明天不用來。',
                    wrong: [
                        '「ても」錯誤：「来てもいい」是許可來，但情境是不需要來。',
                        '「ては」錯誤：「てはいけない」是禁止。',
                        '「たり」錯誤：用於列舉動作。'
                    ]
                }
        ...
        quiz: [
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「ては」正確！「話してはいけない」表示「不可以說話」。圖書館的規則！',
                    wrong: [
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「ても」正確！這是詢問許可「吸ってもいいですか」。回答是「禁煙」=不可以。',
                    wrong: [
...
Object.assign(n5Details, {
    ...
    n5_tsumori: {
        ...
        quiz: [
            ...
            {
                id: 'n5_q_tsumori_3',
                sentence: '「つもり」和「予定」的差別是？',
                options: [
                    '「つもり」強調個人意志，「予定」強調計劃安排',
                    '「つもり」強調計劃安排，「予定」強調個人意志',
                    '意思完全相同',
                    '「つもり」只能用於未來，「予定」只能用於過去'
                ],
                correctIndex: 0,
                explanation: {
                    correct: '正確！「行くつもりです」=我打算去（個人決定），「行く予定です」=預定要去（計劃安排）。',
                    wrong: [
                        '錯誤：順序相反了！',
                        '錯誤：意思有區別。',
                        '錯誤：兩者都用於未來計劃。'
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「つもり」正確！這是個人的意願和決定。「予定」也可以但更客觀。',
                    wrong: [
                        '「予定」也可以！但「つもり」更強調個人意志。',
                        '「こと」錯誤：「ことです」不表示計劃。',
                        '「もの」錯誤：不用於表示計劃。'
                    ]
                }
            ...
            {
                id: 'n5_q_tsumori_5',
                sentence: '彼{かれ}は来年{らいねん}日本{にほん}に行{い}く（　）らしい。',
                options: ['つもり', '予定', 'こと', 'ところ'],
                correctIndex: 0,
                explanation: {
                    correct: '「つもり」正確！說別人的意圖時，加「らしい」「ようです」更自然。直接用「つもり」說他人不太自然。',
                    wrong: [
                        '「予定」也可以！說他人的計劃時「予定らしい」更自然。',
                        '「こと」錯誤：不表示計劃。',
                        '「ところ」錯誤：表示時機。'
                    ]
                }
        ...
        quiz: [
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「と」正確！「母と一緒に」表示「和媽媽一起」。共同動作用「と」！',
                    wrong: [
        ...
        quiz: [
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「すぎて」正確！「すぎて」是て形，連接原因（吃太多）和結果（肚子痛）。',
                    wrong: [
                        '「すぎる」錯誤：需要て形連接後面的結果。',
                        '「すぎた」錯誤：過去式不能直接連接後句。',
                        '「すぎ」錯誤：形式不完整。'
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「すぎます」正確！い形容詞去「い」＋すぎる。「難しい」→「難しすぎる/すぎます」。',
                    wrong: [
                        '「すぎる」也可以！但丁寧體用「すぎます」。',
                        '「すぎた」錯誤：問題現在還是難的。',
                        '「すぎて」錯誤：後面需要接結果。'
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '正確！「食べます」→「食べすぎる」、「高い」→「高すぎる」、「静かな」→「静かすぎる」。',
                    wrong: [
                        '錯誤：動詞用ます形去ます，不是辭書形。',
                        '錯誤：需要去掉詞尾。',
                        '錯誤：不用て形。'
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「すぎる」正確！「甘い」去「い」→「甘すぎる」。い形容詞去「い」再加「すぎる」！',
                    wrong: [
                        '「いすぎる」錯誤：要去掉「い」！這是常見錯誤。',
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「すぎる」正確！「静か」去「な」→「静かすぎる」。な形容詞去「な」再加「すぎる」！',
                    wrong: [
                        '「なすぎる」錯誤：要去掉「な」！',
                        '「すぎた」錯誤：描述現在狀態用「すぎる」。',
                        '「にすぎる」錯誤：「すぎる」不用「に」接續。'
        ...
        quiz: [
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「て」正確！「してある」表示「已經預約好了」的準備狀態。',
                    wrong: [
                        '「た」錯誤：需要て形。',
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「ている」正確！「開く」是自動詞，描述門的狀態用「開いている」。這是陷阱題！',
                    wrong: [
                        '「てある」錯誤：「てある」只能接他動詞（如「開ける」），不能接自動詞「開く」！',
            ...
            {
                id: 'n5_q_tearu_5',
                sentence: '「てある」和「ている」有什麼差別？',
                options: [
                    '「てある」強調有意圖的準備，「ている」單純描述狀態',
                    '意思完全相同',
                    '「ている」強調有意圖，「てある」單純描述',
                    '「てある」用於自動詞，「ている」用於他動詞'
                ],
                correctIndex: 0,
                explanation: {
                    correct: '正確！「窓を開けてある」=（某人）特意把窗戶打開。「窓が開いている」=窗戶開著（不知道誰開的）。',
                    wrong: [
                        '錯誤：意思不同。',
                        '錯誤：順序相反了！',
    ...
    n5_ya: {
        ...
        quiz: [
            ...
            {
                id: 'n5_q_ya_3',
                sentence: '私{わたし}の家族{かぞく}は父{ちち}（　）母{はは}だけです。',
                options: ['と', 'や', 'も', 'か'],
                correctIndex: 0,
                explanation: {
                    correct: '「と」正確！「だけ」表示只有這兩人，完整列舉用「と」。這是陷阱題！',
                    wrong: [
...
Object.assign(n5Details, {
    ...
    n5_yori_hou_ga: {
        ...
        quiz: [
            ...
            {
                id: 'n5_q_yorihouga_5',
                sentence: '「AよりBのほうが」和「BはAより」有什麼差別？',
                options: [
                    '意思相同，但語序和焦點不同',
                    '意思完全不同',
                    '「より」只能放在前面',
                ...
                correctIndex: 0,
                explanation: {
                    correct: '正確！「犬より猫のほうが好き」=「猫は犬より好き」意思相同，但焦點不同。',
                    wrong: [
                        '錯誤：意思相同！',
                        '錯誤：「より」可以在前面或後面。',
                        '錯誤：兩者都可以省略。'
    ...
    n5_wa_yori: {
        ...
        quiz: [
            ...
            {
                id: 'n5_q_wayori_3',
                sentence: '日本語{にほんご}は英語{えいご}（　）難{むずか}しくないと思{おも}います。',
                options: ['ほど', 'より', 'から', 'まで'],
                correctIndex: 0,
                explanation: {
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '正確！「猫は犬より好き」=「犬より猫のほうが好き」意思完全相同！',
                    wrong: [
                        '錯誤：意思相同！',
                        '錯誤：禮貌程度沒有差別。',
                        '錯誤：兩種都可以用於任何句子。'
    ...
    n5_wa_dou_desu_ka: {
        ...
        quiz: [
            ...
            {
                id: 'n5_q_wadou_3',
                sentence: '「お名前{なまえ}は（　）ですか。」\n「田中{たなか}です。」',
                options: ['なん', 'どう', 'どこ', 'だれ'],
                correctIndex: 0,
                explanation: {
                    correct: '「なん」正確！詢問具體內容（名字）用「なん」。這是陷阱題！',
                    wrong: [
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '正確！「お茶はいかがですか」比「お茶はどうですか」更禮貌、更正式。',
                    wrong: [
                        '錯誤：「いかがですか」更禮貌！',
                        '錯誤：意思相同，只是禮貌程度不同。',
                        '錯誤：「いかがですか」可用於任何事物。'
    ...
    n5_soshite: {
        ...
        quiz: [
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「しかし」正確！「寬敞但暗」有轉折意味。這是陷阱題！',
                    wrong: [
            ...
            {
                id: 'n5_q_soshite_5',
                sentence: '「そして」和「それから」有什麼差別？',
                options: [
                    '「そして」追加或順序，「それから」更強調時間順序',
                    '意思完全相同',
                    '「それから」追加特點，「そして」時間順序',
                    '「そして」只能用於形容詞'
                ],
                correctIndex: 0,
                explanation: {
                    correct: '正確！「彼は親切だ。そして、頭がいい」（追加特點）。「買い物をした。それから、家に帰った」（時間順序）。',
                    wrong: [
                        '錯誤：有細微差別！',
                        '錯誤：順序相反了！',
                        '錯誤：「そして」可以用於各種句子。'
    ...
    n5_sore_kara: {
        ...
        quiz: [
            ...
            {
                id: 'n5_q_sorekara_3',
                sentence: '彼{かれ}は親切{しんせつ}だ。（　）、面白{おもしろ}い。',
                options: ['そして', 'それから', 'だから', 'でも'],
                correctIndex: 0,
                explanation: {
                    correct: '「そして」正確！追加特點用「そして」更自然。這是陷阱題！',
                    wrong: [
                        '「それから」錯誤：「それから」更強調時間順序，追加特點用「そして」！',
                        '「だから」錯誤：不是因果關係。',
                        '「でも」錯誤：沒有轉折。'
                    ]
                }
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '正確！「それから」主要用於：1. 時間順序「買い物をした。それから、帰った」。2. 列舉「りんごと、それからバナナ」。',
                    wrong: [
                        '錯誤：轉折用「しかし」「でも」。',
                        '錯誤：因果用「だから」「ので」。',
                        '錯誤：假設用「たら」「ば」。'
    ...
    n5_wa_topic_marker: {
        ...
        quiz: [
            ...
            {
                id: 'n5_q_watopic_2',
                sentence: '「誰{だれ}が先生{せんせい}ですか。」\n「田中{たなか}さん（　）先生{せんせい}です。」',
                options: ['が', 'は', 'を', 'で'],
                correctIndex: 0,
                explanation: {
                    correct: '「が」正確！回答「誰」的問題時，焦點在人，用「が」。這是陷阱題！',
                    wrong: [
                        '「は」錯誤：回答「誰が」問題時，強調焦點的答案用「が」！',
                        '「を」錯誤：「を」是賓語助詞。',
                        '「で」錯誤：「で」表示場所或方式。'
                    ]
                }
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '正確！「田中さんは先生です」（介紹田中的職業）。「田中さんが先生です」（回答「誰是老師」）。',
                    wrong: [
                        '錯誤：意思不同！',
                        '錯誤：兩者都可用於疑問句和陳述句。',
                        '錯誤：禮貌程度沒有差別。'
    ...
    n5_o_kudasai: {
        ...
        quiz: [
            ...
            {
                id: 'n5_q_okudasai_3',
                sentence: 'ここに名前{なまえ}を書{か}い（　）ください。',
                options: ['て', 'を', 'た', 'に'],
                correctIndex: 0,
                explanation: {
            ...
            {
                id: 'n5_q_okudasai_5',
                sentence: '「名詞＋をください」和「動詞て形＋ください」的差別是？',
                options: [
                    '名詞＋を：請求物品；動詞て形：請求動作',
                    '意思完全相同',
                    '名詞＋を：請求動作；動詞て形：請求物品',
                ...
                correctIndex: 0,
                explanation: {
                    correct: '正確！「水をください」=請給我水。「読んでください」=請讀。',
                    wrong: [
                        '錯誤：意思不同！',
                        '錯誤：順序相反了！',
                        '錯誤：禮貌程度相同。'
    ...
    n5_o_go: {
        ...
        quiz: [
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「お」正確！「電話」是例外，雖是漢語但用「お」。這是陷阱題！',
                    wrong: [
                        '「ご」錯誤：「電話」是例外！雖是漢語但習慣用「お」。',
                        '「の」錯誤：「の」是助詞。',
                        '「と」錯誤：「と」是助詞。'
                    ]
                }
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '正確！「お水、お名前」（和語用お）。「ご住所、ご家族」（漢語用ご）。例外如「お電話、お時間」。',
                    wrong: [
                        '錯誤：順序相反了！',
                        '錯誤：跟食物無關。',
                        '錯誤：不能互換，有規則！'
    ...
    n5_ni_e: {
        ...
        quiz: [
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「に」正確！「〜に遊びに行く」表示去某處玩。「へ」也可以。',
                    wrong: [
                        '「で」錯誤：移動目的地用「に」或「へ」。',
                        '「を」錯誤：不適用。',
                        '「が」錯誤：不適用。'
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '正確！「東京に着く」（到達）只能用「に」。「東京へ/に行く」（移動）兩者都可。',
                    wrong: [
                        '錯誤：有細微差別！',
                        '錯誤：順序相反了！',
                        '錯誤：兩者都可用於地點。'
        ...
        quiz: [
            ...
            },
            {
                ...
                explanation: {
                    ...
                    wrong: [
                        '「の中で」錯誤：「の中で」用於三個以上的比較，兩者比較用「と」或「より」！',
                        '「が」錯誤：不適用。',
                        '「に」錯誤：不適用。'
                    ]
                }
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '正確！「果物の中でりんごが一番好き」=水果中最喜歡蘋果。兩者比較用「より」或「どちら」。',
                    wrong: [
                        '錯誤：兩者比較用「より」或「どちらが」。',
                        '錯誤：時間用其他表達方式。',
                        '錯誤：位置用其他表達方式。'
    ...
    n5_i_adjectives_1: {
        ...
        quiz: [
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「だった」正確！「静か」是な形容詞，過去形是「だった」。這是陷阱題！',
                    wrong: [
                        '「かった」錯誤：「かった」是い形容詞的過去形！「静か」是な形容詞！',
                        '「い」錯誤：「い」是い形容詞的詞尾。',
                        '「な」錯誤：「な」是修飾名詞時用的。'
                    ]
                }
    ...
    n5_na_adjectives_1: {
        ...
        quiz: [
            ...
            {
                id: 'n5_q_naadjpast_3',
                sentence: '昨日{きのう}の天気{てんき}は良{よ}（　）。',
                options: ['かった', 'だった', 'い', 'な'],
                correctIndex: 0,
                explanation: {
                    correct: '「かった」正確！「良い/いい」是い形容詞，過去形是「良かった」。這是陷阱題！',
                    wrong: [
                        '「だった」錯誤：「良い」是い形容詞，不是な形容詞！',
                        '「い」錯誤：「い」是現在形。',
                        '「な」錯誤：「良い」不是な形容詞。'
                    ]
                }
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '正確！「綺麗」雖以「い」結尾，但它是な形容詞！「綺麗だ」「綺麗な人」「綺麗だった」。',
                    wrong: [
                        '錯誤：「綺麗」不是い形容詞！「綺麗い」是錯誤的。',
                        '錯誤：只能是な形容詞。',
                        '錯誤：「綺麗」是な形容詞。'
                    ]
                }
