...
export const n2Details: Record<string, GrammarPoint> = {
        ...
        explanation: [
            {
                usageId: 1,
                title: '經過一番折騰後的負面結果',
                description: '表示經過長時間或反覆嘗試後，結果走向不理想，語氣常帶遺憾。',
                examples: [
                    {
                        japanese: '長{なが}い会{かい}議{ぎ}が続{つづ}いたあげく、結{けっ}論{ろん}は先{さき}送{おく}りになった。',
                        chinese: '長時間開會後，結果結論被延後了。'
                    },
                    {
                        japanese: '探{さが}し回{まわ}ったあげく、鍵{かぎ}は見{み}つからなかった。',
                        chinese: '到處找了半天，結果還是找不到鑰匙。'
                    },
                    {
                        japanese: '「旅{りょ}行{こう}は決{き}まった？」\n「うん、宿{やど}を探{さが}したあげく、どこも満{まん}室{しつ}で結{けっ}局{きょく}あきらめたんだ。」\n「えっ、それは残{ざん}念{ねん}だね。」',
                        chinese: '「旅行決定了嗎？」\n「嗯，找了住宿之後，結果哪裡都滿房，只好放棄了。」\n「咦，那太可惜了。」'
                    }
                ]
            }
        ],
        analysis: {
            title: '「あげく」與「末{すえ}」的差異',
            description: '兩者都表示「經過一番...之後」，但語感與結果方向不同。',
            comparison: [
                {
                    point: '「あげく」多用於負面結果',
                    correct: { sentence: '待{ま}たされたあげく、予{よ}約{やく}は取{と}れなかった。', note: '○ 過程久且結果不理想' },
                    incorrect: { sentence: '待{ま}たされたあげく、楽{たの}しい時{じ}間{かん}を過{す}ごせた。', note: '✕ 結果是正面時不自然' }
                },
                {
                    point: '「末{すえ}」可接正面或負面結果，但需有長過程',
                    correct: { sentence: '長{なが}い練{れん}習{しゅう}の末{すえ}、優{ゆう}勝{しょう}した。', note: '○ 長期努力後的結果' },
                    incorrect: { sentence: '少{すこ}し考{かんが}えた末{すえ}、すぐ決{き}めた。', note: '✕ 過程太短，語感不自然' }
                }
            ],
            summary: '「あげく」偏負面結果，「末{すえ}」則著重長過程，正負皆可。'
        },
        tips: {
            title: '小提醒：學習者常犯錯誤',
            items: [
                {
                    mistake: '把正面結果也用「あげく」來表達',
                    explanation: '「あげく」通常帶有遺憾或負面結果的語感，正面結果更自然用「末{すえ}」或「結果」。',
                    whenToUse: '結果不理想、帶有後悔時使用「あげく」。',
                    correct: { sentence: '探{さが}したあげく、結{けっ}局{きょく}見{み}つからなかった。', note: '○ 結果不理想' },
                    incorrect: { sentence: '探{さが}したあげく、見{み}つかって嬉{うれ}しかった。', note: '✕ 正面結果不自然' },
                    memoryTip: '「あげく」= 折騰很久，結果不太妙。'
                },
                {
                    mistake: '接續錯誤，忘記用「た形」或「名詞+の」',
                    explanation: '「あげく」前面需接動詞た形或名詞+の，其他形態不成立。',
                    whenToUse: '動詞用過去形，名詞用「の」。',
                    correct: { sentence: '悩{なや}んだあげく、辞{や}めた。', note: '○ 動詞た形' },
                    incorrect: { sentence: '悩{なや}むあげく、辞{や}めた。', note: '✕ 辭書形不可' },
                    memoryTip: '想成「做完一連串之後」→ 用「た形」。'
                }
            ]
        },
        quiz: [
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「あげく」正確！長く悩んだ末に不本意な結論に至る流れ。',
                    wrong: [
                        '「きり」錯誤：動作が一度きりで終わる意味になり文脈不合。',
                        '「一方」錯誤：対比の表現で、結果を示さない。',
                        '「際」錯誤：時点を表すだけで「結果」の意味がない。'
                    ]
                }
            },
            {
                id: 'n2_ageku_2',
                sentence: '大{おお}喧{げん}嘩{か}の（　）、二{ふた}人{り}は別{わか}れてしまった。',
                options: ['あげく', 'あと', 'ところ', 'ばかり'],
                correctIndex: 0,
                explanation: {
                    correct: '「あげく」正確！名詞+の+あげくで負面結果を表す。',
                    wrong: [
                        '「あと」錯誤：単なる順序で「結果」の含みが弱い。',
                        '「ところ」錯誤：場面や状況の意味で不自然。',
                        '「ばかり」錯誤：程度の「ばかり」ではない。'
                    ]
                }
            ...
            {
                id: 'n2_ageku_3',
                sentence: '長{なが}い練{れん}習{しゅう}の（　）、試{し}合{あい}に勝{か}った。',
                options: ['あげく', '末{すえ}', 'ところ', 'ばかり'],
                correctIndex: 1,
                explanation: {
                    correct: '「末{すえ}」正確！長い過程の末に良い結果。',
                    wrong: [
                        '「あげく」錯誤：良い結果には不自然。',
                        '「ところ」錯誤：直前の場面を表すだけ。',
                        '「ばかり」錯誤：概数・程度の用法ではない。'
            ...
            {
                id: 'n2_ageku_4',
                sentence: '「宿{やど}は決{き}まった？」\n「いろいろ探{さが}した（　）、どこも満{まん}室{しつ}で結{けっ}局{きょく}あきらめた。」\n「それは大{たい}変{へん}だったね。」',
                options: ['末{すえ}に', 'ところで', 'あげく', '以上{いじょう}'],
                correctIndex: 2,
                explanation: {
                    correct: '「あげく」正確！試行の末に不本意な結論。',
                    wrong: [
                        '「末に」錯誤：良い結果向きの語感で不自然。',
                        '「ところで」錯誤：話題転換で文脈不合。',
                        '「以上」錯誤：条件や理由の意味になってしまう。'
                    ]
                }
            },
            {
                id: 'n2_ageku_5',
                sentence: '何{なん}度{ど}も試{ため}した（　）、結{けっ}局{きょく}動{うご}かなかった。',
                options: ['あげく', '末{すえ}', 'だけに', 'きり'],
                correctIndex: 0,
                explanation: {
                    correct: '「あげく」正確！反復の末に不成功の結果。',
                    wrong: [
                        '「末{すえ}」錯誤：文脈が失敗で「末」でも可能だが、「あげく」の方が自然。',
                        '「だけに」錯誤：理由を示す表現で結果の流れが不自然。',
                        '「きり」錯誤：一度きりの意味になってしまう。'
                    ]
                }
            }
        ]
        ...
        explanation: [
            {
                ...
                examples: [
                    ...
                    { japanese: '申{もう}し込{こ}みは郵{ゆう}送{そう}、あるいはオンラインで受{う}け付{つ}けています。', chinese: '申請可用郵寄或線上方式受理。' },
                    { japanese: '「来{らい}週{しゅう}は空{あ}いてる？」\n「火{か}曜{よう}の午{ご}後{ご}、あるいは水{すい}曜{よう}の午{ご}前{ぜん}なら大{だい}丈{じょう}夫{ぶ}だよ。」\n「じゃあ水{すい}曜{よう}にしよう。」', chinese: '「下週有空嗎？」\n「週二下午，或者週三上午都可以。」\n「那就週三吧。」' }
                ]
            },
            {
                usageId: 2,
                title: '可能性（副詞）',
                description: '「也許、可能」的語感，常接「かもしれない」等推量表現。',
                examples: [
                    { japanese: 'あるいは明{あ}日{した}、雨{あめ}が降{ふ}るかもしれない。', chinese: '也許明天會下雨。' },
                    { japanese: '彼{かれ}はあるいはもう帰{かえ}ったかもしれない。', chinese: '他也許已經回去了。' },
                    { japanese: '「遅{おく}れるって連{れん}絡{らく}あった？」\n「まだない。でもあるいは電{でん}車{しゃ}が止{と}まってるのかもしれないね。」\n「そうか、少{すこ}し待{ま}とう。」', chinese: '「有說會晚到嗎？」\n「還沒有。不過也許電車停了。」\n「好，那就再等一下。」' }
                ]
            }
        ],
        analysis: {
            title: '「あるいは」與「または/もしくは」',
            description: '三者皆為「或者」，但正式程度與語感不同。',
            comparison: [
                {
                    point: '「あるいは」偏書面、公告文常見',
                    correct: { sentence: '申{もう}し込{こ}みは郵{ゆう}送{そう}、あるいはオンラインで受{う}け付{つ}けます。', note: '○ 書面說明' },
                    incorrect: { sentence: '友{とも}達{だち}に「あるいはカフェ行{い}く？」と聞{き}いた。', note: '✕ 口語不自然' }
                },
                {
                    point: '「または/もしくは」較中性，口語也可用',
                    correct: { sentence: '電{でん}話{わ}またはメッセージで連{れん}絡{らく}して。', note: '○ 口語也自然' },
                    incorrect: { sentence: 'それはまたは本{ほん}当{とう}かも。', note: '✕ 副詞用法不成立' }
                }
            ],
            summary: '書面正式用「あるいは」，一般選擇用「または/もしくは」，副詞用法只限「あるいは」。'
        },
        tips: {
            title: '小提醒：學習者常犯錯誤',
            items: [
                {
                    mistake: '在口語對話中過度使用「あるいは」',
                    explanation: '「あるいは」較正式，日常對話通常用「または」「それとも」。',
                    whenToUse: '公告、說明、條列選項時用「あるいは」。',
                    correct: { sentence: '本{ほん}日{じつ}は電{でん}話{わ}、あるいはメールでご連{れん}絡{らく}ください。', note: '○ 書面通知' },
                    incorrect: { sentence: '昼{ひる}ご飯{はん}はあるいはラーメンにする？', note: '✕ 口語不自然' },
                    memoryTip: '「あるいは」= 公告體的「或者」。'
                },
                {
                    mistake: '副詞用法時忘了推量語尾',
                    explanation: '副詞的「あるいは」多搭配「かもしれない／だろう」來表達推測。',
                    whenToUse: '要表達不確定的可能性時。',
                    correct: { sentence: 'あるいは遅{おく}れるかもしれない。', note: '○ 推量' },
                    incorrect: { sentence: 'あるいは遅{おく}れる。', note: '✕ 斷定語感過強' },
                    memoryTip: '副詞「あるいは」後面接推量。'
                }
            ]
        },
        quiz: [
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「あるいは」正確！手段を並列。',
                    wrong: [
                        '「それに」錯誤：追加理由で並列の選択ではない。',
                        '「ところが」錯誤：逆接の意味。',
                        '「一方」錯誤：対比の意味になる。'
                    ]
                }
            ...
            {
                id: 'n2_aruiwa_4',
                sentence: '「遅{おく}いね。」\n「うん、あるいは電{でん}車{しゃ}が止{と}まっている（　）。」',
                options: ['かもしれない', 'わけだ', 'はずだ', 'に違{ちが}いない'],
                correctIndex: 0,
                explanation: {
                    correct: '「かもしれない」正確！副詞「あるいは」と相性が良い推量表現。',
                    wrong: [
                        '「わけだ」錯誤：推量ではなく結論の説明。',
                        '「はずだ」錯誤：根拠のある確信で語感が違う。',
                        '「に違いない」錯誤：強い断定で不自然。'
                    ]
                }
            },
            {
                id: 'n2_aruiwa_5',
                sentence: 'ご意{い}見{けん}は書{しょ}面{めん}（　）電{でん}話{わ}でお寄{よ}せください。',
                options: ['もしくは', 'あるいは', 'だから', 'しかも'],
                correctIndex: 0,
                explanation: {
                    correct: '「もしくは」正確！中立的な「または」に近い表現。',
                    wrong: [
                        '「あるいは」錯誤：意味は近いが、ここではより中立な「もしくは」が自然。',
                        '「だから」錯誤：原因・結果の接続。',
                        '「しかも」錯誤：追加の意味で選択ではない。'
                    ]
                }
        ...
        explanation: [
            {
                usageId: 1,
                title: '概數（大約、左右）',
                description: '「約〜」「だいたい〜」的語感，用於數量、時間、距離等的概略估計。偏中性、較書面。',
                examples: [
                    ...
                    { japanese: '「どのくらい待{ま}ちますか。」\n「三{さん}十{じゅう}分{ぷん}ばかりだと思{おも}います。」\n「分{わ}かりました。」', chinese: '「大概要等多久？」\n「我想大概三十分鐘左右。」\n「了解。」' }
                ]
            }
        ],
        analysis: {
            title: '「ばかり」與「ぐらい／ほど」',
            description: '三者都可表概數，但語感與用途不同。',
            comparison: [
                {
                    point: '「ばかり」較書面、較中性',
                    correct: { sentence: '千{せん}円{えん}ばかり用{よう}意{い}してください。', note: '○ 通知、說明語氣自然' },
                    incorrect: { sentence: '今{いま}、千{せん}円{えん}ばかり持{も}ってきて〜。', note: '✕ 太口語時用「ぐらい」更自然' }
                },
                {
                    point: '「ほど」也可表概數，但常帶程度語感',
                    correct: { sentence: '十{じゅっ}分{ぷん}ほどで着{つ}きます。', note: '○ 概數可用「ほど」' },
                    incorrect: { sentence: '緊{きん}張{ちょう}で手{て}が震{ふる}えるばかりだった。', note: '✕ 程度用法不可用「ばかり」' }
                }
            ],
            summary: '概數時三者皆可，但「ばかり」偏書面；程度強調則用「ほど」。'
        },
        tips: {
            title: '小提醒：學習者常犯錯誤',
            items: [
                {
                    mistake: '把「ばかり」理解成「只有」而用在概數位置',
                    explanation: 'N2 的「ばかり」是概數，不是「只有」。若要表「只」多用「だけ」。',
                    whenToUse: '數量或時間的「大約」時使用。',
                    correct: { sentence: '五{ご}十{じゅう}人{にん}ばかり集{あつ}まった。', note: '○ 概數' },
                    incorrect: { sentence: '五{ご}十{じゅう}人{にん}ばかり来{き}た。だから少{すく}ない。', note: '✕ 想說「只有」更自然用「だけ」' },
                    memoryTip: '「ばかり」= 大約，不是「只有」。'
                },
                {
                    mistake: '在口語指示中用「ばかり」顯得太正式',
                    explanation: '日常口語常用「ぐらい」，「ばかり」較書面。',
                    whenToUse: '公告、說明、報告等正式語境。',
                    correct: { sentence: '千{せん}円{えん}ぐらい持{も}ってきて。', note: '○ 口語自然' },
                    incorrect: { sentence: '千{せん}円{えん}ばかり持{も}ってきて。', note: '✕ 口語略生硬' },
                    memoryTip: '口語「ぐらい」= 輕鬆自然。'
                }
            ]
        },
        quiz: [
            {
                ...
                options: ['ばかり', 'だけ', 'しか', 'ほどに'],
                correctIndex: 0,
                explanation: {
                    correct: '「ばかり」正確！概數の表現。',
                    wrong: [
                        '「だけ」錯誤：意為「只有」，語感不同。',
                        '「しか」錯誤：需搭配否定。',
                        '「ほどに」錯誤：程度或結果の意味になってしまう。'
                    ]
                }
            },
            {
            ...
            {
                id: 'n2_bakari_4',
                sentence: '緊{きん}張{ちょう}で声{こえ}が出{で}ない（　）だった。',
                options: ['ほど', 'ばかり', 'ぐらい', 'だけ'],
                correctIndex: 0,
                explanation: {
                    correct: '「ほど」正確！程度を強く表す。',
                    wrong: [
                        '「ばかり」錯誤：概數の意味になってしまう。',
                        '「ぐらい」錯誤：程度は表せるが文脈では「ほど」が自然。',
                        '「だけ」錯誤：限定の意味になる。'
                    ]
                }
            },
            {
                id: 'n2_bakari_5',
                sentence: '千{せん}円{えん}（　）持{も}ってきて。',
                options: ['ぐらい', 'ばかり', 'だけ', 'しか'],
                correctIndex: 0,
                explanation: {
                    correct: '「ぐらい」正確！口語の依頼では自然。',
                    wrong: [
                        '「ばかり」錯誤：意味は近いが口語では生硬。',
                        '「だけ」錯誤：限定になり「大約」ではない。',
                        '「しか」錯誤：否定が必要。'
        ...
        explanation: [
            {
                usageId: 1,
                title: '變化只往一個方向發展',
                description: '狀態或情況持續朝同一方向變化，多帶擔憂或無奈，多為變壞或減少。',
                examples: [
                    { japanese: '物{もの}価{か}は上{あ}がるばかりだ。', chinese: '物價一直在上漲。' },
                    { japanese: '彼{かれ}の成績{せいせき}は悪{わる}くなるばかりだ。', chinese: '他的成績只會越來越差。' },
                    { japanese: '「最{さい}近{きん}どう？」\n「仕{し}事{ごと}が増{ふ}えるばかりで休{やす}みが取{と}れない。」\n「それは大{たい}変{へん}だね。」', chinese: '「最近怎樣？」\n「工作只會越來越多，休假都排不到。」\n「那也太辛苦了。」' }
                ]
            }
        ],
        analysis: {
            title: '「ばかりだ」與「一{いっ}方{ぽう}だ／〜ていく」',
            description: '都是表示變化方向，但語感不同。',
            comparison: [
                {
                    point: '「ばかりだ」多含負面、無奈語氣',
                    correct: { sentence: '不{ふ}景{けい}気{き}で売{う}り上{あ}げが下{さ}がるばかりだ。', note: '○ 擔憂感' },
                    incorrect: { sentence: '休{きゅう}日{じつ}が増{ふ}えるばかりだ。', note: '✕ 正面結果不太自然' }
                },
                {
                    point: '「一方だ」較書面、描述趨勢',
                    correct: { sentence: '人{じん}口{こう}は減{へ}る一{いっ}方{ぽう}だ。', note: '○ 客觀趨勢' },
                    incorrect: { sentence: '今{いま}、少{すこ}しずつ良{よ}くなる一方だ。', note: '✕ 漸進改善較少用一方だ' }
                }
            ],
            summary: '「ばかりだ」偏主觀、擔憂；「一方だ」較客觀書面。'
        },
        tips: {
            title: '小提醒：學習者常犯錯誤',
            items: [
                {
                    mistake: '把「ばかりだ」用在明顯正面結果',
                    explanation: '「ばかりだ」多暗示不好的走向。正面結果可用「〜ていく」或「増{ふ}えていく」。',
                    whenToUse: '描述持續惡化或令人擔心的趨勢。',
                    correct: { sentence: '治{ち}安{あん}が悪{わる}くなるばかりだ。', note: '○ 負面趨勢' },
                    incorrect: { sentence: '給{きゅう}料{りょう}が上{あ}がるばかりだ。', note: '✕ 正面結果不自然' },
                    memoryTip: '「ばかりだ」= 越來越糟。'
                },
                {
                    mistake: '接續用成「た形＋ばかりだ」',
                    explanation: '此用法固定接動詞辭書形（Vる + ばかりだ）。',
                    whenToUse: '描述變化持續進行時。',
                    correct: { sentence: '値{ね}上{あ}げが続{つづ}くばかりだ。', note: '○ 辭書形' },
                    incorrect: { sentence: '値{ね}上{あ}げが続{つづ}いたばかりだ。', note: '✕ 成了「剛剛」的語感' },
                    memoryTip: '趨勢=「Vる＋ばかりだ」。'
                }
            ]
        },
        quiz: [
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「ばかり」正確！「〜ばかりだ」で一方向の変化。',
                    wrong: [
                        '「ばかりに」錯誤：原因の意味。',
                        '「ばかりか」錯誤：不僅…而且…。',
                        '「ばかりで」錯誤：理由の接続になってしまう。'
                    ]
                }
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「ばかりで」正確！理由をつなぐ形。',
                    wrong: [
                        '「ばかりに」錯誤：原因の強調で文脈が不自然。',
                        '「ばかりか」錯誤：追加強調になってしまう。',
                        '「ばかりだ」錯誤：後続が理由節になるため不適切。'
                    ]
                }
            },
            {
                ...
                correctIndex: 1,
                explanation: {
                    correct: '「ばかりだ」正確！悪化が続く流れ。',
                    wrong: [
                        '「ばかり」錯誤：後ろに「だ」を付けないと不自然。',
                        '「ばかりか」錯誤：追加強調になってしまう。',
                        '「ばかりに」錯誤：原因の意味になる。'
                    ]
                }
            ...
            {
                id: 'n2_bakari_da_4',
                sentence: '人{じん}口{こう}は減{へ}る（　）だ。',
                options: ['一{いっ}方{ぽう}', 'ばかり', 'ばかりに', 'ばかりか'],
                correctIndex: 0,
                explanation: {
                    correct: '「一方」正確！客觀的趨勢描述。',
                    wrong: [
                        '「ばかり」錯誤：後ろに「だ」が必要。',
                        '「ばかりに」錯誤：原因強調で意味が違う。',
                        '「ばかりか」錯誤：追加強調の意味。'
            ...
            {
                id: 'n2_bakari_da_5',
                sentence: '「休{やす}みは増{ふ}えた？」\n「いいえ、残{ざん}業{ぎょう}が増{ふ}える（　）だ。」',
                options: ['ばかり', 'ばかりだ', 'ばかりに', 'ばかりか'],
                correctIndex: 1,
                explanation: {
                    correct: '「ばかりだ」正確！悪化の一方向。',
                    wrong: [
                        '「ばかり」錯誤：文末に「だ」が必要。',
                        '「ばかりに」錯誤：原因強調になってしまう。',
                        '「ばかりか」錯誤：追加強調で文脈が不自然。'
        ...
        explanation: [
            {
                usageId: 1,
                title: '不僅如此，甚至更進一步',
                description: 'A已經成立，B更超出預期或更強烈，帶有「不僅…而且…」的遞進語感。',
                examples: [
                    ...
                    { japanese: '「店{みせ}はどうだった？」\n「安{やす}いばかりか、味{あじ}もすごく良{よ}かったよ。」\n「それは行{い}きたい！」', chinese: '「那家店怎樣？」\n「不只便宜，味道也非常好。」\n「那我也想去！」' }
                ]
            }
        ],
        analysis: {
            title: '「ばかりか」與「だけでなく／どころか」',
            description: '都可表遞進，但語感強度不同。',
            comparison: [
                {
                    point: '「ばかりか」強調超出預期，後項更強',
                    correct: { sentence: '遅{おそ}刻{こく}したばかりか、連{れん}絡{らく}もしなかった。', note: '○ 惡化、超出預期' },
                    incorrect: { sentence: 'コーヒーばかりか、紅{こう}茶{ちゃ}も飲{の}めます。', note: '✕ 單純並列，用「だけでなく」更自然' }
                },
                {
                    point: '「どころか」更有「相反／甚至」的語感',
                    correct: { sentence: '忙{いそが}しいどころか、休{やす}む時{じ}間{かん}もない。', note: '○ 甚至更糟' },
                    incorrect: { sentence: '遅{おそ}刻{こく}したどころか、宿{しゅく}題{だい}も出{だ}した。', note: '✕ 後項若是正面，語感不自然' }
                }
            ],
            summary: '超出預期用「ばかりか」，單純並列用「だけでなく」。'
        },
        tips: {
            title: '小提醒：學習者常犯錯誤',
            items: [
                {
                    mistake: '把單純並列也用「ばかりか」',
                    explanation: '「ばかりか」帶有遞進和「更強」的語感，單純列舉較自然用「だけでなく」。',
                    whenToUse: '後項比前項更嚴重或更令人意外時。',
                    correct: { sentence: '遅{おそ}刻{こく}したばかりか、謝{あやま}りもしなかった。', note: '○ 遞進更糟' },
                    incorrect: { sentence: '店{みせ}は広{ひろ}いばかりか、席{せき}も多{おお}い。', note: '✕ 單純並列' },
                    memoryTip: '「ばかりか」= A已經很誇張，B更誇張。'
                },
                {
                    mistake: '後項比前項弱，語感不自然',
                    explanation: '「ばかりか」的後項應更強或更出乎意料。',
                    whenToUse: 'A成立，B更超出預期。',
                    correct: { sentence: '頭{あたま}が痛{いた}いばかりか、熱{ねつ}まで出{で}た。', note: '○ 後項更嚴重' },
                    incorrect: { sentence: '頭{あたま}が痛{いた}いばかりか、少{すこ}し眠{ねむ}い。', note: '✕ 後項較弱' },
                    memoryTip: '後項要「更重」才合理。'
                }
            ]
        },
        quiz: [
            ...
            },
            {
                ...
                options: ['ばかりか', 'だけでなく', 'ばかりで', 'ばかりだ'],
                correctIndex: 1,
                explanation: {
                    correct: '「だけでなく」正確！單純並列。',
                    wrong: [
                        '「ばかりか」錯誤：遞進過強。',
                        '「ばかりで」錯誤：理由の接続になる。',
                        '「ばかりだ」錯誤：一方向の変化。'
            ...
            {
                id: 'n2_bakari_ka_4',
                sentence: '「雨{あめ}だけ？」\n「ううん、雨{あめ}が降{ふ}る（　）、風{かぜ}も強{つよ}いよ。」',
                options: ['ばかりか', 'ばかり', 'ばかりに', 'ばかりだ'],
                correctIndex: 0,
                explanation: {
                    correct: '「ばかりか」正確！後項が追加で強い。',
                    wrong: [
                        '「ばかり」錯誤：概數や限定。',
                        '「ばかりに」錯誤：原因の意味。',
                        '「ばかりだ」錯誤：一方向の変化。'
            ...
            {
                id: 'n2_bakari_ka_5',
                sentence: '安{やす}い（　）、デザインもいい。',
                options: ['だけでなく', 'ばかりか', 'ばかりに', 'ばかりだ'],
                correctIndex: 0,
                explanation: {
                    correct: '「だけでなく」正確！單純並列に自然。',
                    wrong: [
                        '「ばかりか」錯誤：遞進が強すぎる。',
                        '「ばかりに」錯誤：原因の意味。',
                        '「ばかりだ」錯誤：一方向の変化。'
        ...
        explanation: [
            {
                usageId: 1,
                title: '單一原因導致負面結果',
                description: '強調「只因為這一點」，結果變壞或令人遺憾。語氣帶後悔。',
                examples: [
                    ...
                    { japanese: '「どうして落{お}ちたの？」\n「緊{きん}張{ちょう}しすぎたばかりに、実{じっ}力{りょく}が出{だ}せなかった。」\n「そっか、惜{お}しかったね。」', chinese: '「為什麼落選？」\n「只因為太緊張，結果沒發揮實力。」\n「這樣啊，真可惜。」' }
                ]
            }
        ],
        analysis: {
            title: '「ばかりに」與「せいで／ために」',
            description: '三者都可表原因，但語感不同。',
            comparison: [
                {
                    point: '「ばかりに」強調「只因為那一點」的遺憾',
                    correct: { sentence: '少{すこ}し遅{おく}れたばかりに、電{でん}車{しゃ}に乗{の}れなかった。', note: '○ 後悔語感' },
                    incorrect: { sentence: '疲{つか}れたばかりに、今日は早{はや}く寝{ね}る。', note: '✕ 後項是意志行動不自然' }
                },
                {
                    point: '「せいで／ために」較一般，可接客觀原因',
                    correct: { sentence: '雨{あめ}のせいで試{し}合{あい}が中{ちゅう}止{し}になった。', note: '○ 客觀原因' },
                    incorrect: { sentence: '雨{あめ}のせいで、休{やす}むことにした。', note: '✕ 意志行動には「ために」が自然' }
                }
            ],
            summary: '「ばかりに」帶強烈後悔感；中性原因用「ために／せいで」。'
        },
        tips: {
            title: '小提醒：學習者常犯錯誤',
            items: [
                {
                    mistake: '後項是意志或命令',
                    explanation: '「ばかりに」後面多為不情願的結果，不接命令或意志行動。',
                    whenToUse: '結果是遺憾、不利或後悔。',
                    correct: { sentence: '遅{おく}れたばかりに、席{せき}が取{と}れなかった。', note: '○ 不利結果' },
                    incorrect: { sentence: '遅{おく}れたばかりに、急{いそ}いで行{い}こう。', note: '✕ 意志行動' },
                    memoryTip: '「ばかりに」= 後悔的原因。'
                },
                {
                    mistake: '「だけ」和「ばかりに」混用',
                    explanation: '「だけに」表示程度高而理應如此；「ばかりに」是原因導致壞結果。',
                    whenToUse: '只因為一點點原因而吃虧。',
                    correct: { sentence: '真{しん}面{めん}目{もく}だったばかりに、損{そん}をした。', note: '○ 壞結果' },
                    incorrect: { sentence: '真{しん}面{めん}目{もく}だっただけに、損{そん}をした。', note: '✕ 語感不對' },
                    memoryTip: '「だけに」= 理所當然，「ばかりに」= 可惜。'
                }
            ]
        },
        quiz: [
            ...
            {
                id: 'n2_bakari_ni_4',
                sentence: '雨{あめ}の（　）、試{し}合{あい}が中{ちゅう}止{し}になった。',
                options: ['せいで', 'ばかりに', 'ばかりだ', 'ばかりか'],
                correctIndex: 0,
                explanation: {
                    correct: '「せいで」正確！客觀原因。',
                    wrong: [
                        '「ばかりに」錯誤：強い後悔語感になり不自然。',
                        '「ばかりだ」錯誤：一方向の変化。',
                        '「ばかりか」錯誤：追加強調。'
                    ]
                }
            ...
            {
                id: 'n2_bakari_ni_5',
                sentence: '「どうして合{ごう}格{かく}できなかったの？」\n「緊{きん}張{ちょう}しすぎた（　）だよ。」',
                options: ['ばかりに', 'ばかりだ', 'ばかりか', 'ばかり'],
                correctIndex: 0,
                explanation: {
                    correct: '「ばかりに」正確！後悔の原因。',
                    wrong: [
                        '「ばかりだ」錯誤：一方向の変化。',
                        '「ばかりか」錯誤：追加強調。',
                        '「ばかり」錯誤：概數・限定。'
    ...
    'n2_chinamini': {
        ...
        explanation: [
            {
                usageId: 1,
                title: '補充資訊／順便一提',
                description: '在主要話題之外補充相關小資訊，可用於口語或書面。',
                examples: [
                    ...
                    { japanese: '「来{らい}週{しゅう}の予{よ}定{てい}は？」\n「火{か}曜{よう}は空{あ}いてる。ちなみに午{ご}後{ご}なら行{い}けるよ。」\n「じゃあ火{か}曜{よう}で！」', chinese: '「下週的行程呢？」\n「週二有空，順便一提，下午可以。」\n「那就週二吧！」' }
                ]
            }
        ],
        analysis: {
            title: '「ちなみに」與「ところで」',
            description: '兩者都能轉接，但目的不同。',
            comparison: [
                {
                    point: '「ちなみに」是補充相關資訊',
                    correct: { sentence: 'この製{せい}品{ひん}は軽{かる}いです。ちなみに、耐{たい}久{きゅう}性{せい}も高{たか}いです。', note: '○ 相關補充' },
                    incorrect: { sentence: '今日は暑{あつ}いですね。ちなみに、試{し}験{けん}の件{けん}ですが…', note: '✕ 話題轉換用「ところで」更自然' }
                },
                {
                    point: '「ところで」是切換話題',
                    correct: { sentence: 'ところで、明{あした}の会{かい}議{ぎ}の資{し}料{りょう}できた？', note: '○ 話題轉換' },
                    incorrect: { sentence: 'この店{みせ}は安{やす}いです。ところで、味{あじ}もいいです。', note: '✕ 補充資訊用「ちなみに」更自然' }
                }
            ],
            summary: '補充相關資訊用「ちなみに」，切換話題用「ところで」。'
        },
        tips: {
            title: '小提醒：學習者常犯錯誤',
            items: [
                {
                    mistake: '用「ちなみに」硬切換新話題',
                    explanation: '「ちなみに」應該補充同一主題或相關資訊，突然轉題會不自然。',
                    whenToUse: '補充「順便一提」的內容。',
                    correct: { sentence: 'この本{ほん}は読{よ}みやすい。ちなみに、音{おん}声{せい}版{ばん}もある。', note: '○ 相關補充' },
                    incorrect: { sentence: 'この本{ほん}は読{よ}みやすい。ちなみに、明{あした}休{やす}み？', note: '✕ 話題轉換' },
                    memoryTip: '「ちなみに」= 同話題的補充。'
                },
                {
                    mistake: '把「ちなみに」當成原因或結論',
                    explanation: '「ちなみに」不是因果連接詞，不用來解釋理由。',
                    whenToUse: '加一個「順便說明」的小資訊。',
                    correct: { sentence: '雨{あめ}で試{し}合{あい}が中{ちゅう}止{し}。ちなみに、振{ふ}り替{か}えは来{らい}週{しゅう}です。', note: '○ 補充資訊' },
                    incorrect: { sentence: '雨{あめ}で試{し}合{あい}が中{ちゅう}止{し}。ちなみに、天{てん}気{き}が悪{わる}かった。', note: '✕ 原因説明は「ので」「から」' },
                    memoryTip: '原因不是「ちなみに」。'
                }
            ]
        },
        quiz: [
            ...
            {
                id: 'n2_chinamini_4',
                sentence: '今日は暑{あつ}いですね。（　）、明{あした}の会{かい}議{ぎ}の件{けん}ですが…。',
                options: ['ところで', 'ちなみに', 'だから', 'つまり'],
                correctIndex: 0,
                explanation: {
                    correct: '「ところで」正確！話題轉換。',
                    wrong: [
                        '「ちなみに」錯誤：補充資訊ではない。',
                        '「だから」錯誤：因果の意味。',
                        '「つまり」錯誤：要約の意味。'
            ...
            {
                id: 'n2_chinamini_5',
                sentence: '「このセミナー、何{なん}時{じ}まで？」\n「3時{じ}まで。ちなみに資{し}料{りょう}は後{あと}で配{はい}布{ふ}されるよ。」',
                options: ['ちなみに', 'それで', 'なぜなら', 'ところが'],
                correctIndex: 0,
                explanation: {
                    correct: '「ちなみに」正確！補足情報を追加。',
                    wrong: [
                        '「それで」錯誤：因果の流れになる。',
                        '「なぜなら」錯誤：理由説明になる。',
                        '「ところが」錯誤：逆接になる。'
        ...
        explanation: [
            {
                usageId: 1,
                title: '強調否定（口語）',
                description: '「全{まった}く～ない」「少{すこ}しも～ない」的口語版，強調「一點也不」。後面必接否定。',
                examples: [
                    ...
                    { japanese: '「新{あたら}しい仕{し}事{ごと}どう？」\n「まだちっとも慣{な}れないんだ。」\n「そっか、少{すこ}しずつだね。」', chinese: '「新工作怎樣？」\n「還是完全不習慣。」\n「這樣啊，慢慢來。」' }
                ]
            }
        ],
        analysis: {
            title: '「ちっとも～ない」與「全{まった}く／全{ぜん}然{ぜん}～ない」',
            description: '都是強調否定，但語感與語域不同。',
            comparison: [
                {
                    point: '「ちっとも」較口語、語氣柔和',
                    correct: { sentence: '何{なん}度{ど}聞{き}いても、ちっとも分{わ}からない。', note: '○ 口語自然' },
                    incorrect: { sentence: '報{ほう}告{こく}書{しょ}がちっとも整{ととの}っていない。', note: '✕ 書面では「全く」更自然' }
                },
                {
                    point: '「全く／全然」較中性，書面也可用',
                    correct: { sentence: '原{げん}因{いん}は全{まった}く分{わ}かっていない。', note: '○ 報告語氣' },
                    incorrect: { sentence: '全{まった}く眠{ねむ}い。', note: '✕ 肯定文では本來不自然' }
                }
            ],
            summary: '「ちっとも」偏口語，「全く／全然」較中性；三者都必接否定。'
        },
        tips: {
            title: '小提醒：學習者常犯錯誤',
            items: [
                {
                    mistake: '忘記接否定形',
                    explanation: '「ちっとも」必須搭配否定，否則語感不自然。',
                    whenToUse: '想說「一點也不」時，後面接否定。',
                    correct: { sentence: 'ちっとも覚{おぼ}えていない。', note: '○ 否定' },
                    incorrect: { sentence: 'ちっとも覚{おぼ}えた。', note: '✕ 肯定不可' },
                    memoryTip: '「ちっとも」= 否定專用。'
                },
                {
                    mistake: '在正式書面過度使用「ちっとも」',
                    explanation: '「ちっとも」較口語，正式書面多用「全く／全然」。',
                    whenToUse: '日常口語或對話中使用。',
                    correct: { sentence: '報{ほう}告{こく}書{しょ}には全{まった}く記{き}載{さい}がない。', note: '○ 書面自然' },
                    incorrect: { sentence: '報{ほう}告{こく}書{しょ}にはちっとも記{き}載{さい}がない。', note: '✕ 書面でやや不自然' },
                    memoryTip: '口語=「ちっとも」、書面=「全く」。'
                }
            ]
        },
        quiz: [
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「ちっとも」正確！否定形とセットで使う。',
                    wrong: [
                        '「だんだん」錯誤：増加の意味。',
                        '「どんどん」錯誤：急速に進む意味。',
                        '「すっかり」錯誤：完全に、で意味が合わない。'
                    ]
                }
            },
            {
            ...
            {
                id: 'n2_chitto_mo_nai_4',
                sentence: '今日は疲{つか}れたから、（　）早{はや}く寝{ね}る。',
                options: ['さっさと', 'ちっとも', 'ちょっと', 'すっかり'],
                correctIndex: 0,
                explanation: {
                    correct: '「さっさと」正確！素早く行動する意味。',
                    wrong: [
                        '「ちっとも」錯誤：否定と一緒に使う表現。',
                        '「ちょっと」錯誤：少しの意味で不自然。',
                        '「すっかり」錯誤：完全に、の意味。'
            ...
            {
                id: 'n2_chitto_mo_nai_5',
                sentence: '報{ほう}告{こく}書{しょ}には原{げん}因{いん}が（　）書{か}かれていない。',
                options: ['全{まった}く', 'ちっとも', '少{すこ}し', 'だいぶ'],
                correctIndex: 0,
                explanation: {
                    correct: '「全{まった}く」正確！書面で自然な強い否定。',
                    wrong: [
                        '「ちっとも」錯誤：口語で書面には不向き。',
                        '「少し」錯誤：否定強調にならない。',
                        '「だいぶ」錯誤：程度が高い意味。'
        ...
        explanation: [
            {
                usageId: 1,
                title: '理由にふさわしい結果',
                description: '理由や背景があるので「なるほど」と納得する時に使う。多くは良い評価と一緒に使う。',
                examples: [
                    ...
                    { japanese: '「そのホ{ほ}テルどうだった？」\n「高{たか}かっただけあって、サ{さ}ービスが本{ほん}当{とう}に丁{てい}寧{ねい}だった。」\n「やっぱりね。」', chinese: '「那家飯店怎樣？」\n「畢竟很貴，服務真的很周到。」\n「果然如此。」' }
                ]
            }
        ],
        analysis: {
            title: '「だけあって」與「だけに／だけのことはある」',
            description: '都表示「原因合理化結果」，但語感與位置不同。',
            comparison: [
                {
                    point: '「だけあって」偏「不愧是」的納得語感',
                    correct: { sentence: '経{けい}験{けん}者{しゃ}だけあって、対{たい}応{おう}が早{はや}い。', note: '○ 期待通り' },
                    incorrect: { sentence: '疲{つか}れたからだけあって、早{はや}く寝{ね}る。', note: '✕ 只是理由説明なら「だけに」' }
                },
                {
                    point: '「だけのことはある」は文末で評価を強調',
                    correct: { sentence: '高{たか}かっただけのことはある。味{あじ}が違{ちが}う。', note: '○ 評価を強調' },
                    incorrect: { sentence: '高{たか}かっただけのことはあるので、行{い}きましょう。', note: '✕ 文中の理由づけには不自然' }
                }
            ],
            summary: '「だけあって」= 納得の評価、「だけに」= 理由から自然な結果。'
        },
        tips: {
            title: '小提醒：學習者常犯錯誤',
            items: [
                {
                    mistake: '單純理由用「だけあって」',
                    explanation: '「だけあって」帶「不愧是」的評價色彩，純因果時用「だけに」較自然。',
                    whenToUse: '結果符合期待，帶讚嘆或納得。',
                    correct: { sentence: 'さすがプロだけあって、説{せつ}明{めい}が上{じょう}手{ず}だ。', note: '○ 評価がある' },
                    incorrect: { sentence: '雨{あめ}だからだけあって、試{し}合{あい}が中{ちゅう}止{し}になった。', note: '✕ 単純因果' },
                    memoryTip: '「だけあって」= 期待に見合う評価。'
                },
                {
                    mistake: '名詞接續加上「の」',
                    explanation: '名詞は「名詞 + だけあって」。例：「有名な店だけあって」。',
                    whenToUse: '名詞で理由を示すとき。',
                    correct: { sentence: '有{ゆう}名{めい}店{てん}だけあって、客{きゃく}が多{おお}い。', note: '○ 名詞直結' },
                    incorrect: { sentence: '有{ゆう}名{めい}店{てん}のだけあって、客{きゃく}が多{おお}い。', note: '✕ のは不要' },
                    memoryTip: '名詞は「の」なし。'
                }
            ]
        },
        quiz: [
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「だけあって」正確！期待通りの評価。',
                    wrong: [
                        '「だけに」錯誤：理由は合うが評価の納得感が弱い。',
                        '「だけましだ」錯誤：不満の比較。',
                        '「だけのことはある」錯誤：文末評価に使うのが自然。'
                    ]
                }
            },
            {
            ...
            },
            {
                ...
                correctIndex: 0,
                explanation: {
                    correct: '「だけあって」正確！「さすが〜だけあって」定番表現。',
                    wrong: [
                        '「だけましだ」錯誤：比較の意味。',
                        '「だけに」錯誤：理由説明で評価の納得感が薄い。',
                        '「だけのことはある」錯誤：文末評価が自然。'
                    ]
                }
            },
            {
                id: 'n2_dake_atte_4',
                sentence: '高{たか}かった（　）。確{たし}かに味{あじ}が違{ちが}う。',
                options: ['だけのことはある', 'だけあって', 'だけに', 'だけましだ'],
                correctIndex: 0,
                explanation: {
                    correct: '「だけのことはある」正確！文末で評価を強調。',
                    wrong: [
                        '「だけあって」錯誤：文末評価にするなら不自然。',
                        '「だけに」錯誤：理由説明で文脈が合わない。',
                        '「だけましだ」錯誤：不満比較。'
                    ]
                }
            ...
            {
                id: 'n2_dake_atte_5',
                sentence: '雨{あめ}だから（　）、試{し}合{あい}が中{ちゅう}止{し}になった。',
                options: ['だけに', 'だけあって', 'だけのことはある', 'だけましだ'],
                correctIndex: 0,
                explanation: {
                    correct: '「だけに」正確！単純な理由説明。',
                    wrong: [
                        '「だけあって」錯誤：評価の納得感がない。',
                        '「だけのことはある」錯誤：評価の強調で不自然。',
                        '「だけましだ」錯誤：比較の意味。'
                    ]
                }
            }
    ...
    'n2_ga_kikkake_de_o_kikkake_ni': {
        id: 'n2_ga_kikkake_de_o_kikkake_ni',
        pattern: 'がきっかけで / をきっかけに',
        connection: '動{どう}詞{し}た形{けい} + の/こと + がきっかけで\n名{めい}詞{し} + をきっかけに',
        translation: '以...為契機; 因...而開始',
        level: 'N2',
        explanation: [
            {
                usageId: 1,
                title: '契機による行動・変化',
                description: 'ある出来事や出会いをきっかけに、新しい行動や考え方が生まれることを表す。',
                examples: [
                    { japanese: '病{びょう}気{き}がきっかけで、食{しょく}生{せい}活{かつ}を見直{みなお}した。', chinese: '因為生病而重新檢視飲食生活。' },
                    { japanese: '友{とも}達{だち}の紹{しょう}介{かい}をきっかけに、この会{かい}社{しゃ}で働{はたら}き始{はじ}めた。', chinese: '因朋友介紹而開始在這家公司工作。' },
                    { japanese: '引{ひ}っ越{こ}しをきっかけに、写{しゃ}真{しん}を整{せい}理{り}した。', chinese: '以搬家為契機整理了照片。' }
                ]
            }
        ],
        quiz: [
            {
                id: 'n2_ga_kikkake_de_o_kikkake_ni_1',
                sentence: '事{じ}故{こ}（　）安{あん}全{ぜん}意{い}識{しき}が高{たか}まった。',
                options: ['がきっかけで', 'ばかりに', 'にもかかわらず', 'ところで'],
                correctIndex: 0,
                explanation: '出来事が原因となって意識が変化する。'
            },
            {
                id: 'n2_ga_kikkake_de_o_kikkake_ni_2',
                sentence: '留{りゅう}学{がく}したこと（　）、考{かんが}え方{かた}が変{か}わった。',
                options: ['がきっかけで', 'だけに', 'あげく', 'かねない'],
                correctIndex: 0,
                explanation: '「動詞た形 + こと + がきっかけで」。'
            },
            {
                id: 'n2_ga_kikkake_de_o_kikkake_ni_3',
                sentence: 'この出{で}会{あ}い（　）新{あたら}しい目{もく}標{ひょう}ができた。',
                options: ['をきっかけに', 'に限って', 'にすぎない', 'に応{おう}じて'],
                correctIndex: 0,
                explanation: '名詞 + をきっかけに。'
            }
        ]
