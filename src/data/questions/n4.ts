...
→ 原因：混淆可能形與受身形。可能形是e段（me），受身形是a段（ma）。`
    ...
    // 19. ひろう
    {
        ...
        options: [
            ...
            { text: '拾{ひろ}った', reason: '正確！五段動詞促音便。' },
...
・○ 褒{ほ}められた
・× 褒{ほ}めらた
→ 原因：一段動詞受身為「られる」，過去式為「られた」。漏掉「れ」是常見錯誤。`
    },
    {
        id: 'n4_gen_homeru_2',
...
【解析】「～ないでください」接在動詞未然形後。「いじめる」是一段動詞，去掉「る」即為未然形「いじめ」。
【相關詞比較】
・いじめる：欺負。
  例：「弱{よわ}い者{もの}をいじめる。」（欺負弱者。）
・からかう：戲弄/開玩笑。
  例：「友達{ともだち}をからかう。」（捉弄朋友。）
【易錯點】
・○ いじめないで
・× いじまないで
→ 原因：學習者常將「める」結尾的一段動詞誤認為五段，變成「ma」段。`
    },
    {
        id: 'n4_gen_ijimeru_2',
...
→ 原因：受身形「られる」是長音節，不促音便。`
    ...
    // 22. いきる
    {
        ...
        correctIndex: 0,
        tag: 'grammar',
        correctRule: `【考點】希望助動詞「たい」
【解析】「～たい」接在動詞連用形（ます形去ます）後。「生きる」→「生きます」→「生き」。
【相關詞比較】
・生{い}きる：活/生存。
...
・○ 生{い}きたい
・× 生{う}みたい
→ 原因：漢字「生」有多種讀音。「活著」是「いきる」。「產生/生小孩」是「うむ」。`
    },
    {
        id: 'n4_gen_ikiru_2',
...
→ 原因：「ている」前接te形。「生きる」→「生きて」。`
    ...
    // 23. いのる
    {
        ...
        level: 'N4',
        options: [
            { text: '祈{いの}ります', reason: '正確！五段動詞ます形。' },
            { text: '祈{いの}れ', reason: '錯誤：命令形。' },
            { text: '祈{いの}って', reason: '錯誤：te形。' },
            { text: '祈{いの}り', reason: '錯誤：連用形/名詞。' }
        ],
        correctIndex: 0,
        tag: 'vocab',
        correctRule: `【考點】動詞活用
...
・○ いらっしゃいます
・× いらっしゃります
→ 原因：「いらっしゃる」是特殊五段活用（aru及ur结尾的特殊敬語動詞），ます形是「いらっしゃいます」（i音變）。`
    },
    {
...
・おります：在。（謙）。
  例：「担当者{たんとうしゃ}は席{せき}を外{はず}しております。」（負責人不在座位上。）
【易錯點】
・○ いらっしゃいます
・× いらっしゃります
→ 原因：注意特殊活用。`
...
→ 原因：「てある」原則上只接他動詞。「入る」是自動詞，不能接「てある」。`
    ...
    // 26. いそぐ
    {
        ...
        options: [
            ...
            { text: '急{いそ}ぎ', reason: '正確！五段動詞連用形。' },
            { text: '急{いそ}げ', reason: '錯誤：命令形。' }
        ],
        correctIndex: 2,
        tag: 'masu',
        correctRule: `【考點】勸誘形（ましょう）
【解析】「～ましょう」接在動詞連用形後。「急ぐ」→「急ぎます」→「急ぎ」。
【相關詞比較】
・急{いそ}ぐ：趕快/著急。
  例：「駅{えき}へ急{いそ}ぐ。」（趕去車站。）
・慌{あわ}てる：慌張。
...
・○ 急{いそ}ぎましょう
・× 急{いそ}いでましょう
→ 原因：te形不能接ましょう。連用形（masu形去masu）才對。`
    },
    {
        id: 'n4_gen_isogu_2',
...
【解析】接受款待用餐時說「いただきます」。這也是「食べる」的謙讓語。
【相關詞比較】
・召{め}し上{あ}がる：吃/喝（尊敬）。
...
【解析】B回答自己的動作，應若是對A（如客戶）表示敬意，可用謙讓語「出席いたします」。
【相關詞比較】
・お願{ねが}いいたします：拜託您了。
...
→ 原因：問句用尊敬語「されますか」，答句必須切換為謙讓語或丁寧語。不能用尊敬語回答自己。`
    ...
    // 29. かえる
    {
        ...
        level: 'N4',
        options: [
            { text: '変{か}わります', reason: '錯誤：自動詞（預定自己變了）。' },
            { text: '変{か}えます', reason: '正確！一段他動詞（人為變更）。' },
...
→ 原因：換燈泡是人為動作。`
    ...
    // 30. かける
    {
        ...
        level: 'N4',
        options: [
            { text: '掛{か}かって', reason: '錯誤：自動詞（懸掛）。' },
            { text: '被{かぶ}って', reason: '錯誤：戴帽子。' },
            { text: '履{は}いて', reason: '錯誤：穿鞋/褲。' },
            { text: '掛{か}けて', reason: '正確！一段動詞（戴眼鏡）。' }
        ],
        correctIndex: 3,
        tag: 'vocab',
        correctRule: `【考點】穿戴動詞
【解析】日文穿戴動詞分得很細。戴眼鏡用「掛ける」。
【相關詞比較】
・眼鏡{めがね}を掛{か}ける：戴眼鏡。
...
・○ 掛{か}けて
・× 掛{か}かって
→ 原因：「掛かる」是自動詞（如：畫掛在牆上），人為戴眼鏡用他動詞「掛ける」。`
    },
    {
        id: 'n4_gen_kakeru_2',
...
・○ 格好{かっこう}
・× 形{かたち}
→ 原因：雖然意思都是形狀/樣子，但「帥」的慣用句是「格好がいい」。`
    },
    {
        id: 'n4_gen_kakkou_2',
...
→ 原因：中文「狗咬（我）」，主語是狗。日文若省略主語通常指「我（被咬）」。`
    ...
    // 34. かんがえる
    {
        ...
        options: [
            ...
            { text: '考{かんが}えって', reason: '錯誤：一段動詞不促音便。' },
...
→ 原因：te形接も。不是de。`
    ...
    // 35. かりる
    {
        ...
        level: 'N4',
        options: [
            { text: '借{か}りました', reason: '正確！一段動詞（借入）。' },
...
→ 原因：B是物品持有者，動作是「借出（貸す）」。`
    ...
    // 36. かたづける
    {
        ...
        options: [
            ...
            { text: '片付{かたづ}いて', reason: '錯誤：自動詞（這房間很整潔）。' },
...
→ 原因：一段動詞te形。`
    ...
    // 37. かつ
    {
        ...
        options: [
            ...
            { text: '勝{か}った', reason: '錯誤：常體（語體不統一，若無前文通常敬體優先，且此為單句題）。備註：若有丁寧體優先選丁寧體。' },
            { text: '勝{か}ち', reason: '錯誤：連用形。' }
        ],
        correctIndex: 0,
        tag: 'masu',
        correctRule: `【考點】單字語義
【解析】勝利是「勝つ」。助詞用「に」（勝負的對象/場合）。
【相關詞比較】
・勝{か}つ：贏。
...
→ 原因：引用句內保持動詞原形（除非已發生）。`
    ...
    // 38. かわく
    {
        ...
        level: 'N4',
        options: [
            { text: '乾{かわ}き', reason: '正確！五段自動詞mask形。' },
            { text: '乾{かわ}い', reason: '錯誤：變位錯誤（缺少き）。' },
            { text: '乾{かわ}かし', reason: '錯誤：他動詞（弄乾）。' },
            { text: '濡{ぬ}れ', reason: '錯誤：濕。' }
        ],
        correctIndex: 0,
        tag: 'vocab',
        correctRule: `【考點】自他動詞辨析
【解析】衣服乾了（自然狀態變化），用自動詞「乾く」。
【相關詞比較】
・乾{かわ}く：乾（自動）。
...
【解析】口渴日文說「喉が乾いた」（喉嚨乾了），習慣用過去式表示已經進入乾的狀態。
【相關詞比較】
・喉{のど}が乾{かわ}いた：口渴。
...
→ 原因：生理狀態的形容常使用過去式（完了形）表示狀態的確立。`
    ...
    // 39. かわる
    {
        ...
        level: 'N4',
        options: [
            { text: '変{か}わり', reason: '正確！五段自動詞。' },
            { text: '変{か}え', reason: '錯誤：他動詞（人去改變它）。' },
        ...
        tag: 'vocab',
        correctRule: `【考點】自他動詞辨析
【解析】號誌燈號變換是機械自動或自然變化，用自動詞「変わる」。
【相關詞比較】
・変{か}わる：改變/變化（自動）。
  例：「季節{きせつ}が変{か}わる。」（季節變換。）
・変{か}える：改變/更換（他動）。
...
・代{か}わりに：代替。
  例：「社長{しゃちょう}の代{か}わりに出席{しゅっせき}する。」（代替社長出席。）
【易錯點】
・○ 代{か}わります
・× 変{か}わります
...
→ 原因：漢字相同但讀音語義不同。`
    },
    {
        ...
        level: 'N4',
        options: [
            { text: '通{かよ}って', reason: '正確！表示習慣性往返。' },
...
・○ 飾{かざ}ります
・× 飾{かざ}います
→ 原因：五段動詞词尾「る」前是「a」段（kaza），變masu形時「る」變「り」。`
    },
    {
        id: 'n4_gen_kazaru_2',
...
→ 原因：五段動詞假定形是u段改e段+ば。`
    ...
    // 42. けす
    {
        ...
        level: 'N4',
        options: [
            { text: '消{け}して', reason: '正確！五段動詞te形。' },
            { text: '消{き}えて', reason: '錯誤：自動詞（燈自己滅）。' },
...
【解析】人為關燈用他動詞「消す」。電器、火的開關用「つける/けす」。
【相關詞比較】
・消{け}す：關掉/消去（他動）。
...
・○ 電気{でんき}を消{け}して
・× 電気{でんき}を閉{し}めて
→ 原因：中文都說「關」，但日文區分嚴格。門窗用「閉める」，電器用「消す」。`
    },
    {
        id: 'n4_gen_kesu_2',
...
→ 原因：五段動詞「su」結尾，te形為「shite」，無音便。`
    ...
    // 43. きえる
    {
        ...
        level: 'N4',
        options: [
            { text: '消{け}しました', reason: '錯誤：他動詞（人去熄滅）。' },
...
→ 原因：自動詞通常搭配主格助詞「が」。`
    },
    {
        ...
        options: [
            ...
            { text: '消{け}した', reason: '錯誤：他動詞（我把它關了）。' },
...
【解析】畫面突然滅掉（非人為操作），用自動詞「消える」的過去式「消えた」。
【相關詞比較】
...
→ 原因：學習者容易混淆自動詞與可能形（消せる）。`
    ...
    // 44. きこえる
    {
        ...
        options: [
            ...
            { text: '聞{き}こえます', reason: '正確！自發動詞。' },
            { text: '聞{き}きます', reason: '錯誤：意志動詞（去聽）。' },
            { text: '聞{き}こえ', reason: '錯誤：連用形。' }
        ],
        correctIndex: 1,
        tag: 'vocab',
        correctRule: `【考點】聽覺動詞辨析
...
→ 原因：自動詞用「が」。`
    },
    {
        ...
        options: [
            ...
            { text: '決{き}めて', reason: '錯誤：他動詞（我還沒決定）。雖然也可以，但自動詞更強調「狀態未定」。' },
...
→ 原因：助詞「を」提示受詞。`
    },
    {
        ...
        level: 'N4',
        options: [
            { text: '決{き}めた', reason: '正確！表決定（にする的動詞版）。' },
            { text: '決{き}まった', reason: '錯誤：自動詞（被決定成豬排飯了）。' },
...
→ 原因：搬家的「越」用「越」。超過數量的「超」用「超」。`
    },
    {
        ...
        level: 'N4',
        options: [
            { text: '越{こ}すん', reason: '正確！越す + んです（強調/説明）。' },
            { text: '越{こ}し', reason: '錯誤：動名詞引っ越し？但句尾要有だ/です。A句尾是ね。動詞接續較自然。' },
...
→ 原因：漢字寫法。`
    ...
    // 50. こわれる
    {
        ...
        level: 'N4',
        options: [
            { text: '壊{こわ}れて', reason: '正確！一段自動詞te形+いる。' },
            { text: '壊{こわ}れ', reason: '錯誤：連用形。' },
            { text: '壊{こわ}して', reason: '錯誤：他動詞（弄壞）。' },
...
・○ 壊{こわ}れて
・× 壊{こわ}して
→ 原因：「して」是他動詞，表示某人弄壞了它。描述物品當下的狀態用自動詞。`
    },
    {
...
→ 原因：「壊す」是人為動作。「壊している」變成正在破壞它。`
    ...
    // 51. こわす
    {
        ...
        level: 'N4',
        options: [
            { text: '壊{こわ}しました', reason: '正確！五段他動詞。' },
            { text: '壊{こわ}れました', reason: '錯誤：自動詞（弟弟機壞了？語意不清，通常指相機自己壞）。強調弟弟是肇事者用他動詞。' },
...
→ 原因：有明確的主詞（弟弟）和受詞（相機），是典型的他動詞句型。`
    },
    {
        ...
        options: [
            ...
            { text: '壊{こわ}れた', reason: '錯誤：肚子裂開了（自動詞）。' },
...
→ 原因：「下がる」是指懸掛物或數值下降。`
    },
    {
        ...
        options: [
            ...
            { text: '下{くだ}る', reason: '正確！辞書形+こと（名詞化）。' },
            { text: '下{くだ}り', reason: '錯誤：名詞/連用形。' },
            { text: '下{さ}がる', reason: '錯誤：下降。' }
        ],
        correctIndex: 1,
        tag: 'grammar',
        correctRule: `【考點】名詞化（對話）
...
→ 原因：必須根據主語選擇敬語類別。`
    ...
    // 54. くらべる
    {
        ...
        options: [
            ...
            { text: '比{くら}べって', reason: '錯誤：一段動詞不促音便。' },
...
→ 原因：假定條件表示「一比之下就...」。`
    ...
    // 55. くれる
    {
        ...
        options: [
            ...
            { text: 'もらい', reason: '錯誤：主語如果是彼，不能用もらう（應為：彼に...もらった）。' },
            { text: 'やり', reason: '錯誤：給（下對下）。' }
        ],
        correctIndex: 0,
        tag: 'vocab',
        correctRule: `【考點】授受動詞（别人給我）
...
→ 原因：日文授受動詞嚴格區分主語方向。主語是給予者→くれる。主語是接受者→もらう。`
    ...
    // 56. まちがえる
    {
        ...
        level: 'N4',
        options: [
            { text: '間違{まちが}えて', reason: '正確！一段動詞。' },
            { text: '間違{まちが}って', reason: '錯誤：這是自動詞「間違う」的te形。雖然語意相通，但電話號碼是受詞（を），故用他動詞「間違える」較自然。且選項常考一段變位。' },
            { text: '違{ちが}って', reason: '錯誤：不同。' },
            { text: '直{なお}して', reason: '錯誤：訂正/修理。' }
        ],
        correctIndex: 0,
        tag: 'transitive',
        correctRule: `【考點】自他動詞舉例
【解析】弄錯了（他動詞），用「間違える」。
【相關詞比較】
・間違{まちが}える：弄錯（他動）。
...
→ 原因：一段動詞去ru加te。`
    },
    {
        ...
        options: [
            ...
            { text: '間違{まちが}いました', reason: '錯誤：雖然可以用，但口語承認錯誤常說「間違えました」（我搞錯了）。' },
            { text: '違{ちが}いました', reason: '錯誤：不一樣（指客觀事實不同）。' },
            { text: '直{なお}しました', reason: '錯誤：改正了。' }
        ],
        correctIndex: 0,
        tag: 'vocab',
        correctRule: `【考點】錯誤表達（對話）
【解析】自己做錯事承認錯誤時，常用他動詞「間違える」的過去式。
【相關詞比較】
...
→ 原因：自我反省用他動詞。`
    ...
    // 57. まいる
    {
        ...
        options: [
            ...
            { text: '行{い}', reason: '錯誤：不夠客氣（普通体）。' },
            { text: '来{き}', reason: '錯誤：來。' }
        ],
        correctIndex: 1,
        tag: 'keigo',
        correctRule: `【考點】謙讓語（去/來）
【解析】「行く、来る」的謙讓語是「参る」（mairu）。「参ります」。
【相關詞比較】
・参{まい}る：去/來（謙讓）。
...
→ 原因：商務電話需使用謙讓語。`
    ...
    // 58. まける
    {
        ...
        options: [
            ...
            { text: '落{お}ちて', reason: '錯誤：掉落/考試落榜（試験に落ちる）。但比賽輸用負ける。' },
            { text: '無{な}くして', reason: '錯誤：弄丟。' }
        ],
        correctIndex: 0,
        tag: 'te',
        correctRule: `【考點】動詞て形
【解析】由於是遺憾的結果（～てしまう），前接te形。「負ける」→「負けて」。
【相關詞比較】
・負{ま}ける：輸。
...
→ 原因：一段動詞不促音便。`
    },
    {
        ...
        options: [
            ...
            { text: '落{お}ちた', reason: '錯誤：落榜（若語境是考試可用，但無上下文通常指勝負時用負けた最通俗）。' }
        ],
        correctIndex: 0,
        tag: 'vocab',
        correctRule: `【考點】勝負表達（對話）
【解析】表達比賽結果「輸了」，用過去式「負けた」。
【相關詞比較】
・負{ま}け犬{いぬ}：敗犬（喪家之犬）。
・勝{か}ち負{ま}け：勝負。
  例：「勝{か}ち負{ま}けにこだわる。」（拘泥於勝負。）
【易錯點】
・○ 負{ま}けた
・× 負{ま}けった
→ 原因：一段動詞過去式去ru加ta。`
...
→ 原因：五段動詞u -> i。`
    ...
    // 60. まわる
    {
        ...
        level: 'N4',
        options: [
            { text: '回{まわ}って', reason: '正確！五段自動詞。' },
            { text: '回{まわ}して', reason: '錯誤：他動詞（人去轉它）。' },
...
→ 原因：不能問長輩「いただきますか」（您要領受嗎？），不禮貌。`
    ...
    // 62. みえる
    {
        ...
        correctIndex: 0,
        tag: 'vocab',
        correctRule: `【考點】視覺動詞辨析
【解析】風景自然映入眼簾，用「見える」。
【相關詞比較】
・見{み}える：看得見（視力/視野）。
  例：「目{め}が悪{わる}くて見{み}えない。」（眼睛不好看不見。）
・見{み}られる：能看（機會/被動）。
  例：「この動物{どうぶつ}は動物園{どうぶつえん}で見{み}られる。」（這動物在動物園能看到。）
【易錯點】
・○ 富士山{ふじさん}が見{み}える
・× 富士山{ふじさん}を見{み}える
→ 原因：對象語用「が」。`
...
→ 原因：視力機能用見える。`
    ...
    // 63. みつかる
    {
        ...
        options: [
            ...
            { text: '見{み}つけました', reason: '錯誤：他動詞（我找到了）。雖然語意通，但通常無主語描述物品出現用自動詞。' },
...
→ 原因：自動詞用受詞格助詞「が」。`
    },
    {
        ...
        level: 'N4',
        options: [
            { text: '見{み}つからなくて', reason: '正確！找不到（自動詞否定te形）。' },
...
→ 原因：地點是主語（場所が），故用自動詞。`
    ...
    // 64. みつける
    {
        ...
        level: 'N4',
        options: [
            { text: '見{み}つけた', reason: '正確！一段他動詞。' },
            { text: '見{み}つかった', reason: '錯誤：自動詞（石頭被發現了）。' },
...
→ 原因：石頭是受詞（を）。`
    },
    {
        ...
        level: 'N4',
        options: [
            { text: '見{み}つけた', reason: '正確！動詞ta形+ところ（剛做完/發生）。' },
            { text: '見{み}つかった', reason: '錯誤：自動詞。' },
...
→ 原因：強調是「我」發現的。`
    ...
    // 65. もどる
    {
        ...
        level: 'N4',
        options: [
            { text: '戻{もど}って', reason: '正確！五段動詞促音便。' },
...
→ 原因：申す是自謙語，不能變成被動敬語形式（申される是誤用，除非極特殊方言）。`
    ...
    // 69. むかえる
    {
        ...
        correctIndex: 0,
        tag: 'vocab',
        correctRule: `【考點】動詞活用與目的
【解析】「迎えに行く」是去接人的固定搭配。一段動詞去ru。
【相關詞比較】
・迎{むか}える：迎接。
...
→ 原因：一段動詞連用形是Mukae，不是Mukai。`
    },
    {
        ...
        level: 'N4',
        options: [
            { text: '迎{むか}えに', reason: '正確！目的格（に）。' },
            { text: '迎{むか}えて', reason: '錯誤：迎えに行く才對。迎えて行く是「接了然後走」，語意不同（目的 vs 順序）。' },
            { text: '送{おく}りに', reason: '錯誤：送行。' },
            { text: '連{つ}れに', reason: '錯誤：帶（tsure）。連れに行く少用。' }
        ],
        correctIndex: 0,
        tag: 'grammar',
        correctRule: `【考點】移動目的（對話）
【解析】「動作連用形 + に + 行く/来る」，表示移動的目的。
【相關詞比較】
・迎{むか}えに来{く}る：來接。
・取{と}りに行{い}く：去拿。
【易錯點】
...
→ 原因：一段動詞。`
    },
    {
        ...
        options: [
            ...
            { text: '投{な}がる', reason: '錯誤：自動詞化？（錯誤詞）。' },
...
→ 原因：ku結尾ite音便。`
    ...
    // 73. なくなる
    {
        ...
        level: 'N4',
        options: [
            { text: '無{な}くなって', reason: '正確！五段自動詞。' },
            { text: '無{な}くして', reason: '錯誤：他動詞（弄丟了）。若選此，主語常是人。此題主語是橡皮擦。' },
            { text: '無{な}くて', reason: '錯誤：沒有（形容詞nai的te形）。' },
            { text: '死{し}んで', reason: '錯誤：死（亡くなる音同字不同）。' }
        ],
        correctIndex: 0,
        tag: 'vocab',
        correctRule: `【考點】自他動詞與漢字
【解析】物品消失/用完，用自動詞「無くなる」。
【相關詞比較】
・無{な}くなる：消失/沒了。
...
→ 原因：物品用「無」，人用「亡」。`
    },
    {
        ...
        options: [
            ...
            { text: '無{な}くし', reason: '錯誤：他動詞（弄丟）。' },
            { text: '無{な}くさり', reason: '錯誤：無此變位。' },
            { text: '終{お}わり', reason: '錯誤：結束。' }
        ],
        correctIndex: 0,
        tag: 'grammar',
        correctRule: `【考點】樣態助動詞（對話）
【解析】「～そうです」（看起來快...）。接動詞連用形。「無くなる」→「無くなります」→「無くなりそう」。
【相關詞比較】
・無{な}くなりそうだ：快沒了。
・雨{あめ}が降{ふ}りそうだ：快下雨了。
【易錯點】
...
→ 原因：連用形接sou表示樣態，辭書形接sou表示傳聞。`
    ...
    // 74. なおる
    {
        ...
        level: 'N4',
        options: [
            { text: '直{なお}った', reason: '正確！五段自動詞。' },
            { text: '直{なお}した', reason: '錯誤：他動詞（修好了_人是主語）。' },
            { text: '治{なお}った', reason: '錯誤：病好了。' },
            { text: '戻{もど}った', reason: '錯誤：回來了。' }
        ],
        correctIndex: 0,
        tag: 'vocab',
        correctRule: `【考點】自他動詞與漢字區分
【解析】物品修復用「直る」。身體康復用「治る」。
【相關詞比較】
・直{なお}る：修復/改正。
  例：「癖{くせ}が直{なお}る。」（壞習慣改掉了。）
・治{なお}る：治癒。
...
→ 原因：醫療相關通常用偏旁有水的治。`
    ...
    // 75. なおす
    {
        ...
        level: 'N4',
        options: [
            { text: '直{なお}して', reason: '正確！他動詞。' },
            { text: '直{なお}って', reason: '錯誤：自動詞。' },
            { text: '治{なお}して', reason: '錯誤：治療。' },
            { text: '正{ただ}して', reason: '錯誤：雖有糾正之意，但naoshite更口語常用。' }
        ],
        correctIndex: 0,
        tag: 'vocab',
        correctRule: `【考點】自他動詞語義
【解析】人為修正錯誤用「直す」。
【相關詞比較】
・直{なお}す：修正/修理/翻譯。
...
→ 原因：慣用句型。`
    ...
    // 76. なれる
    {
        ...
        correctIndex: 0,
        tag: 'vocab',
        correctRule: `【考點】動詞活用與搭配
【解析】習慣用「慣れる」（一段）。助詞用「に」。
【相關詞比較】
・慣{な}れる：習慣。
  例：「仕事{しごと}に慣{な}れる。」（習慣工作。）
・成{な}る：成為。
  例：「大人{おとな}に成{な}る。」（變大人。）
【易錯點】
・○ 慣{な}れました
...
→ 原因：一段動詞去ru加mashita。`
    },
    {
        ...
        options: [
            ...
            { text: '慣{な}れて', reason: '正確！習慣/適應（～てくる 變化）。' },
...
→ 原因：五段促音便。`
    ...
    // 80. にげる
    {
        ...
        level: 'N4',
        options: [
            { text: '逃{に}げて', reason: '正確！一段動詞。' },
            { text: '逃{に}がして', reason: '錯誤：他動詞（放走/錯過）。' },
...
→ 原因：一段動詞。`
    ...
    // 81. にる
    {
        ...
        level: 'N4',
        options: [
            { text: '似{に}て', reason: '正確！一段動詞te形+いる（狀態）。' },
...
→ 原因：一段動詞去ru。`
    },
    {
        ...
        options: [
            ...
            { text: '同{おな}じ', reason: '錯誤：一樣（如果是名詞/形動，要接だ/です，題目結尾是ね，如果是同じだね就可以。但似ているね更自然描述相似性）。' },
...
【易錯點】
・○ 階段{かいだん}を上{のぼ}る
・× 階段{かいだん}を上{あ}がる（雖然口語有時混用，但精確動詞是Noboru）
→ 原因：Noboru強調攀登動作，Agaru強調位置變化。`
    },
    {
        id: 'n4_gen_noboru_2',
...
→ 原因：山田先生是主語，自己留下來。`
    ...
    // 84. のりかえる
    {
        ...
        level: 'N4',
        options: [
            { text: '乗{の}り換{か}えます', reason: '正確！一段動詞。' },
            { text: '乗{の}り換{か}わります', reason: '錯誤：自動詞化？無此常搭配。通常由人換乘，用他動詞。' },
...
→ 原因：人為主動動作。`
    ...
    // 85. ぬれる
    {
        ...
        level: 'N4',
        options: [
            { text: '濡{ぬ}れて', reason: '正確！一段自動詞。' },
            { text: '濡{ぬ}らして', reason: '錯誤：他動詞（弄濕）。' },
...
→ 原因：我（錢包主人）視角。`
    ...
    // 88. おどろく
    {
        ...
        level: 'N4',
        options: [
            { text: '驚{おどろ}いた', reason: '正確！五段動詞過去式。' },
...
→ 原因：五段促音便。`
    ...
    // 90. おいでになる
    {
        ...
        options: [
            ...
            { text: 'おいでました', reason: '錯誤：變位錯誤。「おいでになる」是複合動詞，變化在「なる」。' },
        ...
        tag: 'keigo',
        correctRule: `【考點】尊敬語活用
【解析】「おいでになる」是「来る、行く、いる」的尊敬語。活用同「なる」。
【相關詞比較】
・おいでになる：來/去/在（尊敬）。
・ご覧{らん}になる：看（尊敬）。
【易錯點】
...
→ 原因：語義不通。`
    },
    {
        ...
        level: 'N4',
        options: [
            { text: '行{おこな}われる', reason: '正確！客觀描述活動舉行常用受身形。' },
...
→ 原因：能力否定。`
    },
    {
        ...
        level: 'N4',
        options: [
            { text: '思{おも}い出{だ}す', reason: '正確！習慣/頻率。' },
            { text: '思{おも}い出{だ}した', reason: '錯誤：想起了（煞那間）。問句是「常...嗎？」，用現在式（習慣）。' },
            { text: '思{おも}った', reason: '錯誤：認為。' },
            { text: '覚{おぼ}えた', reason: '錯誤：記住了。' }
        ],
        correctIndex: 0,
        tag: 'vocab',
        correctRule: `【考點】時態與習慣（對話）
...
→ 原因：五段促音便。`
    ...
    // 104. おとす
    {
        ...
        options: [
            ...
            { text: '落{お}ちて', reason: '錯誤：自動詞。' },
            { text: '落{お}とさって', reason: '錯誤：變位錯誤。' },
            { text: '下{さ}がって', reason: '錯誤：自動詞下降。' }
        ],
        correctIndex: 0,
        tag: 'te',
        correctRule: `【考點】自他動詞
...
→ 原因：語意邏輯。`
    ...
    // 107. さげる
    {
        ...
        level: 'N4',
        options: [
            { text: '下{さ}げて', reason: '正確！一段他動詞（低下）。' },
            { text: '下{さ}がって', reason: '錯誤：自動詞（下降/退後）。' },
...
→ 原因：人控制身體動作。`
    },
    {
        ...
        options: [
            ...
            { text: '下{さ}がる', reason: '錯誤：自動詞（自己退後）。主語是「我」把「行李」移開，用他動詞。' },
            { text: '落{お}とす', reason: '錯誤：弄掉。' },
...
【解析】「～なければならない」的口語簡略「～なきゃ」。接未然形。一段動詞去ru。「知らせる」→「知らせなきゃ」。
【相關詞比較】
・知{し}らせておきます：先通知一下。
【易錯點】
・○ 知{し}らせなきゃ
...
→ 原因：他動詞接受詞。`
    },
    {
        ...
        level: 'N4',
        options: [
            { text: '育{そだ}てた', reason: '正確！他動詞。' },
            { text: '育{そだ}った', reason: '錯誤：自動詞。' },
...
→ 原因：漢字語義。`
    },
    {
        ...
        options: [
            ...
            { text: '植{う}わった', reason: '錯誤：自動詞（被種著/長著）。主語是人（我種的），用他動詞。' },
...
【易錯點】
・○ 母{はは}が喜{よろこ}ぶ
・× 母{はは}が嬉{うれ}しい（形容詞通常描述第一人稱，第三人稱用動詞Yorokobu）
→ 原因：人稱限制。`
    },
    {
        id: 'n4_gen_yorokobu_2',
        prob: 'A：「プレゼント、彼女{かのじょ}は ______ くれた？」\nB：「うん、すごく。」',
...
→ 原因：五段撥音便。`
    ...
    // 172. よる
    {
        ...
        prob_zh: '回家路上 *順路去* 便利商店。',
        level: 'N4',
        options: [
            { text: '寄{よ}ります', reason: '正確！五段動詞（順路去/靠近）。' },
            { text: '集{あつ}まります', reason: '錯誤：集合。' },
            { text: '止{と}まります', reason: '錯誤：停。' },
            { text: '帰{かえ}ります', reason: '錯誤：回家。「コンビニに帰ります」不通（家住在便利商店？）。' }
        ],
        correctIndex: 0,
        tag: 'vocab',
        correctRule: `【考點】移動動詞
...
→ 原因：語感的鄭重程度。`
    },
    {
        ...
        level: 'N4',
        options: [
            { text: '申{もう}し上{あ}げ', reason: '正確！案内申し上げる（謙讓句型）。' },
            { text: 'いたし', reason: '錯誤：案内いたします亦可，但此題若考詞彙，moushiageru也是常見公務用語。' },
...
→ 原因：複合詞。`
    ...
    // 175. しぬ
    {
        ...
        options: [
            ...
            { text: '殺{ころ}して', reason: '錯誤：殺了（他動詞）。句意通常是自然死亡，除非特別強調弄死。' },
...
→ 原因：撥音便。`
    },
    {
        ...
        options: [
            ...
            { text: '眠{ねむ}って', reason: '錯誤：睡著（雖然也可能，但shinde是nu動詞考點）。' }
        ],
        correctIndex: 0,
        tag: 'vocab',
...
→ 原因：音便。`
    ...
    // 176. しんじる
    {
        ...
        level: 'N4',
        options: [
            { text: '信{しん}じて', reason: '正確！一段動詞（上一段）。' },
...
→ 原因：上一段動詞。`
    },
    {
        ...
        level: 'N4',
        options: [
            { text: '信{しん}じて', reason: '正確！狀態否定（信じていない）。口語省略i。' },
...
→ 原因：動詞此態。`
    },
    {
        ...
        options: [
            ...
            { text: '楽{たの}しい', reason: '錯誤：形容詞不接している。' }
        ],
        correctIndex: 0,
        tag: 'grammar',
        correctRule: `【考點】慣用句（對話）
...
→ 原因：主語與助詞ga。`
    },
    {
        ...
        level: 'N4',
        options: [
            { text: 'たまって', reason: '正確！堆積（自動詞）。' },
            { text: 'ためて', reason: '錯誤：人為堆積（他動詞）。灰塵是自然累積。' },
...
→ 原因：五段促音便。`
    ...
    // 185. つづく
    {
        ...
        level: 'N4',
        options: [
            { text: '続{つづ}いて', reason: '正確！五段自動詞。' },
            { text: '続{つづ}けて', reason: '錯誤：他動詞（繼續做）。主語是地震（自然現象）。' },
...
→ 原因：請求對方做動作。`
    },
    {
        ...
        correctIndex: 0,
        tag: 'grammar',
        correctRule: `【考點】複合動詞（對話）
【解析】「動詞連用形＋続ける」（持續做...）。「食べ続ける」。
【相關詞比較】
・飲{の}み続{つづ}ける：一直喝。
・降{ふ}り続{つづ}く：這是不間斷地下（自動詞複合）。
【易錯點】
・○ 食{た}べ続{つづ}ける
・× 食{た}べ続{つづ}く
→ 原因：人的動作持續。`
...
【易錯點】
・○ 空{そら}を飛{と}ぶ
・× 空{そら}で飛{と}ぶ（強調動作發生範圍，但移動通過習慣用wo）
→ 原因：移動路徑。`
    },
    {
        id: 'n4_gen_tobu_2',
