...
【解析】「会{あ}う」是五段動詞，辭書形字尾「う」變成「い」加「ます」。
【相關詞比較】
・会{あ}う：見面。
・話{はな}す：說話。
【易錯點】
...
【解析】「言{い}う」是五段動詞，字尾u，て形為促音便「言{い}って」。
【相關詞比較】
・言{い}う：說（內容）。
・話{はな}す：談話（交流）。
【易錯點】
...
【解析】詢問過去的事用「行きましたか」。否定回答「行きませんでした」。
【相關詞比較】
・どこへも行{い}かない：哪都不去。
【易錯點】
・○ 行{い}きました
...
【解析】「置{お}く」是五段動詞，字尾ku，て形為イ音便「置{お}いて」。
【相關詞比較】
・置{お}く：放。
・起{お}きる：起床（て形起きて）。
【易錯點】
...
→ 原因：特殊五段。`
    ...
    // 25. かかる (Kakaru)
    {
        ...
        correctIndex: 0,
        tag: 'conjugation',
        correctRule: `【考點】花費時間/金錢
【解析】時間/金錢花費使用「かかる」（自動詞）。ます形「かかります」。
【相關詞比較】
・かける：花（時間/金錢）（他）。但通常說「時間{じかん}がかかる」。
【易錯點】
・○ かかります
・× かけます（除非主語是人，例如「我花時間」）
→ 原因：自他動詞常用句。`
...
【解析】穿上半身衣物用「着{き}る」。上一段動詞，ます形「着{き}ます」。
【相關詞比較】
...
→ 原因：看起來像一段。`
    ...
    {
        id: 'n5_gen_shiru_2',
        prob: 'A：「田中さんの電話番号、______ ？」\nB：「ううん、______。」',
        prob_zh: 'A：「*知道* 田中先生的電話號碼嗎？」\nB：「不，*不知道*。」',
        level: 'N5',
        options: [
...
【解析】「知っていますか」的否定回答是「知りません」（或常體「知らない」）。不說「知っていません」。
【相關詞比較】
・分{わ}かる→分{わ}からない
【易錯點】
・○ 知{し}らない
...
→ 原因：活用。`
    ...
    // 52. 出る (Deru)
    {
        ...
        tag: 'conjugation',
        correctRule: `【考點】一段動詞活用
【解析】「出{で}る」是一段。ます形「出{で}ます」。助詞用「o」（離開的場所）。
【相關詞比較】
・出{だ}す：拿出。
・入{はい}る：進入。
【易錯點】
...
→ 原因：可能 vs 意志。`
    ...
    // 84. 出かける (Dekakeru)
    {
        ...
        options: [
            ...
            { text: '出{で}かけた', reason: '錯誤：過去式。「出かけたところ」是「剛出門完」，題目「今から」是即將。' },
...
【解析】「辭書形 + ところ」表示即將做某事。「出かけるところ」（正要出門）。
【相關詞比較】
・出{で}かける：出門。
・出{で}る：出去。
【易錯點】
...
→ 原因：時態影響意義。`
    },
    {
        ...
        options: [
            ...
            { text: '出{で}かける', reason: '錯誤：辭書形。對話中拒絕邀約，用ます形較禮貌。' },
            { text: '出{で}かけた', reason: '錯誤：過去式。「今から」（現在開始）用現在/未來時。' },
            { text: '出{で}かけて', reason: '錯誤：て形。「～てから」後面通常接另一動作，此處直接說「要出門」。' }
        ],
        correctIndex: 0,
        tag: 'conjugation',
        correctRule: `【考點】禮貌拒絕（對話）
【解析】「出かけます」ます形表達禮貌。「今から～」說明即將的行動。
【相關詞比較】
・出{で}かける：出門（一段）。
・帰{かえ}る：回家（五段）。
【易錯點】
...
→ 原因：連用形接續。`
    ...
    // 87. 晴れる (Hareru)
    {
        ...
        options: [
            ...
            { text: '晴{は}れます', reason: '錯誤：ます形不接「でしょう」。應為「晴れるでしょう」或「晴れますでしょう（較不常用）」。' },
            { text: '晴{は}れた', reason: '錯誤：過去式。「晴れたでしょう」是「晴了吧（推測過去）」。題目「明日」是未來。' },
            { text: '晴{は}れて', reason: '錯誤：て形不接「でしょう」。' }
        ],
        correctIndex: 0,
        tag: 'conjugation',
        correctRule: `【考點】推測表現（天氣）
【解析】「辭書形 + でしょう」表示推測。「晴れるでしょう」（會晴吧）。
【相關詞比較】
・晴{は}れる：放晴。
・曇{くも}る：陰天。
【易錯點】
...
→ 原因：樣態 vs 傳聞。`
    },
    {
        ...
        level: 'N5',
        options: [
            { text: '曇{くも}って', reason: '正確！て形表示理由（因為陰了）。' },
            { text: '曇{くも}る', reason: '錯誤：辭書形。用「から」說理由，前面通常用て形或普通形。' },
            { text: '曇{くも}り', reason: '錯誤：連用形或名詞。「曇り」可作名詞（陰天），但接「から」時用動詞形式較自然。' },
            { text: '曇{くも}った', reason: '錯誤：過去式。雖可接「から」，但て形「曇って」更常用於表理由。' }
        ],
        correctIndex: 0,
        tag: 'conjugation',
        correctRule: `【考點】理由表達（對話）
【解析】「～てから」或「～て」表示理由。五段動詞「曇る」て形為「曇って」。
【相關詞比較】
・曇{くも}る：陰天（五段）。
・降{ふ}る：下（雨/雪）（五段）。
【易錯點】
...
→ 原因：Ru結尾也有五段。`
    },
    {
        ...
        options: [
            ...
            { text: '困{こま}って', reason: '錯誤：て形。雖可用（困ってね），但「困った」更常見。' },
...
→ 原因：需要て形。`
    },
    {
        ...
        level: 'N5',
        options: [
            { text: '吹{ふ}いて', reason: '正確！て形表示理由（因為風吹）。' },
...
→ 原因：不需雙重。`
    },
    {
        ...
        level: 'N5',
        options: [
            { text: '弾{ひ}いて', reason: '正確！て形表示理由（因為每天彈）。' },
...
→ 原因：同音不同活用。`
    },
    {
        ...
        options: [
            ...
            { text: '要{い}ります', reason: '錯誤：ます形。雖正確，但口語「いる？」更常見。' },
...
→ 原因：Suru的活用。`
    },
    {
        ...
        options: [
            ...
            { text: '電話{でんわ}した', reason: '錯誤：過去式。題目「今」表示現在進行。' },
            { text: '電話{でんわ}し', reason: '錯誤：連用形不接「いる」，應為「している」。' }
        ],
        correctIndex: 0,
        tag: 'conjugation',
        correctRule: `【考點】進行式（對話）
【解析】「～ている」表進行。サ變「する」て形為「して」。「電話してる」。
【相關詞比較】
・電話{でんわ}する：打電話。
・話{はな}す：說話（五段）。
【易錯點】
...
→ 原因：需要て形。`
    ...
    // 97. 結婚する (Kekkon suru)
    {
        ...
        options: [
            ...
            { text: '結婚{けっこん}した', reason: '錯誤：過去式。「結婚した予定」語意錯誤。' },
            { text: '結婚{けっこん}して', reason: '錯誤：て形不接「予定」。' }
        ],
        correctIndex: 0,
        tag: 'conjugation',
        correctRule: `【考點】預定表現（～予定）
【解析】「辭書形 + 予定」表示預定。「結婚する予定」（預定結婚）。
【相關詞比較】
・結婚{けっこん}する：結婚。
・離婚{りこん}する：離婚。
【易錯點】
...
→ 原因：接續規則。`
    },
    {
        ...
        options: [
            ...
            { text: '結婚{けっこん}する', reason: '錯誤：辭書形。「去年」（過去）用過去式。' },
...
【解析】「掃除{そうじ}する」ます形為「掃除します」。表示習慣動作。
【相關詞比較】
・掃除{そうじ}する：打掃。
・片付{かたづ}ける：整理（一段）。
【易錯點】
...
→ 原因：需要過去式。`
    ...
    // 100. 料理する (Ryouri suru)
    {
        ...
        tag: 'conjugation',
        correctRule: `【考點】サ變動詞ます形變化
【解析】「料理{りょうり}する」是サ變動詞。ます形為「料理します」。
【相關詞比較】
・料理{りょうり}する：做菜。
・作{つく}る：製作（五段）。
【易錯點】
...
→ 原因：Suru活用。`
    },
    {
        ...
        options: [
            ...
            { text: '料理{りょうり}した', reason: '錯誤：過去式。「したのが好き」意思不同（喜歡做過的）。' },
            { text: '料理{りょうり}して', reason: '錯誤：て形不接「の」。' }
        ],
        correctIndex: 0,
        tag: 'conjugation',
        correctRule: `【考點】名詞化（～のが）
【解析】「辭書形 + のが好き」表示喜歡做某事。「料理するのが好き」。
【相關詞比較】
・料理{りょうり}する：做菜。
・食{た}べる：吃（一段）。
【易錯點】
