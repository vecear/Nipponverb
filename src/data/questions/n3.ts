...
export const n3Questions: StaticQuestion[] = [
    ...
    // --- SOP Expanded N3 Batch 7 ---
    // 24. 占める (Shimeru)
    {
        id: 'n3_v1399_shimeru_1',
        prob: '売上{うりあげ}の半分{はんぶん}以上{いじょう}を ______。',
        prob_zh: '*佔據* 了營業額的一半以上。',
        level: 'N3',
        options: [
            { text: '占{し}めて', reason: '錯誤：接續錯誤。' },
            { text: '占{し}め', reason: '錯誤：這是連用形/名詞，不適合作為句尾。' },
            { text: '占{し}めます', reason: '錯誤：這是未來/意志，不符描述現狀。' },
            { text: '占{し}めている', reason: '正確！一段動詞，表示狀態。' }
        ],
        correctIndex: 3,
        tag: 'vocab',
        correctRule: '【考點】單字語義與搭配\n【解析】佔據了營業額的一半以上。 \n【語義】「占める」(shimeru) 表示在全體中佔有一定的比例或地位。\n【延伸】相關詞/混淆項：占めて、占め、占めます'
    },
    {
        id: 'n3_v1399_shimeru_2',
        prob: '重要{じゅうよう}な位置{いち}を ______。',
        prob_zh: '*佔據* 重要位置。',
        level: 'N3',
        options: [
            { text: '占{し}める', reason: '正確！一段動詞辭書形。' },
            { text: '閉{し}める', reason: '錯誤：這是「關閉」。' },
            { text: '絞{し}める', reason: '錯誤：這是「勒緊/縮減」。' },
            { text: '占{し}めて', reason: '錯誤：接續。' }
        ],
        correctIndex: 0,
        tag: 'vocab',
        correctRule: '【考點】單字語義與搭配\n【解析】佔據重要位置。 \n【活用】「占める」是一段動詞。\n【延伸】相關詞/混淆項：閉める、絞める、占めて'
    },
    // 25. しゃべる (Shaberu)
    {
        id: 'n3_v1399_shaberu_1',
        prob: 'あまり ______ すぎないでください。',
        prob_zh: '請不要 *說* 太多。',
        level: 'N3',
        options: [
            { text: 'しゃべ', reason: '錯誤：誤認一段。' },
            { text: 'しゃべり', reason: '正確！五段動詞連用形接複合動詞。' },
            { text: 'しゃべら', reason: '錯誤：否定。' },
            { text: 'しゃべって', reason: '錯誤：接續。' }
        ],
        correctIndex: 1,
        tag: 'conjugation',
        correctRule: '【考點】動詞活用變化\n【解析】請不要說太多。 \n【活用】「しゃべる」是五段動詞(非一段)，連用形去ru變ri。\n【延伸】相關詞/混淆項：しゃべ、しゃべら、しゃべって'
    },
    {
        id: 'n3_v1399_shaberu_2',
        prob: '秘密{ひみつ}を ______ しまった。',
        prob_zh: '*說漏* 了秘密。',
        level: 'N3',
        options: [
            { text: 'しゃべり', reason: '錯誤：接續。' },
            { text: '話{はな}して', reason: '錯誤：語感較客觀，しゃべる更有「喋喋不休」感。' },
            { text: 'しゃべって', reason: '正確！五段動詞促音便。' },
            { text: 'しゃべら', reason: '錯誤：否定。' }
        ],
        correctIndex: 2,
        tag: 'te',
        correctRule: '【考點】動詞て形活用\n【解析】說漏了秘密。 \n【活用】「しゃべる」結尾是「る」，變為「って」。\n【延伸】相關詞/混淆項：しゃべり、話して、しゃべら'
    },
    // 26. 生じる (Shoujiru)
    {
        id: 'n3_v1399_shoujiru_1',
        prob: '問題{もんだい}が ______ 可能性{かのうせい}がある。',
        prob_zh: '有 *產生* 問題的可能性。',
        level: 'N3',
        options: [
            { text: '生{う}まれる', reason: '錯誤：這是「出生」。' },
            { text: '起{お}きる', reason: '錯誤：語義正確但此處常見生じる。' },
            { text: '生{しょう}じ', reason: '錯誤：接續。' },
            { text: '生{しょう}じる', reason: '正確！一段動詞辭書形。' }
        ],
        correctIndex: 3,
        tag: 'vocab',
        correctRule: '【考點】單字語義與搭配\n【解析】有產生問題的可能性。 \n【語義】「生じる」(shoujiru) 多用於抽象事物的產生或發生。\n【延伸】相關詞/混淆項：生まれる、起きる、生じ'
    },
    {
        id: 'n3_v1399_shoujiru_2',
        prob: '摩擦{まさつ}により熱{ねつ}が ______。',
        prob_zh: '因摩擦而 *產生* 熱。',
        level: 'N3',
        options: [
            { text: '生{しょう}じます', reason: '正確！一段動詞ます形。' },
            { text: '生{しょう}じ', reason: '錯誤：這是連用形/名詞，不適合作為句尾。' },
            { text: '生{しょう}ずる', reason: '錯誤：這是古語/書面體。' },
            { text: '生{う}む', reason: '錯誤：那是他動詞。' }
        ],
        correctIndex: 0,
        tag: 'vocab',
        correctRule: '【考點】單字語義與搭配\n【解析】因摩擦而產生熱。 \n【活用】「生じる」是一段動詞。亦有五段型態「生ずる」但在現代日語多用一段。\n【延伸】相關詞/混淆項：生じ、生む、生ずる'
    },
    // 27. 救う (Sukuu)
    {
        id: 'n3_v1399_sukuu_1',
        ...
        level: 'N3',
        options: [
            { text: '救{すく}わ', reason: '錯誤：否定。' },
            { text: '救{すく}う', reason: '正確！五段動詞辭書形。' },
            { text: '空{す}く', reason: '錯誤：那是「空」。' },
            { text: '救{すく}い', reason: '錯誤：這是連用形/名詞，不適合作為句尾。' }
        ],
        correctIndex: 1,
        tag: 'vocab',
        correctRule: '【考點】單字語義與搭配\n【解析】拯救生命。 \n【語義】「救う」(sukuu) 多用於拯救生命、靈魂或困境。\n【延伸】相關詞/混淆項：空く、救わ、救い'
    },
    {
        id: 'n3_v1399_sukuu_2',
        prob: '彼{かれ}は多{おお}くの人を ______ ました。',
        prob_zh: '他 *拯救* 了許多人。',
        level: 'N3',
        options: [
            { text: '救{すく}わ', reason: '錯誤：否定。' },
            { text: '救{すく}っ', reason: '錯誤：促音便不接ます。' },
            { text: '救{すく}い', reason: '正確！五段動詞ます形。' },
            { text: '助{たす}け', reason: '錯誤：語義相近但此處選救い更強調整救。' }
        ],
        correctIndex: 2,
        tag: 'conjugation',
        correctRule: '【考點】動詞活用變化\n【解析】他拯救了許多人。 \n【活用】五段動詞變位。\n【延伸】相關詞/混淆項：救わ、救っ、助け'
    ...
    // 28. 優れる (Sugureru)
    {
        id: 'n3_v1399_sugureru_1',
        prob: '彼{かれ}は ______ 技術{ぎじゅつ}を持{も}っている。',
        prob_zh: '他擁有 *優秀* 的技術。',
        level: 'N3',
        options: [
            { text: '優{やさ}しい', reason: '錯誤：這是「溫柔」。' },
            { text: '勝{まさ}る', reason: '錯誤：這是「勝過」。' },
            { text: '優{すぐ}れ', reason: '錯誤：接續。' },
            { text: '優{すぐ}れた', reason: '正確！一段動詞過去式接名詞，表示性質。' }
        ],
        correctIndex: 3,
        tag: 'vocab',
        correctRule: '【考點】單字語義與搭配\n【解析】他擁有優秀的技術。 \n【用法】「優れた + 名詞」是常見的修飾用法，表示優秀。\n【延伸】相關詞/混淆項：優れ、優しい、勝る'
    },
    {
        id: 'n3_v1399_sugureru_2',
        prob: '今日{きょう}は体調{たいちょう}が ______ ません。',
        prob_zh: '今天身體狀況 *不佳*。',
        level: 'N3',
        options: [
            { text: '優{すぐ}れ', reason: '正確！一段動詞ます形否定。' },
            { text: '優{すぐ}れな', reason: '錯誤：否定。' },
            { text: '悪{わる}い', reason: '錯誤：形容詞。' },
            { text: '良{よ}く', reason: '錯誤：語義正確但接續不同。' }
        ],
        correctIndex: 0,
        tag: 'vocab',
        correctRule: '【考點】單字語義與搭配\n【解析】今天身體狀況不佳。 \n【慣用句】「体調が優れない」是固定表達方式。\n【延伸】相關詞/混淆項：良く、悪い、優れな'
    },
    // 29. 過ごす (Sugosu)
    {
        id: 'n3_v1399_sugosu_1',
        prob: '夏休み{なつやすみ}を田舎{いなか}で ______。',
        prob_zh: '在鄉下 *度過* 暑假。',
        level: 'N3',
        options: [
            { text: '暮{く}らした', reason: '錯誤：那是「生活」。' },
            { text: '過{す}ごした', reason: '正確！五段動詞過去式。' },
            { text: '過{す}ぎた', reason: '錯誤：那是「經過/超過」。' },
            { text: '過{す}ごし', reason: '錯誤：這是連用形/名詞，不適合作為句尾。' }
        ],
        correctIndex: 1,
        tag: 'vocab',
        correctRule: '【考點】單字語義與搭配\n【解析】在鄉下度過暑假。 \n【自他動詞】「過ごす」(他，度過) 與 「過ぎる」(自，經過)。\n【延伸】相關詞/混淆項：過ごし、過ぎた、暮らした'
    },
    {
        id: 'n3_v1399_sugosu_2',
        prob: '一人{ひとり}で ______ のは寂{さび}しい。',
        prob_zh: '一個人 *度過* (時光) 很寂寞。',
        level: 'N3',
        options: [
            { text: '過{す}ごそ', reason: '錯誤：意向。' },
            { text: '過{す}ごし', reason: '錯誤：連用。' },
            { text: '過{す}ごす', reason: '正確！五段動詞辭書形。' },
            { text: '過{す}ごさ', reason: '錯誤：否定。' }
        ],
        correctIndex: 2,
        tag: 'grammar',
        correctRule: '【考點】文法接續\n【解析】一個人的話度過時光很寂寞。 \n【活用】五段動詞變位。\n【延伸】相關詞/混淆項：過ごし、過ごそ、過ごさ'
    },
    // 30. 進める (Susumeru)
    {
        id: 'n3_v1399_susumeru_1',
        prob: '計畫{けいかく}を ______。',
        prob_zh: '*推進* 計畫。',
        level: 'N3',
        options: [
            { text: '進{すす}ま', reason: '錯誤：否定。' },
            { text: '進{すす}み', reason: '錯誤：那是自動詞。' },
            { text: '勧{すす}め', reason: '錯誤：選字錯誤，那是「推薦」。' },
            { text: '進{すす}め', reason: '正確！一段他動詞連用形。' }
        ],
        correctIndex: 3,
        tag: 'transitive',
        correctRule: '【考點】自他動詞辨析\n【解析】推進計畫。 \n【自他動詞】「進む」(自) vs 「進める」(他)。助詞「を」選他動詞。\n【延伸】相關詞/混淆項：進み、勧め、進ま'
    },
    {
        id: 'n3_v1399_susumeru_2',
        prob: '時計{とけい}を5分{ごふん} ______。',
        prob_zh: '將時鐘 *撥快* 5分鐘。',
        level: 'N3',
        options: [
            { text: '進{すす}めた', reason: '正確！一段他動詞過去式。' },
            { text: '遅{おそ}めた', reason: '錯誤：那是「減慢」。' },
            { text: '早{はや}めた', reason: '錯誤：語義相近，但撥快時鐘常用進める。' },
            { text: '進{すす}んだ', reason: '錯誤：那是自動詞。' }
        ],
        correctIndex: 0,
        tag: 'transitive',
        correctRule: '【考點】自他動詞辨析\n【解析】將時鐘撥快5分鐘。 \n【活用】一段他動詞變位。\n【延伸】相關詞/混淆項：進んだ、遅めた、早めた'
    },
    // 31. 勧める (Susumeru)
    {
        id: 'n3_v1399_susumeru_3',
        prob: '友達{ともだち}にこの本{ほん}を ______ られた。',
        prob_zh: '*被* 朋友 *推薦* 了這本書。',
        level: 'N3',
        options: [
            { text: '勧{すす}ま', reason: '錯誤：變化錯誤。' },
            { text: '勧{すす}め', reason: '正確！一段動詞受身形。' },
            { text: '誘{さそ}わ', reason: '錯誤：那是「邀請」。' },
            { text: '進{すす}め', reason: '錯誤：選字錯誤。' }
        ],
        correctIndex: 1,
        tag: 'passive',
        correctRule: '【考點】受身形活用\n【解析】被朋友推薦了這本書。 \n【漢字辨析】「勧める」用於推薦物品、建議；「進める」用於移動或推進。\n【延伸】相關詞/混淆項：進め、勧ま、誘わ'
    },
    {
        id: 'n3_v1399_susumeru_4',
        prob: '留学{りゅうがく}を ______。',
        prob_zh: '*建議/鼓勵* 留學。',
        level: 'N3',
        options: [
            { text: '勧{すす}め', reason: '錯誤：這是連用形/名詞，不適合作為句尾。' },
            { text: '進{すす}めます', reason: '錯誤：選字錯誤。' },
            { text: '勧{すす}めます', reason: '正確！一段動詞。' },
            { text: '頼{たの}みます', reason: '錯誤：語義不合。' }
        ],
        correctIndex: 2,
        tag: 'vocab',
        correctRule: '【考點】單字語義與搭配\n【解析】建議留學。 \n【活用】一段動詞變位。\n【延伸】相關詞/混淆項：進めます、勧め、頼みます'
    },
    // 32. 済ませる (Sumaseru)
    {
        id: 'n3_v1399_sumaseru_1',
        prob: '用事{ようじ}を早く ______ ください。',
        prob_zh: '請快點 *辦完* 私事。',
        level: 'N3',
        options: [
            { text: '済{す}まし', reason: '錯誤：連用。' },
            { text: '済{す}んで', reason: '錯誤：那是自動詞。' },
            { text: '終{お}わって', reason: '錯誤：語義相近，但此處濟ませる更好。' },
            { text: '済{す}ませて', reason: '正確！一段使役式他動詞 te 形。' }
        ],
        correctIndex: 3,
        tag: 'transitive',
        correctRule: '【考點】自他動詞辨析\n【解析】請快點辦完私事。 \n【自他動詞】「済む」(自) vs 「済ませる」(他)。\n【延伸】相關詞/混淆項：済んで、済まし、終わって'
    },
    {
        id: 'n3_v1399_sumaseru_2',
        prob: '昼食{ちゅうしょく}を簡単に ______。',
        prob_zh: '簡單地 *解決* 了午餐。',
        level: 'N3',
        options: [
            { text: '済{す}ませた', reason: '正確！一段他動詞過去式。' },
            { text: '済{す}まし', reason: '錯誤：連用。' },
            { text: '済{す}んだ', reason: '錯誤：那是自動詞。' },
            { text: '食{た}べた', reason: '錯誤：語感不符此處「解決/應付」的含義。' }
        ],
        correctIndex: 0,
        tag: 'vocab',
        correctRule: '【考點】單字語義與搭配\n【解析】簡單地解決了午餐。 \n【語感】「済ませる」常用於表示用簡單的方式應付或完成某事。\n【延伸】相關詞/混淆項：済んだ、食べた、済まし'
    },
    // 33. 責める (Semeru)
    {
        id: 'n3_v1399_semeru_1',
        prob: '自分{じぶん}を ______ ないでください。',
        prob_zh: '請不要 *責怪* 自己。',
        level: 'N3',
        options: [
            { text: '攻{せ}め', reason: '錯誤：選字錯誤，那是「攻擊」。' },
            { text: '責{せ}め', reason: '正確！一段動詞否定接續。' },
            { text: '責{せ}め', reason: '錯誤：接續。' },
            { text: '責{せ}ま', reason: '錯誤：變化錯誤。' }
        ],
        correctIndex: 1,
        tag: 'vocab',
        correctRule: '【考點】單字語義與搭配\n【解析】請不要責怪自己。 \n【漢字辨析】「責める」是責備；「攻める」是進攻。\n【延伸】相關詞/混淆項：攻め、責め、責ま'
    },
    {
        id: 'n3_v1399_semeru_2',
        prob: '無責任{むせきにん}だと ______ られた。',
        prob_zh: '*被* 責怪說不負責任。',
        level: 'N3',
        options: [
            { text: '攻{せ}め', reason: '錯誤：選字錯誤。' },
            { text: '怒{おこ}ら', reason: '錯誤：那是「被生氣」。' },
            { text: '責{せ}め', reason: '正確！一段動詞受身形。' },
            { text: '責{せ}ま', reason: '錯誤：變化錯誤。' }
        ],
        correctIndex: 2,
        tag: 'passive',
